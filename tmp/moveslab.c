...
if (ynerr)
	{
	/* Add Const */
	leftx=sol0[mcmax]-bondv[bondm[mcmax]][0];
	/* Add Koef */
	for (n1=0;n1<3;n1++)
		{
		if(bondn[bondm[mcmax]][n1]) 
			{
			leftx-=bondv[bondm[mcmax]][n1+1]*sol0[bondn[bondm[mcmax]][n1]-1];
			}
		}
	/**/
	return leftx;
...
if (ynerr)
	{
	/* Add Const */
	lefty=sol0[mcmax]-bondv[bondm[mcmax]][0];
	/* Add Koef */
	for (n1=0;n1<3;n1++)
		{
		if(bondn[bondm[mcmax]][n1]) 
			{
			lefty-=bondv[bondm[mcmax]][n1+1]*sol0[bondn[bondm[mcmax]][n1]-1];
			}
		}
	/**/
	return lefty;
...
if (ynerr)
	{
	/* Add Const */
	leftp=sol0[mcmax]-bondv[bondm[mcmax]][0];
	/* Add Koef */
	for (n1=0;n1<3;n1++)
		{
		if(bondn[bondm[mcmax]][n1]) 
			{
			leftp-=bondv[bondm[mcmax]][n1+1]*sol0[bondn[bondm[mcmax]][n1]-1];
			}
		}
	/**/
	return leftp*leftp;
