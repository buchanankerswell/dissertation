...
kable(
  caption = 'Comparing surface heat flow patterns across upper-plate sectors',
  linesep = '',
  col.names = c('Segment', 'Kriging', 'Similarity', 'Comparison'),
  escape = F,
  booktabs = T,
  format = 'latex'
) %>%
...
Second, Similarity's low error rates are computed with relatively few data points (from `r rmse.luca$segment[which.min(rmse.luca$n.obs.sim)]`: n = `r min(rmse.luca$n.obs.sim)` to `r rmse.luca$segment[which.max(rmse.luca$n.obs.sim)]`: n = `r max(rmse.luca$n.obs.sim)`) compared to Kriging (from `r names(map_dbl(shp.hf.crop, nrow))[which.min(map_dbl(shp.hf.crop, nrow))]`: n = `r min(map_dbl(shp.hf.crop, nrow))` to `r names(map_dbl(shp.hf.crop, nrow))[which.max(map_dbl(shp.hf.crop, nrow))]`: n = `r max(map_dbl(shp.hf.crop, nrow))`). This study computes Kriging error rates using all surface heat flow observations within the interpolation domain. In contrast, Similarity error rates are computed using a subset of observations that are explicitly co-located with the 0.5$^\circ \times$ 0.5$^\circ$ grid of target locations taken from @lucazeau2019. Similarity error rates may increase (or decrease) relative to Kriging error rates if computed using all observations within each interpolation domain. Computing Similarity error rates on the same set of observations as Kriging would require reproducing the Similarity results of @lucazeau2019 from the constituent proxy datasets, which are not provided as supplementary files.
...
```{r alaskaAleutiansUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Alaska Aleutians. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Alaska Aleutians'}

knitr::include_graphics('assets/figs/chpt3/AlaskaAleutiansUpperPlate.png')

```

```{r andesUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Andes. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Andes'}

knitr::include_graphics('assets/figs/chpt3/AndesUpperPlate.png')

```

```{r kamchatkaMarianasUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Kamchatka Marianas. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Kamchatka Marianas'}

knitr::include_graphics('assets/figs/chpt3/KamchatkaMarianasUpperPlate.png')

```

```{r kyushuRyukyuUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Kyushu Ryukyu. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Kyushu Ryukyu'}

knitr::include_graphics('assets/figs/chpt3/KyushuRyukyuUpperPlate.png')

```

```{r lesserAntillesUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Lesser Antilles. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Lesser Antilles'}

knitr::include_graphics('assets/figs/chpt3/LesserAntillesUpperPlate.png')

```

```{r nPhilippinesUpper, fig.cap='Along strike variability of upper-plate surface heat flow near N Philippines. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near N Philippines'}

knitr::include_graphics('assets/figs/chpt3/NPhilippinesUpperPlate.png')

```

```{r newBritainSolomonUpper, fig.cap='Along strike variability of upper-plate surface heat flow near New Britain Solomon. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near New Britain Solomon'}

knitr::include_graphics('assets/figs/chpt3/NewBritainSolomonUpperPlate.png')

```

```{r sPhilippinesUpper, fig.cap='Along strike variability of upper-plate surface heat flow near S Philippines. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near S Philippines'}

knitr::include_graphics('assets/figs/chpt3/SPhilippinesUpperPlate.png')

```

```{r scotiaUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Scotia. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Scotia'}

knitr::include_graphics('assets/figs/chpt3/ScotiaUpperPlate.png')

```

```{r sumatraBandaSeaUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Sumatra Banda Sea. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Sumatra Banda Sea'}

knitr::include_graphics('assets/figs/chpt3/SumatraBandaSeaUpperPlate.png')

```

```{r tongaNewZealandUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Tonga New Zealand. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Tonga New Zealand'}

knitr::include_graphics('assets/figs/chpt3/TongaNewZealandUpperPlate.png')

```

```{r vanuatuUpper, fig.cap='Along strike variability of upper-plate surface heat flow near Vanuatu. Please refer to the main text for explanation of panels and colors.', fig.scap='Along strike variability of upper-plate surface heat flow near Vanuatu'}
