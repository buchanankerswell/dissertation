...
\nomenclature[]{$z_{1100}$}{Upper plate thickness at 1100$^{\circ}$C}%
\nomenclature[]{$z_c$}{Mechanical coupling depth between subducting slab and upper plate}%
\nomenclature[]{$\Phi$}{Thermal parameter $\sim$ slab age $\times$ convergence rate}%
