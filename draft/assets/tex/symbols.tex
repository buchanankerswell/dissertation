...
\nomenclature{$cut$}{variogram lag cutoff constant}
...
\nomenclature{$shift$}{variogram lag shift constant}
...
\nomenclature{$nug$}{variogram nugget}
\nomenclature{$sill$}{variogram sill}
...
\nomenclature{$\Sigma$}{covariance matrix for Gaussian mixture modelling}
