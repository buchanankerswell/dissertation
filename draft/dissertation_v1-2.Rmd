...
#### Upper-Plate Surface Heat Flow Continuity
...
In principle, combining the desirable properties of Similarity (spatial-independence) and Kriging (conserving ground-truth) during the interpolation process is possible by layering Similarity and Kriging interpolations. A layered approach simultaneously respects the First [@krige1951] and Third Laws of Geography [@zhu2018] by integrating geologic and spatial information. Any number of methods may be applied to combine Similarity and Kriging predictions. As a basic example: (1) compare Similarity and Kriging layers to detect anomalies, (2) compute weights proportional to the squared difference between Similarity and Kriging predictions to emphasized (or subdue) anomalies, (3) combine Similarity and Kriging layers using a weighted average scheme.

## Conclusions

This study evaluates spatial patterns of surface heat flow near subduction zones by comparing Kriging and Similarity interpolation methods applied to a (processed) global surface heat flow dataset [ThermoGlobe, @lucazeau2019]. Surface heat flow distributions and trench-orthogonal profiles predicted by Similarity and Kriging highlight at least three important points of consideration:

1. Irregular spacing of ThermoGlobe data
...
3. Layered interpolation approaches can combine the strengths of Similarity (spatial-independence) and Kriging (conserving ground-truth) to produce more accurate surface heat flow predictions
