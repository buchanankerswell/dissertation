...
The amount of heat escaping Earth's surface depends on the thermal state of Earth's lithosphere, plus heat-transferring and heat-generating subsurface processes like hydrothermal circulation, radioactive decay, fault motion, plate coupling, and mantle convection [@fourier1827; @kelvin1863; @parsons1977; @pollack1977; @stein1992; @hutnak2008; @hasterok2013; @stein1994; @rudnick1998; @furlong2013; @gao2014; @furukawa1993; @wada2009; @kerswell2020; @currie2004; @currie2006]. Surface heat flow observations are thus critically important for understanding lithospheric evolution, crustal deformation and seismic hazards, groundwater hydrology and environmental impacts, and economic exploration (e.g. hydrocarbon, mineral, and geothermal energy resources). Monumental efforts to take tens of thousands of continental and oceanic surface heat flow measurements (see ThermoGlobe References) and compile them into databases [@pollack1993; @hasterok2008; @lucazeau2019; @jennings2021] enable multi-disciplinary investigations into lithospheric and crustal processes.

ThermoGlobe, the most recent global surface heat flow database [@lucazeau2019; @jennings2021], currently contains `r format(nrow(hf), big.mark = ',')` observations, yet the spatial coverage near subduction zones is sparse and highly irregular at the regional scale (10$^2$ to 10$^3$ $km$, Figure \@ref(fig:globalhfComp) & Table \@ref(tab:hfSummaryTable)). While ThermoGlobe includes many datasets of neatly organized observations, often collocated with seismic arrays at the $\leq$ 10$^2$ $km$ scale, separation distances on the order of 10$^3$ $km$ can exist between clusters of data. Thus, the challenge of evaluating regional patterns of surface heat flow along a subduction zone segment is careful interpolation of sparse, irregularly-spaced data.
...
> 3. Locations with similar geographic configurations have similar values for other target variables [@zhu2018]
