...
sectors.df <-
  tibble(
    ...
    n = unlist(map(shp.sectors, ~map_dbl(.x$pnts, ~nrow(.x))), use.names = F),
...
kable(
  col.names = c('Segment', 'Sector', 'n', 'Median', 'IQR', 'Median', 'IQR', 'Median', 'IQR'),
...
add_header_above(
  c(' ' = 2, 'ThermoGlobe' = 3, 'Similarity' = 2, 'Krige' = 2),
  escape = F
) %>%
