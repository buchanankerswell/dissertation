...
Meanwhile, Similarity and Kriging profiles are obviously distinguishable. For example, Kriging profiles are smooth and closely parallel ThermoGlobe data, whereas Similarity profiles show higher heat flow where geodynamically expected (e.g. in sector 4, which intersects a volcanic center and ridge segment; Figure \@ref(fig:newBritainSolomonUpper)). Methodological differences apparently drive divergence between Similarity and Kriging predictions in this case.
