...
%DIF DEL dissertation.tex      Mon Nov  8 04:15:57 2021
%DIF ADD dissertation_v2.tex   Mon Nov  8 04:17:06 2021
...
% Acknowledments
  ...
  \input{assets/tex/acknowledgment}
  \clearpage
...
\caption[The Geodynamicist's dilemma]{The Geodynamicist's dilemma. Time-depth diagram representing the data availability on Earth. The rock record (red circles) encodes information about geodynamic processes throughout Earth's history, but only within approximately 100 \(km\) of Earth's surface. Geophysical data (blue circles) \DIFdelbeginFL \DIFdelFL{provides }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{provide }\DIFaddendFL images of Earth's deep interior, but only since the 20th century CE (or 10\(^{-7}\) \(Ga\)). Direct observations (green circle) are limited to the present-day surface. Size of the circles represents the abundance of available data. Reprinted from Gerya (\protect\hyperlink{ref-gerya2014}{2014}) with permission.}\label{fig:sparse}
\end{figure}

Subduction occurs when two lithospheric plates converge and the denser plate \emph{subducts} beneath the other at a \DIFdelbegin %DIFDELCMD < \glsfirst{sz}%%%
\DIFdel{. }%DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \emph{\DIFadd{subduction zone}}\DIFadd{. Subduction zones }\DIFaddend are implicated in myriad geodynamic phenomena, including seismicity, metamorphism, volatile flux, volcanism, dynamic plate motions, and crustal deformation (\protect\hyperlink{ref-cizkova2013}{Čížková \& Bina, 2013}; \protect\hyperlink{ref-gao2017}{Gao \& Wang, 2017}; \protect\hyperlink{ref-gonzalez2016}{Gonzalez et al., 2016}; \protect\hyperlink{ref-grove2012}{Grove et al., 2012}; \protect\hyperlink{ref-hacker2003}{Hacker et al., 2003}; \protect\hyperlink{ref-hirauchi2010}{Hirauchi et al., 2010}; \protect\hyperlink{ref-peacock1990}{Peacock, 1990}, \protect\hyperlink{ref-peacock1991}{1991}, \protect\hyperlink{ref-peacock1993}{1993}, \protect\hyperlink{ref-peacock1996}{1996}; \protect\hyperlink{ref-peacock1999a}{Peacock \& Hyndman, 1999}; \protect\hyperlink{ref-vankeken2011}{van Keken et al., 2011}). These phenomena are largely defined by plate motions and mechanical \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend along the plate interface (\protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-peacock1994}{Peacock et al., 1994}; \protect\hyperlink{ref-peacock1996}{Peacock, 1996}\DIFdelbegin \DIFdel{; }\DIFdelend \DIFaddbegin \DIFadd{). Important inputs and thermo-kinematic boundary conditions exerting first-order control on subduction zone structure and geodynamics (plate velocity, subduction angle, plate thickness, sediment thickness, crustal structure, subduction duration, and others) vary considerably among presently active subduction zones worldwide (e.g. }\DIFaddend \protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}\DIFdelbegin \DIFdel{). While a diverse set of }%DIFDELCMD < \glsfirst{tkbc} %%%
\DIFdel{intuitively implies an equally diverse range of mechanical behaviour, previous work suggests mechanical behaviour is rather uniform among presently active }%DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{; }\protect\hyperlink{ref-syracuse2006}{Syracuse \& Abers, 2006}\DIFadd{).
}

\DIFadd{Intuition suggests subduction zone inputs and thermo-kinematic boundary conditions should influence mechanical behavior along the plate interface. Yet previous work argues for rather uniform depths of plate (de)coupling among subduction zones with diverse thermo-kinematic boundary conditions }\DIFaddend (\protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-wada2008}{Wada et al., 2008}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). \DIFdelbegin \DIFdel{An apparent juxtaposition between uniform mechanical behaviour vs.~diverse boundary conditionsimplies a very unintuitive model of subduction}\DIFdelend \DIFaddbegin \DIFadd{Models based on such uniform mechanical behavior are widely adopted over alternative models (after }\protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}\DIFadd{) and imply some aspects of subduction zone mechanics are minimally affected by thermo-kinematic boundary conditions. However, the spatial variability (with depth }\emph{\DIFadd{and}} \DIFadd{along strike in map view) of plate interface mechanics is difficult to quantify and currently characterized for transects across relatively few subduction zone segments compared to the global extent of actively converging margins}\DIFaddend .

This dissertation is motivated by the following question. How can one quantify the \DIFdelbegin \DIFdel{diversity of mechanical behaviour }\DIFdelend \DIFaddbegin \DIFadd{spatial variability of plate interface mechanical behavior }\DIFaddend across a range of \DIFdelbegin \DIFdel{plausible }%DIFDELCMD < \gls{sz} %%%
\DIFdel{configurations}\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend ? Each chapter focuses on quantifying an aspect of \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend mechanics using different computational approaches and datasets.

Chapter \ref{chpt2} numerically simulates oceanic-continental subduction across a range of \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend and plate coupling is observed after 10 \(Ma\). Multivariate linear regression is then used to formulate an expression for estimating \DIFdelbegin %DIFDELCMD < \glsfirst{cd}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth}\DIFaddend . The expression requires estimates for upper-plate thickness, which can be inverted from \DIFdelbegin %DIFDELCMD < \glsfirst{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow}\DIFaddend . Average upper-plate \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend for 13 presently active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend yield a narrow distribution of \DIFdelbegin %DIFDELCMD < \glspl{cd}%%%
\DIFdel{---supporting }\DIFdelend \DIFaddbegin \DIFadd{coupling depths---supporting }\DIFaddend the idea of broadly uniform mechanical \DIFdelbegin \DIFdel{behaviour among }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths among subduction zones}\DIFaddend .

Chapter \ref{chpt3} takes a closer look \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend by quantifying its spatial variability in 2D. Two interpolations methods, Kriging and Similarity, are compared to assess \DIFdelbegin \DIFdel{their relative effectiveness. While one approach yields more favourable error rates, both show diverse spatial patterns of }%DIFDELCMD < \gls{shf} %%%
\DIFdel{in contradiction to broadly uniform }%DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{differences in their regional heat flow estimates near subduction zones. While Kriging and Similarity yield comparable regional interpolations on average, both approaches show lateral (along strike) surface heat flow variability in the upper plate. Discontinuous upper-plate surface heat flow implies non-uniform upper-plate thickness and contradicts broadly uniform coupling depths }\DIFaddend predicted in Chapter \ref{chpt2}.
\DIFdelbegin \DIFdel{Dataset scaling and new improvements to interpolation methods promise better tools for evaluating geodynamic variability among }%DIFDELCMD < \glspl{sz}%%%
\DIFdel{.
}\DIFdelend 

Finally, Chapter \ref{chpt4} applies machine learning techniques to recognize detachment of subducting markers (representing recovered rock fragments) from the numerical simulations in Chapter \ref{chpt2}. A large (91,733) \glsfirst{ptt} dataset of recovered \DIFdelbegin \DIFdel{marker }\DIFdelend \DIFaddbegin \DIFadd{markers }\DIFaddend is compared across numerical experiments and with a global compilation of \DIFdelbegin %DIFDELCMD < \glsfirst{hp} %%%
\DIFdel{metamorphic terranes }\DIFdelend \DIFaddbegin \gls{pt} \DIFadd{estimates for rocks exhumed from subduction zones }\DIFaddend (the rock record). Marker \gls{ptt} distributions are distinct from the rock record \DIFdelbegin \DIFdel{, likely pointing to inherent sampling bias introduced by aggregating undifferentiated }%DIFDELCMD < \gls{hp} %%%
\DIFdel{rocks into a single composite dataset}\DIFdelend \DIFaddbegin \DIFadd{for most numerical simulations, except for the most slowly-converging systems (40 \(km/Ma\))}\DIFaddend . Both marker \gls{ptt} distributions and marker recovery rates correlate with \DIFdelbegin %DIFDELCMD < \gls{tkbc}%%%
\DIFdel{, suggesting }\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions, implying }\DIFaddend non-uniform mechanical \DIFdelbegin \DIFdel{behaviour among }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{detachment of rock among subduction zones}\DIFaddend .
...
\begin{itemize}
\item
  Plate coupling responds strongly to \DIFdelbegin %DIFDELCMD < \gls{upt}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness
}\DIFaddend \item
  Inverting \DIFdelbegin %DIFDELCMD < \glsfirst{shf} %%%
\DIFdel{allows }%DIFDELCMD < \glsfirst{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow allows coupling depth }\DIFaddend estimation
\item
  Globally consistent \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{implies consistent }%DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow implies consistent upper-plate thickness}\DIFaddend , and thus uniform \DIFdelbegin %DIFDELCMD < \glspl{cd}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths
...
Deep mechanical coupling between converging plates is implicated in dynamic plate motions, crustal deformation, seismic cycles, arc magmatism, detachment (recovery) of subducting material, and is considered a key feature of \DIFdelbegin %DIFDELCMD < \glsfirst{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics. This study uses two-dimensional numerical simulations of oceanic-continental convergent margins to investigate effects of \DIFdelbegin %DIFDELCMD < \glsfirst{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend on coupling---specifically focusing on thermal parameter (\(\Phi\)) and \DIFdelbegin %DIFDELCMD < \glsfirst{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness}\DIFaddend . Numerical simulations implement coupling by including the metamorphic (de)hydration reaction \(antigorite \allowbreak \Leftrightarrow olivine + orthopyroxene + H_{2}O\) in the upper-plate mantle. Visualizing \DIFdelbegin %DIFDELCMD < \glsfirst{pts} %%%
\DIFdelend \DIFaddbegin \DIFadd{P-T-strain }\DIFaddend fields show thermal feedbacks regulating \DIFdelbegin %DIFDELCMD < \glsfirst{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend dynamically with strong responses to \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend and weak responses to \(\Phi\). The results imply estimation of \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend is possible by inverting \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdel{from }%DIFDELCMD < \glsfirst{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness from surface heat flow}\DIFaddend . Moreover, \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend sampled from the backarc region near 17 presently active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdel{imply uniform }%DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones imply uniform upper-plate thickness}\DIFaddend , and thus uniform \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdel{among }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths among subduction zones}\DIFaddend .

\hypertarget{chpt2Intro}{%
\section{Introduction}\label{chpt2Intro}}

Subduction geodynamics are largely defined by plate motions and mechanical \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend along the plate interface. For example, a transition from mechanically decoupled (plates moving differentially with respect to each other) to coupled plates (plates moving with the same local velocity) dramatically increases temperature by inducing mantle circulation in the upper-plate asthenospheric mantle (\protect\hyperlink{ref-peacock1994}{Peacock et al., 1994}; \protect\hyperlink{ref-peacock1996}{Peacock, 1996}). Observations from numerical simulations and forearc \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend imply coupling transitions occur globally within a narrow range of depths in modern \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (70-80 \(km\)). Further, coupling appears essentially unresponsive to diverse \DIFdelbegin %DIFDELCMD < \gls{tkbc}%%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions}\DIFaddend , including oceanic-plate age, convergence velocity, and subduction geometry (\protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-wada2008}{Wada et al., 2008}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). While uniform \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdel{among }%DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths among subduction zones }\DIFaddend are inferred from numerical simulations and \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow}\DIFaddend , this phenomenon remains curious and unconfirmed to a large extent. To understand \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics, it is essential to understand why modern \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend appear to achieve similar \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend despite differences in their physical characteristics.

Notwithstanding, many numerical geodynamic models use \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend of 70-80 \(km\) as a boundary condition (\protect\hyperlink{ref-abers2017}{Abers et al., 2017}; \protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-gao2014}{Gao \& Wang, 2014}; \protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}; \protect\hyperlink{ref-vankeken2011}{van Keken et al., 2011}, \protect\hyperlink{ref-vankeken2018}{2018}; \protect\hyperlink{ref-wada2012}{Wada et al., 2012}; \protect\hyperlink{ref-wilson2014}{Wilson et al., 2014}), although not exclusively (e.g.~40-56 \(km\), \protect\hyperlink{ref-england2010}{England \& Katz, 2010}; \protect\hyperlink{ref-peacock1996}{Peacock, 1996}). Similar \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdel{among }%DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths among subduction zones }\DIFaddend is an attractive hypothesis for at least two reasons. First, it helps explain a relatively narrow range of depths to subducting oceanic-plates beneath volcanic arcs (\protect\hyperlink{ref-england2004}{England et al., 2004}; \protect\hyperlink{ref-syracuse2006}{Syracuse \& Abers, 2006}) as mechanical coupling is expected to be closely associated with the onset of flux melting. Second, mechanical coupling is required to detach crustal fragments from the subducting plate (\protect\hyperlink{ref-agard2016}{Agard et al., 2016}), so uniform \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend may also help explain why maximum pressures recorded by subducted oceanic material worldwide is \(\leq\) 2.3-2.5 \(GPa\) (roughly 80 \(km\), \protect\hyperlink{ref-agard2009}{Agard et al., 2009}, \protect\hyperlink{ref-agard2018}{2018}).

The location and extent of mechanical coupling along the plate interface is implicated in myriad geodynamic phenomena, including seismicity, metamorphism, volatile flux, volcanism, plate motions, and crustal deformation (\protect\hyperlink{ref-cizkova2013}{Čížková \& Bina, 2013}; \protect\hyperlink{ref-gao2017}{Gao \& Wang, 2017}; \protect\hyperlink{ref-gonzalez2016}{Gonzalez et al., 2016}; \protect\hyperlink{ref-grove2012}{Grove et al., 2012}; \protect\hyperlink{ref-hacker2003}{Hacker et al., 2003}; \protect\hyperlink{ref-hirauchi2010}{Hirauchi et al., 2010}; \protect\hyperlink{ref-peacock1990}{Peacock, 1990}, \protect\hyperlink{ref-peacock1991}{1991}, \protect\hyperlink{ref-peacock1993}{1993}, \protect\hyperlink{ref-peacock1996}{1996}; \protect\hyperlink{ref-peacock1999a}{Peacock \& Hyndman, 1999}; \protect\hyperlink{ref-vankeken2011}{van Keken et al., 2011}). Consequently, the mechanics of coupling have been extensively studied and discussed. Coupling fundamentally depends on the strength (viscosity) of materials above, within, and below the plate interface. Water flux from compaction and dehydration of hydrous minerals with increasing \glsfirst{pt} forms layers of low viscosity sheet silicates near the plate interface. Transmission of shear stress between plates is inhibited by formation of talc and serpentine in the shallow upper-plate mantle (\protect\hyperlink{ref-peacock1999a}{Peacock \& Hyndman, 1999}). Lack of traction along the interface, combined with cooling from the subducting plate surface, ensures a positive feedback between hydrous mineral formation and mechanical decoupling. Experimentally determined flow laws, petrologic observations, and geophysical observations all support the plausibility of this conceptual model of subduction interface \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend (e.g. \protect\hyperlink{ref-agard2016}{Agard et al., 2016}, \protect\hyperlink{ref-agard2018}{2018}; \protect\hyperlink{ref-gao2014}{Gao \& Wang, 2014}; \protect\hyperlink{ref-peacock1999a}{Peacock \& Hyndman, 1999}).

Experimental control over important \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend make geodynamic numerical simulations essential for investigating such complex geodynamic environments. Wada \& Wang (\protect\hyperlink{ref-wada2009}{2009}) previously investigated the effects of \(\Phi\) on \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend by numerically simulating 17 presently active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . Among other \DIFdelbegin %DIFDELCMD < \gls{tkbc}%%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions}\DIFaddend , their models specify convergence rate, subduction geometry, thermal structure of oceanic- and overriding-plates, and degree of coupling along the subduction interface. Notably, their experiments control for interface rheology and discriminate best-fit \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend based on observed forearc \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow}\DIFaddend .

This study similarly specifies \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend to numerically simulate the range of modern \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend systems, but regulates interface rheology dynamically by implementing metamorphic reactions that respond to evolving \DIFdelbegin %DIFDELCMD < \gls{pts} %%%
\DIFdelend \DIFaddbegin \DIFadd{P-T-strain }\DIFaddend fields. Subduction geometry and \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend are not fully determined features, in other words, but spontaneous model outcomes within the range of specified boundary conditions discussed in Section \ref{numMethods}. As in previous studies (e.g. \protect\hyperlink{ref-ruh2015}{Ruh et al., 2015}), rheological effects of the dehydration reaction \(antigorite \allowbreak \Leftrightarrow olivine + orthopyroxene + H_{2}O\) are implemented to drive mechanical coupling. An abrupt viscosity increase accompanies antigorite (serpentine) destabilization, thereby inducing mechanical coupling, as defined by empirically-determined flow laws used in the experiments (Table \ref{tab:materials}).

This chapter focuses on two fundamental questions. How does \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend respond to \(\Phi\) \emph{and} \DIFdelbegin %DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness}\DIFaddend ? And how stable is \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend through time? First, 64 convergent margins with variable \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend and \(\Phi\) are numerically simulated and mechanical plate coupling is observed. Thermal feedbacks within the system are visualized in terms of mantle temperature, viscosity, and velocity fields and \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend responses to a range of \(\Phi\) and \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend are quantified using multivariate linear regression. Three different regression models are then used to estimate \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend for 17 presently active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdel{. }%DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones. Coupling depth }\DIFaddend estimates are narrowly distributed, regardless of regression model form. Finally, implications and questions regarding uniformity among \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend in terms of \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdel{, }%DIFDELCMD < \gls{upt}%%%
\DIFdel{, and }%DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow, upper-plate thickness, and coupling depth }\DIFaddend are discussed.

\hypertarget{numMethods}{%
\section{Numerical Modelling Methods}\label{numMethods}}

This study simulates converging oceanic-continental plates, where an ocean basin is being consumed by subduction at a continental margin (Figure \ref{fig:init}). Initial conditions are modified from previous numerical experiments of active margins (\protect\hyperlink{ref-gorczyk2007}{Gorczyk et al., 2007}; \protect\hyperlink{ref-sizova2010}{Sizova et al., 2010}) using the code \texttt{I2VIS} (\protect\hyperlink{ref-gerya2003}{Gerya \& Yuen, 2003}), although plate coupling was not the focus of their studies. An identical rheologic model with identical material properties (Table \ref{tab:materials}), and a identical hydration/melt model (Table \ref{tab:melts} \& Appendix \ref{deHydration}) to Sizova et al. (\protect\hyperlink{ref-sizova2010}{2010}) are implemented. However, the version of \texttt{I2VIS} in this study differs from Sizova et al. (\protect\hyperlink{ref-sizova2010}{2010}) in its initial setup, overall dimension, resolution, continental geotherm, dehydration model, and left boundary condition (origin of new oceanic lithosphere). Differences are outlined in this section and in Appendix \ref{deHydration}. Sixty-four \texttt{I2VIS} models constructed with varying convergence rates (\DIFdelbegin \DIFdel{\(\vec{v}_{conv}\)}\DIFdelend \DIFaddbegin \DIFadd{\(\vec{v}\)}\DIFaddend ), oceanic-plate ages, and \DIFdelbegin %DIFDELCMD < \glspl{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend (Figure \ref{fig:params}) were ran on the \href{https://scicomp.ethz.ch/wiki/Euler}{Euler cluster} at ETH, Zürich for at least 100 timesteps.
...
Oceanic-plates of different ages are also tacitly assumed to dehydrate similarly with the above implementation. However, older (colder) oceanic-plates are expected to carry water to greater depths than younger (warmer) plates because of relatively delayed water-releasing reactions (\protect\hyperlink{ref-peacock1996}{Peacock, 1996}). Abrupt water release with serpentine dehydration (Equation \eqref{eq:antstab}) was tested to model deep water retention in cold oceanic-plates. Mechanical coupling \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend was indistinguishable from gradual water release models. This implies rates of water release are less important than the depth of serpentine stability. Explicitly modelling other major dehydration reactions are thus unlikely to significantly affect mechanical coupling \DIFdelbegin \DIFdel{behaviour}\DIFdelend \DIFaddbegin \DIFadd{behavior}\DIFaddend , yet likely to introduce numerical artifacts at great computational cost. A simplified gradual water release model for all oceanic-plates is therefore preferred.
...
where \(b\)=\(5\times10^{-10}\) \(m\) is \DIFaddbegin \DIFadd{the }\DIFaddend Burgers vector, \(G\)=\(8\times10^{10}\) \(Pa\) is shear modulus, \(h\)=\(1\times10^{-3}\) \(m\) is the assumed grain size, \(m=2.5\) is the grain size exponent, and the other flow law parameters are given in Table \ref{tab:materials}. \DIFdelbegin \DIFdel{Our models limited viscosity for all rocks at }\DIFdelend \DIFaddbegin \DIFadd{Viscosity is limited in all numerical experiments from }\DIFaddend \(\eta_{min} = 10^{17}\ Pa \cdot s\) \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{to }\DIFaddend \(\eta_{max} = 10^{25}\ Pa \cdot s\).
...
The rheologic model and \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend described in the previous sections always results in plate motions towards the left boundary (slab-rollback). Relatively high dip angles and extreme subduction velocities in some high-\(\Phi\) experiments cause chaotic \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend by 10 \(Ma\) as the upper-plate is stretched thin and mechanical interference occurs between trench sediments and the high-viscosity convergence region 200 \(km\) from the left boundary. Numerical solutions are stable for most experiments, however, reaching quasi-steady state by 5 \(Ma\). An additional 5 \(Ma\) is allowed to ensure stable geodynamics before observing \DIFdelbegin %DIFDELCMD < \gls{cd}%%%
\DIFdel{. }%DIFDELCMD < \Glsfirst{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth. Surface heat flow}\DIFaddend , rock type, temperature, viscosity, strain rate, shear heating, and velocity fields are visualized at approximately 10 \(Ma\) (e.g.~Figure \ref{fig:comp}) for all 64 experiments to assess geodynamics and solution stability (Figure \ref{fig:antDepth}).
...
After approximately 10 \(Ma\) of subduction \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend is determined directly from viscosity by finding the approximate area where strength contrasts between serpentinized- and non-serpentinized upper-plate mantle diminishes to \(<\) 10\(^2\) \(Pa \cdot s\). The node nearest to this region is assigned as the \DIFdelbegin %DIFDELCMD < \gls{cd}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth}\DIFaddend . This study assumes mechanical coupling occurs instantaneously and at a single node. Mechanical coupling in reality must be dispersed across a finite length along the plate interface, however. At the numerical resolution the experiments, coupling-like viscosity contrasts are similar within a small area (approximately 5 \(\times\) 5 \(km\) or 5 \(\times\) 5 nodes), giving a qualitative uncertainty \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend on the order of 2.5 \(km\).
...
\DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{Coupling depth }\DIFaddend (\(Z_{cpl}\)) correlates strongly with \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend (\(Z_{UP}\)) and weakly with \(\Phi\) across all 64 numerical models (Table \ref{tab:zcResults}, Figures \ref{fig:results} \& \ref{fig:biv}). The responsiveness of \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend to \(Z_{UP}\) but not to \(\Phi\) is a key result of \DIFdelbegin \DIFdel{our experiments}\DIFdelend \DIFaddbegin \DIFadd{this study}\DIFaddend . The following equation minimizes standard least squares while optimizing the number of parameters, \emph{p value}, and \(R^2\) for all possible permutations of the variables \(Z_{UP}\) and \(\Phi\) in linear and quadratic forms:
...
Sensitivity of \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdel{to }%DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth to upper-plate thickness }\DIFaddend and \(\Phi\) is apparent when visualizing Equation \eqref{eq:zCpl} and other regression models across \(Z_{UP}\) and \(\Phi\) space \ref{fig:multiv}. Applying Equation \eqref{eq:zCpl} to 17 active \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments (Table \ref{tab:segs}) gives a wide range of estimated \DIFdelbegin %DIFDELCMD < \glspl{cd}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths}\DIFaddend , similar to \DIFdelbegin \DIFdel{our model simulations }\DIFdelend \DIFaddbegin \DIFadd{the numerical simulations in this study}\DIFaddend . The distribution of estimated \DIFdelbegin %DIFDELCMD < \glspl{cd}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths}\DIFaddend , however, is relatively narrow and quasi-normal, with a mean of \(\sim\) 82 \(km\) and standard deviation of 7 \(km\) (Figure \ref{fig:multiv}d).
...
\DIFdelbeginFL %DIFDELCMD < \caption[Estimated coupling depths for 17 active \gls{sz} segments]{%%%
\DIFdelendFL \DIFaddbeginFL \caption[Estimated coupling depths for 17 active subduction zone segments]{\DIFaddendFL Multivariate regressions and estimated coupling depth ($Z_{cpl}$) for 17 active \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zone }\DIFaddendFL segments. Contoured plots show estimated $Z_{cpl}$ (contours) as a function of thermal parameter ($\Phi$) and upper-plate thickness ($Z_{UP}$) for linear (a) and quadratic (b, c) regressions. The best fit regression is panel b (Equation \ref{eq:zCpl}, see Tables \ref{tab:anova} and \ref{tab:regSummary}). Black squares represent numerical experiments used to fit the contours. White points represent active \DIFdelbeginFL %DIFDELCMD < \glspl{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zones }\DIFaddendFL (Table \ref{tab:segs}). Contours imply $Z_{cpl}$ depends strongly on $Z_{UP}$, regardless of the regression equation form. Estimated $Z_{cpl}$ for \DIFdelbeginFL %DIFDELCMD < \glspl{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zones }\DIFaddendFL with similar $\Phi$ are quite different (e.g. Alaska vs. N. Sumatra). Estimated $Z_{cpl}$ are also quite similar for \DIFdelbeginFL %DIFDELCMD < \glspl{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zones }\DIFaddendFL with very different $\Phi$ (e.g. Kamchatka vs. N. Cascadia). (d) Distributions of estimated $Z_{cpl}$ for 17 active \DIFdelbeginFL %DIFDELCMD < \glspl{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zones }\DIFaddendFL shown in (a), (b), and (c). These 17 segments span a large range of $\Phi$ but are expected to have a relatively narrow distribution of $Z_{cpl}$ (82 $\pm$ 14 $km$) according to the regressions in (a), (b), and (c).}\label{fig:multiv}
\end{figure}

\hypertarget{surface-heat-flow}{%
\subsection{Surface Heat Flow}\label{surface-heat-flow}}

Upper-plate \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend remains relatively stable and reflects initial upper-plate geotherms in the backarc region for experiments with low to moderate \(\Phi\) (Figure \ref{fig:hf}). However, high-amplitude and high-frequency positive \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend deviations in the upper-plate are common in all experiments, especially for high-\(\Phi\) experiments. These deviations correspond to extensional deformation and heat transport via lithospheric thinning and melt migration. These features are apparent as subvertical low viscosity, high strain rate columns originating from the plate interface (Figure \ref{fig:comp}b, d) and point to potential sources of error when inverting \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{in active }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow in active subduction zones}\DIFaddend . Notably, the backarc is relatively unaffected by fluid and melt migration compared to the forearc. Estimating \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdel{by inverting }%DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness by inverting surface heat flow }\DIFaddend in the backarc is therefore preferable to forearc \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow}\DIFaddend .

\DIFdelbegin %DIFDELCMD < \begin{figure}[htbp]
%DIFDELCMD < 

%DIFDELCMD < {\centering \includegraphics[width=1\linewidth,]{assets/figs/chpt2/fig5} 
%DIFDELCMD < 
...
%DIFDELCMD < %%%
%DIFDELCMD < \caption[Surface heat flow calculated from numerical experiments]{%
{%DIFAUXCMD
\DIFdelFL{Surface heat flow ($\vec{q}$) vs. normalized distance for model cdf with upper-plate thickness ($Z_{UP}$) ranging from 46 to 94 $km$. The distribution of $\vec{q}$ in the forearc (normalized distance between 0.0 and 1.0) is narrow and shows little variance until near the arc (normalized distance between 0.75 and 1.0). The broad distribution of $\vec{q}$ behind the arc (normalized distance $>$ 1.0) reflects the broad distribution of initial continental geotherms ($Z_{UP}$). Any simple relationship between $\vec{q}$ and $Z_{UP}$ may be obscured by heating from extension or vertical migration of fluids, especially within the arc-region (high-amplitude fluctuations).}}%DIFAUXCMD
%DIFDELCMD < \label{fig:hf78}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{Surface heat flow }\DIFaddend across all numerical experiments is similar in the forearc region (normalized distance \(\leq\) 0.75, Figure \ref{fig:hf78}). In contrast, \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend extending behind the arc region (normalized distance \(>\) 0.75, Figure \ref{fig:hf78}) increases systematically, then levels off at values reflecting initial continental geotherms (i.e.~reflecting initial \DIFdelbegin %DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness}\DIFaddend ). In reality, \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend depend on fault slip rates and rates of volcanic outputs. However, heat flow in the behind the arc may remain in steady-state if rates of volcanism and crustal thinning by extension are low (\protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}).
...
\caption[Surface heat flow calculated from numerical experiments]{\DIFaddFL{Surface heat flow ($\vec{q}$) vs. normalized distance for model cdf with upper-plate thickness ($Z_{UP}$) ranging from 46 to 94 $km$. The distribution of $\vec{q}$ in the forearc (normalized distance between 0.0 and 1.0) is narrow and shows little variance until near the arc (normalized distance between 0.75 and 1.0). The broad distribution of $\vec{q}$ behind the arc (normalized distance $>$ 1.0) reflects the broad distribution of initial continental geotherms ($Z_{UP}$). Any simple relationship between $\vec{q}$ and $Z_{UP}$ may be obscured by heating from extension or vertical migration of fluids, especially within the arc-region (high-amplitude fluctuations).}}\label{fig:hf78}
\end{figure}

\DIFaddend \hypertarget{chpt2Discussion}{%
...
A clear association between plate coupling and the reaction \(antigorite \allowbreak \Leftrightarrow olivine + orthopyroxene + H_{2}O\) is observed in all experiments. A relatively narrow serpentine channel quickly forms above the dehydrating oceanic-plate, localizing strain, lubricating the plate interface, and inhibiting transfer of shear stress between plates (e.g. \protect\hyperlink{ref-agard2016}{Agard et al., 2016}; \protect\hyperlink{ref-ruh2015}{Ruh et al., 2015}). This mechanical \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend is a direct consequence of a sharp rheologic change dependent on the location of serpentine dehydration reaction described in Section \ref{numHydration} and its effect on the rheologic model described in Section \ref{rheologicModel}. Interactions among viscosity changes, serpentine dehydration, and heat transfer are regulated by competing dynamic feedbacks acting in the upper-plate. In summary, cooling and hydration of the shallow upper-plate mantle (serpentine stabilization) and heating from circulating asthenospheric mantle beneath the upper-plate lithosphere (driven by mechanical coupling) compete to stabilize \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend (Figure \ref{fig:flow}).
...
How does \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdel{influence }%DIFDELCMD < \gls{cd}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness influence coupling depth}\DIFaddend ? Numerical experiments point to the upper-plate lithosphere-asthenosphere boundary as an important feature constraining coupling mechanics as it defines the permissible flow field in the upper-plate (Figure \ref{fig:streams}a-d). Thin upper-plate lithospheres (Figure \ref{fig:streams}a, b) permit shallow mantle flow and advection of heat farther up the plate interface. Thin upper-plate lithospheres thereby raise coupling depths by raising serpentine stability up the plate interface. Thick upper-plate lithospheres (Figure \ref{fig:streams}c, d) restrict mantle wedge flow to deeper levels, deepening serpentine stability and mechanical coupling.

The thermal state of the slab, as represented by \(\Phi\), has almost no effect on \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend by comparison. Relative insensitivity of \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend to \(\Phi\) is consistent with previous studies of active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (\protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). The irresponsiveness of \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend to changes in \(\Phi\) is perhaps due to competing cooling and heating effects driven by the subducting oceanic-plate. For example, high-\(\Phi\) oceanic-plates (older plates with higher velocities) cool the upper-plate mantle more effectively, but also effectively heat the interface by driving stronger mantle circulation. In contrast, low-\(\Phi\) oceanic-plates (younger plates with lower velocities) are less effective in cooling the upper-plate mantle, but also ineffectively heat the interface by ineffectively driving mantle circulation. That is, the shallow vs.~deep dynamic effects of \(\Phi\) tend to cancel each other, explaining the lack of correlation between \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend and \(\Phi\).
...
Theoretically, \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend can be estimated directly by fitting forearc \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend data using forward modelling approaches (e.g. \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). However, forward approaches typically adjust \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdel{independently from }%DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth independently from upper-plate thickness}\DIFaddend , which is inconsistent with an inherent link between \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdel{and }%DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth and upper-plate thickness }\DIFaddend discussed in Section \ref{chpt2Discussion} (e.g.~Figures \ref{fig:hf78} \& \ref{fig:streams}). Moreover, many additional heat sources (e.g.~shear heating and crustal plutonism, \protect\hyperlink{ref-gao2014}{Gao \& Wang, 2014}; \protect\hyperlink{ref-reesjones2018}{Rees Jones et al., 2018}) may contribute to forearc \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdel{---increasing }\DIFdelend \DIFaddbegin \DIFadd{surface heat flow---increasing }\DIFaddend uncertainty when inverting \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdel{from }%DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness from surface heat flow}\DIFaddend .

Assuming low degrees of backarc extension, estimating \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdel{in active }%DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth in active subduction zones }\DIFaddend using Equation \eqref{eq:zCpl} with \(Z_{UP}\) inverted from backarc \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend is preferable to avoid additional uncertainties stemming from seismic and volcanic activity in the forearc. However, while \(\Phi\) is inventoried for most active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (\protect\hyperlink{ref-syracuse2006}{Syracuse \& Abers, 2006}), a corresponding dataset of \(Z_{UP}\) does not exist. Several geophysical and petrologic methods might be considered for independent estimates of \(Z_{UP}\) (e.g.~seismic velocities, flexure, heat flow, mantle xenoliths). Backarc \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend is still a good choice, however, because of its direct correspondence with \(Z_{UP}\). For example, \(Z_{UP}\) may be estimated using simple one-dimensional heat transport models assuming values for radiogenic heat production in the crust (\protect\hyperlink{ref-rudnick1998}{Rudnick et al., 1998}). Special attention must be paid to crustal processes, including extension and magmatism, because additional heating will underestimate \(Z_{UP}\) and, consequently, underestimate \DIFdelbegin %DIFDELCMD < \gls{cd}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth}\DIFaddend .
...
A \(Z_{cpl}\) distribution of 82 \(\pm\) 14 \(km\) (2\(\sigma\)) estimated for active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend in this study (Figure \ref{fig:multiv}d) roughly match the preferred \(Z_{cpl}\) inferred from forearc \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend for Cascadia and NE Japan (75-80 \(km\), \protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}) \(km\). The range of \(Z_{cpl}\) estimated for active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend in this study (Figure \ref{fig:multiv}d) is relatively broad, however. For example, omitting Mexico and Nankai because their \(\Phi\) values fall outside \DIFdelbegin \DIFdel{our modeling domain, estimated }%DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{the range of \(\Phi\) used for numerical experiments, estimated coupling depths }\DIFaddend range from almost 100 \(km\) (Kyushu) to approximately 65 \(km\) (Sumatra and NE Japan, Table \ref{tab:segs}).

\DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdel{in active }%DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{Coupling depth in active subduction zones }\DIFaddend are commonly assumed to be narrowly distributed around 70-80 \(km\) (\protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). The strong correlation between \(Z_{UP}\) and \(Z_{cpl}\) found from numerical experiments imply uniform \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend are possible if \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend are globally uniform. The \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend dataset compiled by Wada \& Wang (\protect\hyperlink{ref-wada2009}{2009}) (Table \ref{tab:segs}) shows average backarc \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend are indeed similar among active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdel{---implying }\DIFdelend \DIFaddbegin \DIFadd{subduction zones---implying }\DIFaddend a narrow distribution of \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend (Figure \ref{fig:multiv}d). Much of their dataset is based on Currie \& Hyndman (\protect\hyperlink{ref-currie2006}{2006}), who estimate \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend for 10 circum-Pacific \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend of 50-60 \(km\) (defined by the 1200 \(^{\circ}C\) isotherm). Uniformly thin \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend are corroborated by uniformly high heat flow (\(>\) 70 \(mW/m^{2}\)), thermobarometric constraints on mantle xenoliths, and P-wave velocities (\protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}). An attempt is made to further corroborate the uniformity of \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend in Chapter \ref{chpt3} by interpolating \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{near active }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow near active subduction zones}\DIFaddend .

Although it still curious why upper-plates among \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend may have similar thicknesses, one can assume it is likely related to some processes of lithospheric erosion proposed for subarc lithosphere. These include: lithospheric delamination induced by lower crust eclogitization (\protect\hyperlink{ref-sobolev2005}{Sobolev \& Babeyko, 2005}), small-scale convection caused by hydration-induced mantle wedge weakening (\protect\hyperlink{ref-arcay2006}{Arcay et al., 2006}), thermal erosion (\protect\hyperlink{ref-england2010}{England \& Katz, 2010}), mechanical weakening by percolating melts (\protect\hyperlink{ref-gerya2011}{Gerya \& Meilick, 2011}), and subarc foundering of magmatic cumulates (\protect\hyperlink{ref-jull2001}{Jull \& Kelemen, 2001}). Most of these mechanisms are thus strongly related to mantle wedge hydration, melting, and melt transport toward volcanic arcs.

The metamorphic rock record may also imply consistency among \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdel{in }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths in subduction zones}\DIFaddend . For example, the demise of a serpentine channel and onset of coupling may provide a natural barrier such that rocks are more likely to be exhumed from within the channel than from below it. The relative abundance of blueschists and eclogites should then be greater for pressures below estimated \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend (approximately 2.4 \(GPa\) or 70-80 \(km\)) than above them. This hypothesis will be explicitly explored in Chapter \ref{chpt4}.
...
\item
  \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{Coupling depth }\DIFaddend is stabilized near the base of the upper-plate lithosphere by competing dynamic feedbacks regulating heat transport, serpentine dehydration, and mechanical coupling in the upper-plate mantle.
\item
  A simple expression fitted to \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend observed in numerical experiments allows the \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend to be estimated for active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdel{by inverting }%DIFDELCMD < \gls{upt} %%%
\DIFdel{from }%DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones by inverting upper-plate thickness from surface heat flow}\DIFaddend .
\item
  Uniform \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend in circum-Pacific \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (\protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}) may indicate uniform \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend at approximately 80 \(km\).
\end{enumerate}

Questions remain, however, including: how do warm (thin) upper-plates persist over 100's of kilometers behind arcs and throughout the lifespan of \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend ? How abruptly are dehydration reaction occurring along the subduction interface? How can expressions like Equation \eqref{eq:zCpl} be improved using natural datasets? Each of these questions may be considered for future research.
...
\begin{itemize}
\item
  \DIFdelbegin \DIFdel{Diverse spatial patterns of }%DIFDELCMD < \glsfirst{shf} %%%
\DIFdel{characterize }%DIFDELCMD < \glspl{sz}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{Spatial patterns of surface heat flow near subduction zones reflect regional geodynamic variability
}\DIFaddend \item
  \DIFdelbegin \DIFdel{Quantitative inference is possible by careful 2D }%DIFDELCMD < \gls{shf} %%%
\DIFdel{interpolation
}\DIFdelend \DIFaddbegin \DIFadd{Kriging and Similarity interpolations are regionally comparable, but distinctive at \(\leq\) 100's of \(km\) scales
}\DIFaddend \item
  \DIFdelbegin \DIFdel{New interpolation approaches and dataset scaling will improve }%DIFDELCMD < \gls{sz} %%%
\DIFdel{research
}\DIFdelend \DIFaddbegin \DIFadd{Both methods show many cases of lateral (along-strike) variability in upper-plate surface heat flow
}\item
  \DIFadd{Variations in upper-plate surface heat flow patterns imply non-uniform upper-plate thickness and discontinuous geodynamics
}\DIFaddend \end{itemize}
\end{quote}
...
\DIFdelbegin \DIFdel{Heat }\DIFdelend \DIFaddbegin \DIFadd{The magnitude of heat }\DIFaddend fluxing through the Earth's surface \DIFdelbegin \DIFdel{provides indirect observations of }%DIFDELCMD < \glsfirst{pts} %%%
\DIFdel{fields deep in }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{is directly proportional to temperature gradients and strain rates deep in subduction zones}\DIFaddend . Global heat flow databases are \DIFdelbegin \DIFdel{therefore essential }\DIFdelend \DIFaddbegin \DIFadd{thus promising sources }\DIFaddend for generating and testing hypotheses about \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdel{geodynamics. However, evaluating }\DIFdelend \DIFaddbegin \DIFadd{subduction zone geodynamics. Evaluating }\DIFaddend spatial variability of \DIFdelbegin %DIFDELCMD < \glsfirst{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend across large tectonic features requires careful projection and interpolation of sparse observations\DIFaddbegin \DIFadd{, however}\DIFaddend . This study \DIFdelbegin \DIFdel{investigates the accuracy and resolution of simple ordinary Kriging methods applied to }%DIFDELCMD < \gls{shf} %%%
\DIFdel{near }%DIFDELCMD < \gls{sz} %%%
\DIFdel{segments. Kriging interpolations, based on the First Law of Geography (spatial continuity), are directly compared to an approach based on the Third Law of Geography (Similarity). Both methods are generally comparable and show diverse spatial patterns of (dis) continuous }%DIFDELCMD < \gls{shf} %%%
\DIFdel{near }%DIFDELCMD < \glspl{sz}%%%
\DIFdel{. Diverse spatial patterns of }%DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{compares two interpolation methods based on fundamentally different principles, Kriging and Similarity, to investigate spatial variability of surface heat flow near 13 presently active subduction zones. Kriging and Similarity are grossly comparable at regional scales with median differences from -3 to 15 \(mWm^{-2}\). However, Kriging and Similarity show distinctive patterns of surface heat flow across the upper-plates (along strike) of at least 7 out of 13 subduction zone segments. Moreover, several segments show differences in average upper-plate surface heat flow of up to 50 \(mWm^{-2}\) along strike. Discontinuous heat flow across upper-plates }\DIFaddend may imply spatially heterogeneous lithospheric thickness (contrary to expectations from Chapter \ref{chpt2}), spatially heterogeneous dynamics, spatially heterogeneous near-surface perturbations, and/or undersampling relative to the scale and magnitude of spatial variability. \DIFdelbegin \DIFdel{The results highlight present challenges in evaluating spatial variability of }%DIFDELCMD < \gls{sz} %%%
\DIFdel{geodynamics from }%DIFDELCMD < \gls{shf} %%%
\DIFdel{datasets and stress the importance of characterizing }%DIFDELCMD < \gls{shf} %%%
\DIFdel{patterns to the fullest extent possible. Dataset scaling and developing new composite interpolation approaches will improve interpolation resolution and accuracy, promising }\DIFdelend \DIFaddbegin \DIFadd{New methods carefully layering two or more interpolation techniques promise }\DIFaddend better tools for distinguishing \DIFdelbegin \DIFdel{geodynamic variability among presently active }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{spatial variability in surface heat flow}\DIFaddend .

\hypertarget{chpt3Intro}{%
\section{Introduction}\label{chpt3Intro}}

Heat escaping the solid Earth's surface indicates a dynamically cooling planet. \DIFdelbegin %DIFDELCMD < \Glsfirst{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{Surface heat flow }\DIFaddend databases (\protect\hyperlink{ref-hasterok2008}{Hasterok \& Chapman, 2008}; \protect\hyperlink{ref-jennings2021}{Jennings \& Hasterok, 2021}; \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}; \protect\hyperlink{ref-pollack1993}{Pollack et al., 1993}) enable geodynamic investigations by relating the amount of heat escaping Earth's surface to heat-transferring and heat-generating subsurface processes like hydrothermal circulation, radioactive decay, fault motion, subduction dynamics, and mantle convection (\protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-fourier1827}{Fourier, 1827}; \protect\hyperlink{ref-furlong2013}{Furlong \& Chapman, 2013}; \protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-gao2014}{Gao \& Wang, 2014}; \protect\hyperlink{ref-hasterok2013}{Hasterok, 2013}; \protect\hyperlink{ref-kelvin1863}{Kelvin, 1863}; \protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}; \protect\hyperlink{ref-parsons1977}{Parsons \& Sclater, 1977}; \protect\hyperlink{ref-pollack1977}{Pollack \& Chapman, 1977}; \protect\hyperlink{ref-rudnick1998}{Rudnick et al., 1998}; \protect\hyperlink{ref-stein1992}{Stein \& Stein, 1992}, \protect\hyperlink{ref-stein1994}{1994}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{Surface heat flow }\DIFaddend observations have motivated research in many scientific and industrial fields as evident by more than 1,393 publications compiled in the largest and most recent \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend database (\texttt{ThermoGlobe}, \protect\hyperlink{ref-jennings2021}{Jennings \& Hasterok, 2021}; \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}).

While \texttt{ThermoGlobe} currently contains 69,729 observations, the irregularly-spaced data only cover a small fraction of the Earth's surface (510,065,800 \(km^2\), \protect\hyperlink{ref-archinal2018}{Archinal et al., 2018}) with an average spatial density of only 137 \(obs/Million\,km^2\). Estimating global or regional \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend rates thus requires careful interpolation of sparse observations across relatively large distances, even in the most densely sampled regions. One approach to this problem is integrating geographic, geologic, geochronologic, and geophysical information into interpolation methods. In this approach, estimates for unknown target locations are selected from \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend distributions constructed from global observation sites that have similar characteristics (e.g.~sites have similar bathymetry, elevation, proximity to active or ancient orogens, seafloor age, upper mantle shear wave velocities, etc., \protect\hyperlink{ref-chapman1975}{Chapman \& Pollack, 1975}; \protect\hyperlink{ref-davies2013}{Davies, 2013}; \protect\hyperlink{ref-goutorbe2011}{Goutorbe et al., 2011}; \protect\hyperlink{ref-lee1965}{Lee \& Uyeda, 1965}; \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}; \protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-sclater1970}{Sclater et al., 1970a}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-sclater1970}{Sclater \& Francheteau, 1970}\DIFaddend ; \protect\hyperlink{ref-shapiro2004}{Shapiro \& Ritzwoller, 2004}). These methods are called \emph{Similarity} methods (Figure \ref{fig:similarityBuffer}) and follow assumptions embedded in the Third Law of Geography: \emph{the more similar the geographic configuration of two points, the more similar their values} (\protect\hyperlink{ref-zhu2018}{Zhu et al., 2018}). Global scale problems are particularly suited for Similarity approaches as they do not rely on spatial density of observations. On the other hand, assumed interactions among many independent geologic proxies used to construct proxy \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend distributions, each with its own assumptions and uncertainties, makes Similarity a complex combinatorial problem vulnerable to decisions about the number of proxies, proxy dataset quality, and simplified geologic models used to compute observable classes (see \protect\hyperlink{ref-goutorbe2011}{Goutorbe et al., 2011} for method details).



\begin{figure}[htbp]

{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\linewidth,]{assets/figs/chpt3/similarityBuffer} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\linewidth,]{assets/figs/chpt3/ThermoGlobeBufferComp} 
\DIFaddendFL 

}

\DIFdelbeginFL %DIFDELCMD < \caption[Similarity interpolation of near 13 active \gls{sz} segments]{%%%
\DIFdelendFL \DIFaddbeginFL \caption[Similarity interpolation of near 13 active subduction zone segments]{\DIFaddendFL Global \DIFdelbeginFL \DIFdelFL{Similarity interpolation of }%DIFDELCMD < \gls{shf} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{surface heat flow near subduction zone segments. (a) }\texttt{\DIFaddFL{ThermoGlobe}} \DIFaddFL{surface heat flow observations }\DIFaddendFL cropped within 1000 \(km\) circular buffers around 13 active \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zone }\DIFaddendFL segments. \DIFaddbeginFL \DIFaddFL{(b) Global Similarity interpolation cropped within the same buffers. }\DIFaddendFL Note that \DIFdelbeginFL %DIFDELCMD < \gls{shf} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Similarity estimates }\DIFaddendFL above 250 \(mWm^{-2}\) \DIFdelbeginFL \DIFdelFL{is }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{are }\DIFaddendFL colored white \DIFaddbeginFL \DIFaddFL{to keep continuity with the colorbar (e}\DIFaddendFL .\DIFaddbeginFL \DIFaddFL{g.~near CA, AN, SC, and VN segments). }\DIFaddendFL \texttt{ThermoGlobe} data and Similarity interpolation \DIFaddbeginFL \DIFaddFL{are }\DIFaddendFL from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Subduction zone }\DIFaddendFL boundaries \DIFdelbeginFL \DIFdelFL{as }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(bold white lines) are }\DIFaddendFL defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Segments: AA {[}Alaska Aleutians{]}, AN {[}Andes{]}, CA {[}Central America{]}, KM {[}Kamchatka Marianas{]}, KR {[}Kyushu Ryukyu{]}, LA {[}Lesser Antilles{]}, \DIFdelbeginFL \DIFdelFL{NP }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{NBS }\DIFaddendFL {[}\DIFdelbeginFL \DIFdelFL{N Philippines}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{New Britain Solomon}\DIFaddendFL {]}, \DIFdelbeginFL \DIFdelFL{NBS }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{NP }\DIFaddendFL {[}\DIFdelbeginFL \DIFdelFL{New Britain Solomon}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{N Philippines}\DIFaddendFL {]}, \DIFdelbeginFL \DIFdelFL{SP }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{SBS }\DIFaddendFL {[}\DIFdelbeginFL \DIFdelFL{S Philippines}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Sumatra Banda Sea}\DIFaddendFL {]}, SC {[}Scotia{]}, \DIFdelbeginFL \DIFdelFL{SBS }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{SP }\DIFaddendFL {[}\DIFdelbeginFL \DIFdelFL{Sumatra Banda Sea}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S Philippines}\DIFaddendFL {]}, TNZ {[}Tonga New Zealand{]}, VN {[}Vanuatu{]}.}\label{fig:similarityBuffer}
\end{figure}

Similarity methods generally ignore any notion of spatial dependence, or continuity, of \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow}\DIFaddend . Measures of proximity to orogens and active volcanic areas may be considered in Similarity methods (\protect\hyperlink{ref-goutorbe2011}{Goutorbe et al., 2011}; \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}), but these measures roughly reference spatial dependence to tectonic features and not to other nearby \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations. Generally speaking, spatial (dis)continuity of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend reflects the (dis)continuity of subsurface geodynamics (assuming insignificant near-surface perturbations). For example, broad \DIFdelbegin \DIFdel{low-}%DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{low surface heat flow }\DIFaddend regions on continents outline cratons and uniform \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{near }%DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow near subduction zones }\DIFaddend are interpreted to reflect uniform lithospheric thickness (\protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-hyndman2005}{Hyndman et al., 2005}) and mechanical coupling depths (\protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). This phenomenon is encapsulated in the First Law of Geography: \emph{everything is related, but nearer things are more related} (\protect\hyperlink{ref-krige1951}{Krige, 1951}; \protect\hyperlink{ref-matheron1963}{Matheron, 1963}). It is crucial for regional geodynamic investigations to characterize the spatial continuity of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations whenever possible.

In contrast to Similarity methods, ordinary Kriging (\protect\hyperlink{ref-krige1951}{Krige, 1951}) approaches interpolation by only considering the locations of nearby observations. Kriging conserves spatial dependence and ideally presents the \emph{on-the-ground} reality given enough observations. However, accurate Kriging interpolations are challenging in geodynamically diverse settings because the method assumes second order weak stationarity (the relationship among \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations is constant and only depends on the distance between points), which is likely violated in regions encompassing many interacting tectonic features. However, stationarity need only apply over the local Kriging domain, so this problem is overcome by careful choice of Kriging parameters. Although not applied in this study, modifications to Kriging may be considered, including relaxing assumptions of stationarity or applying techniques that respect the Second Law of Geography (\emph{spatial phenomena are inherently heterogeneous}, \protect\hyperlink{ref-goodchild2004}{Goodchild, 2004}), such as directional Kriging or Markov-Bayes techniques (\protect\hyperlink{ref-bardossy1997}{Bárdossy, 1997}).

This Chapter focuses on comparing the accuracy, resolution, and diversity of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend interpolations produced by Similarity and Kriging methods for 13 presently active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . The following questions are considered. At what resolution can spatial \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend patterns be confidently resolved with the current global database? Are Kriging and Similarity methods comparable when applied to \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{near }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow near subduction zones}\DIFaddend ? What do the differences (if any) imply about geodynamic variability among active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend , especially with respect to uniform upper-plate thickness discussed in Chapter \ref{chpt2}?

First, ordinary Kriging is applied to the \texttt{ThermoGlobe} database (\protect\hyperlink{ref-jennings2021}{Jennings \& Hasterok, 2021}; \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}) cropped within 1000 \(km\) buffers around 13 presently active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Kriging estimates and uncertainties are then directly compared (point-by-point) to Similarity interpolations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). The results show Kriging and Similarity methods are generally comparable for most subduction segments but Similarity estimates have considerably less error. This study highlights present challenges in inferring \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics quantitatively from \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend datasets and encourages characterization \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend patterns to the fullest extent possible. Scaling datasets and developing composite interpolation approaches promise better tools for distinguishing geodynamic variability near active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend .
...
Like Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}), 4,661 poor quality observations (\texttt{Code\ 6} = D), 350 data points without heat flow observations, and 2 without geographic information are excluded from the analysis. Note that quality control of such a large dataset is an ongoing endeavor and 11,712 observations currently have an undetermined quality (\texttt{Code\ 6} = Z). Duplicate observations at the same location are parsed (to avoid singular covariance matrices during Kriging) by selecting only the best quality measurement. If duplicate measurements are of equal quality, one is randomly chosen. Finally, only \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend values in the range (0 - 250{]} \(mWm^{-2}\) are included in Kriging. \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{Surface heat flow }\DIFaddend observations outside of the range (0 - 250{]} \(mWm^{-2}\) are considered anomalous (e.g.~collected near geothermal systems, \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}) and constitute a small fraction of measurements (4,883 out of 65,196) forming long tails on either side of the global \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend distribution. The final dataset used for Kriging contains 13,365 observations after filtering for quality, missing values, and heat flow range, parsing 14,119 duplicate pairs, and cropping within \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend buffers (Table \ref{tab:hfSummaryTable} \& Figure \ref{fig:hfSummaryPlot}).
...
\DIFdelbeginFL %DIFDELCMD < \caption[Distributions of \texttt{ThermoGlobe} observations near 13 active \gls{sz} segments]{%%%
\DIFdelendFL \DIFaddbeginFL \caption[Distributions of \texttt{ThermoGlobe} observations near 13 active subduction zone segments]{\DIFaddendFL Distribution of \texttt{ThermoGlobe} observations cropped within 1000 \(km\) circular buffers around 13 active \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zone }\DIFaddendFL segments. Heat flow distributions are centered between 41 and 108 \(mWm^{-2}\) and highly skewed right. Skewness represents near-surface perturbations from geothermal systems and tectonic regions with high thermal activity. Diverse interactions between tectonic and near-surface processes are apparent from the broad, irregular \DIFdelbeginFL %DIFDELCMD < \gls{shf} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{surface heat flow }\DIFaddendFL distributions. Distributions are colored by quantiles (25\%, 50\%, 75\%). Data from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}).}\label{fig:hfSummaryPlot}
\end{figure}
...
\texttt{ThermoGlobe} data and Similarity interpolations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) are transformed into a Pacific-centered Robinson \DIFdelbegin %DIFDELCMD < \gls{crs} %%%
\DIFdelend \DIFaddbegin \DIFadd{coordinate reference system }\DIFaddend defined using the \texttt{proj4} string ``\texttt{+proj=robin\ +lon\_0=-155\ +lon\_wrap=-155\ +x\_0=0\ +y\_0=0\ +ellps=WGS84\ +datum=WGS84\ +units=m\ +no\_defs}'' (\protect\hyperlink{ref-proj2021}{PROJ contributors, 2021}). All geographic operations, including transformation, cropping, Kriging, and comparing interpolations, are performed in the above \DIFdelbegin %DIFDELCMD < \gls{crs} %%%
\DIFdelend \DIFaddbegin \DIFadd{coordinate reference system }\DIFaddend using general-purpose functions in the \texttt{R} package \texttt{sf} (\protect\hyperlink{ref-pebesma2018}{Pebesma, 2018}). The Kriging domains (Figure \ref{fig:domainConstruct}) are defined by drawing 1000 \(km\) circular buffers around each \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segment defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Target locations for Kriging are defined across the same grid used by Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) to compute point-by-point differences with their Similarity interpolation.



\begin{figure}[htbp]

{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\linewidth,]{assets/figs/chpt3/KyushuRyukyuComp} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.6\linewidth,]{assets/figs/chpt3/KyushuRyukyuComp} 
\DIFaddendFL 

}

\caption[Example of an interpolation domain constructed around Kyushu Ryukyu]{Example of a interpolation domain constructed around Kyushu Ryukyu. Interpolation domains are defined by drawing a 1000 \(km\) circular buffer (thin black line) around the segment boundary (bold black line). \texttt{ThermoGlobe} data is cropped within the buffered region by intersection (left). Note that Kyushu Ryukyu is one of the most densely sampled regions, yet still has considerable gaps. Similarity interpolation (right) fills in the gaps and presents a textured distribution by combining many underlying geologic proxy datasets. Note that \DIFdelbeginFL %DIFDELCMD < \gls{shf} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{surface heat flow }\DIFaddendFL above 250 \(mWm^{-2}\) is colored white. Data and interpolations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). Segment boundary defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}).}\label{fig:domainConstruct}
\end{figure}
...
Optimized Kriging parameters, cross-validation errors, and associated cost are given in Table \ref{tab:vgrmSummaryTable} and Figure \ref{fig:vgrmSummaryPlot} (see Appendix \ref{krigeOpt} for details about the optimization procedure). Kriging parameters vary substantially from segment to segment but do not correlate with cost (with the possible exception of the variogram sill, Figure \ref{fig:vgrmSummaryPlot}). Despite a range of domain sizes, observation densities, and diverse tectonic configurations, all Kriging domains converge on solutions within 15-20 iterations (Figure \ref{fig:optTrace}) without noticeable patterns of error overall (Figure \ref{fig:vgrmSummaryPlot}). Differences in cost are apparently explained by constant segment-to-segment differences in \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend distributions (\(\sigma_{vgrm}\), \(\sigma_{interp}\), Equation \eqref{eq:costExp}) rather than differences in Kriging parameters. The variogram optimization methods are thus successfully generalizable across \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments without a need for case-by-case data manipulation or anisotropic variogram models.

\begin{table}

\caption{\label{tab:vgrmSummaryTable}Optimum variogram models by segment}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llrrrrrrrr}
\toprule
Segment & Model & Cutoff & Lags & Shift & $n_{max}$ & Sill & Range & RMSE & Cost\\
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{Bes} & \cellcolor{gray!6}{10.6} & \cellcolor{gray!6}{39.7} & \cellcolor{gray!6}{7.9} & \cellcolor{gray!6}{10.8} & \cellcolor{gray!6}{801} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{27} & \cellcolor{gray!6}{0.616}\\
Andes & Exp & 9.2 & 50.0 & 7.9 & 13.3 & 5990 & 344 & 35 & 0.297\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{6.9} & \cellcolor{gray!6}{35.0} & \cellcolor{gray!6}{9.1} & \cellcolor{gray!6}{12.5} & \cellcolor{gray!6}{3063} & \cellcolor{gray!6}{106} & \cellcolor{gray!6}{31} & \cellcolor{gray!6}{0.249}\\
Kamchatka Marianas & Lin & 1.0 & 34.6 & 7.1 & 10.4 & 1800 & 1458 & 32 & 0.426\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{41.5} & \cellcolor{gray!6}{8.2} & \cellcolor{gray!6}{11.8} & \cellcolor{gray!6}{1781} & \cellcolor{gray!6}{170} & \cellcolor{gray!6}{35} & \cellcolor{gray!6}{0.483}\\
Lesser Antilles & Lin & 10.0 & 39.0 & 6.3 & 12.6 & 905 & 77 & 10 & 0.309\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{10.6} & \cellcolor{gray!6}{35.1} & \cellcolor{gray!6}{6.0} & \cellcolor{gray!6}{12.6} & \cellcolor{gray!6}{1361} & \cellcolor{gray!6}{65} & \cellcolor{gray!6}{29} & \cellcolor{gray!6}{0.542}\\
New Britain Solomon & Lin & 1.7 & 41.1 & 7.6 & 13.3 & 706 & 251 & 26 & 0.617\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{32.9} & \cellcolor{gray!6}{7.7} & \cellcolor{gray!6}{12.6} & \cellcolor{gray!6}{1046} & \cellcolor{gray!6}{828} & \cellcolor{gray!6}{29} & \cellcolor{gray!6}{0.470}\\
Scotia & Exp & 15.3 & 39.4 & 7.8 & 12.6 & 21375 & 4510 & 19 & 0.238\\
...
Kriging cross-validation errors are within 3 (Lesser Antilles) to 63 (Vanuatu) \(mWm^{-2}\) of the quoted 7 \(mWm^{-2}\) \gls{rmse} for Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019})'s preferred Similarity model (7 proxy observables, Table \ref{tab:vgrmSummaryTable}). As expected, Kriging errors can be relatively small compared to Similarity for domains with high observation density (Lesser Antilles; n = 3,011) but relatively large where observational density is comparatively low (Vanuatu; n = 137). Please note, however, that Kriging error is evaluated only on observations within 1000 \(km\) buffers of \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments. The quoted 7 \(mWm^{-2}\) \gls{rmse} from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) evaluates error on \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations across all oceans and continents. Differentiating \glspl{rmse} in Table \ref{tab:vgrmSummaryTable} from errors reported by Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}; or other global interpolations: e.g. \protect\hyperlink{ref-goutorbe2011}{Goutorbe et al., 2011}; \protect\hyperlink{ref-pollack1993}{Pollack et al., 1993}; \protect\hyperlink{ref-shapiro2004}{Shapiro \& Ritzwoller, 2004}) are therefore only rough comparisons. It is unclear how Similarity uncertainty will scale overall when the domain is restricted to regional tectonic scales.

\DIFdelbegin %DIFDELCMD < \begin{figure}[htbp]
%DIFDELCMD < 

%DIFDELCMD < {\centering \includegraphics[width=1\linewidth,]{assets/figs/chpt3/vgrmSummary} 
%DIFDELCMD < 
...
%DIFDELCMD < %%%
%DIFDELCMD < \caption[Summary of optimized variogram models]{%
{%DIFAUXCMD
\DIFdelFL{Summary of optimized Kriging parameters. Differences in cost (error) are small among Kriging domains despite a diverse set of observation densities, tectonic configurations, initial search parameters, and variogram models. Cost does not correlate with Kriging parameters (with a possible exception of variogram sills), indicating the optimization procedure is successfully generalizeable across }%DIFDELCMD < \gls{sz} %%%
\DIFdelFL{segments.}}%DIFAUXCMD
%DIFDELCMD < \label{fig:vgrmSummaryPlot}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \hypertarget{globalDiff}{%
\subsection{Global Interpolation Differences}\label{globalDiff}}

Two point-by-point comparisons between Similarity and Kriging methods are presented in this study---\emph{estimates} and \emph{uncertainties}. Summary statistics for \emph{estimate} differences are given in Table \ref{tab:diffSummaryTable}. Summary statistics for \emph{uncertainty} differences are given in Appendix \ref{interpDiffAppendix}.

\begin{table}

\caption{\label{tab:diffSummaryTable}[Similarity $-$ Krige] estimate differences by segment}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llrrrrrrrr}
\toprule
Segment & Model & Min & Max & Median & IQR & Mean & $\sigma$ & n & Cost\\
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{Bes} & \cellcolor{gray!6}{-611} & \cellcolor{gray!6}{596} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{19} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{27} & \cellcolor{gray!6}{5779} & \cellcolor{gray!6}{0.606}\\
Andes & Cir & -136 & 2107 & 3 & 43 & 9 & 78 & 7623 & 0.297\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{-137} & \cellcolor{gray!6}{2318} & \cellcolor{gray!6}{15} & \cellcolor{gray!6}{59} & \cellcolor{gray!6}{43} & \cellcolor{gray!6}{135} & \cellcolor{gray!6}{2792} & \cellcolor{gray!6}{0.248}\\
Kamchatka Marianas & Lin & -133 & 180 & 5 & 19 & 7 & 23 & 7059 & 0.425\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{-109} & \cellcolor{gray!6}{167} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{19} & \cellcolor{gray!6}{6} & \cellcolor{gray!6}{21} & \cellcolor{gray!6}{2766} & \cellcolor{gray!6}{0.481}\\
Lesser Antilles & Cir & -106 & 108 & 4 & 15 & 3 & 21 & 2226 & 0.306\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{-74} & \cellcolor{gray!6}{151} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{23} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{21} & \cellcolor{gray!6}{1835} & \cellcolor{gray!6}{0.530}\\
...
\caption[Summary of differences between Similarity and Kriging estimates]{Summary of differences between Similarity and Kriging estimates. Note that differences are computed as {[}Similarity \(-\) Krige{]}. Differences are centered near zero with medians ranging from -3 to 15 \(mWm^{-2}\), but broadly distributed with interquartile ranges from 15 to 59 \(mWm^{-2}\) and long tails extending from -611 to 2318 \(mWm^{-2}\). Interpolation methods generally agree to within a few tens of \(mWm^{-2}\) near \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zone }\DIFaddendFL segments. Positive medians and right skew indicate systematic overestimation of \DIFdelbeginFL %DIFDELCMD < \gls{shf} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{surface heat flow }\DIFaddendFL by Similarity compared to Kriging. The broadest distributions (Andes and Central America) reflect less subtle differences between methods. Distributions are colored by quantiles (25\%, 50\%, 75\%). Similarity estimates from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). Please refer to Figure \ref{fig:sigmaDiffSummaryPlot} for uncertainty differences.}\label{fig:diffSummaryPlot}
\end{figure}

\hypertarget{regionalDiff}{%
\subsection{Regional Interpolation Differences}\label{regionalDiff}}

Notable sources of differences between Similarity and Kriging methods include 1) tectonic features resolved by Similarity that are smoothed-out by Kriging or 2) general discordance between the spatial continuity of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations and Similarity estimates. Examples given in this section highlight the range of differences observed between Similarity and Kriging methods in diverse interpolation domains. These include complex tectonic environments (Central America, Vanuatu), simple tectonic environments (Kyushyu Ryukyu), and regions with very few observations (Scotia). All other segments are in Appendix \ref{interpDiffAppendix}.

For example, high \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend representing the arms of the Galápagos triple junction are resolved by Similarity to the SW of the Central America segment (Figure \ref{fig:centralAmericaDiff}). However, the triple junction arms are not well defined by Kriging. The interpolation comparison for Central America highlights two distinct regions---bright positive differences along the arms of the triple junction and within the subducting Cocos Plate, and muted differences to the E and NE of the Cocos Plate behind the volcanic arc. Note the moderate differences within the Cocos Plate in Figure \ref{fig:centralAmericaDiff} where Similarity estimates relatively high \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend by proximity to the nearby spreading centers. Kriging estimates in the same region disagree because \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations within the Cocos Plate are, in fact, relatively low. Similar discordance between high Similarity estimates and low \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations are observed in many \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments, especially near spreading centers.
...
The Scotia segment illustrates a case where \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations are incredibly sparse. Similarity resolves the East Scotia Ridge (ESR) and the WSW-ENE trending transform boundary separating the Scotia and Sandwich Plates from the Antartic Plate (Figure \ref{fig:scotiaDiff}). Kriging, on the other hand, appears featureless because very few \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations (n = 25) poorly define experimental variograms. Kriging estimates thus approximate the expected (mean: 79 \(mWm^{-2}\)) value for the entire domain according to Equation \eqref{eq:linEstimate}. That is, Kriging provides no more geodynamic information than computing the arithmetic mean for \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations within 1000 \(km\) of the Scotia segment. Resolving spatial (dis)continuity is unfeasible and Similarity methods become the obvious choice in such cases.

While Similarity tends to define tectonic features and Kriging tends to smooth out tectonic features, the opposite pattern is observed within the tectonically-complex region near Vanuatu. Similarity resolves the N-S trending spreading center separating the New Hebrides plate from the Balmoral Reef and Conway Reef microplates (Figure \ref{fig:vanuatuDiff}). However, \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations are sufficiently dense and continuous to partially resolve the short ridge segments and transform faults outlining the microplates between Vanuatu and the Tonga New Zealand segments by Kriging. The differences are difficult to interpret because of the somewhat random discordance between interpolation methods.



\begin{figure}[htbp]

{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\linewidth,]{assets/figs/chpt3/CentralAmericaDiffComp} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.74\linewidth,]{assets/figs/chpt3/CentralAmericaDiffComp} 
\DIFaddendFL 

}

\caption[Similarity vs. Kriging estimates and uncertainties for Central America]{Similarity vs.~Kriging estimates and uncertainties for Central America. Arms of the Galápagos triple junction (GTJ), the East Pacific Rise (EPR) and Cocos Ridge (CR), are resolved by Similarity (topleft), but smoothed-out by Kriging (topright). Note the moderate positive differences between estimates within the Cocos Plate (CP) where Similarity estimates relatively high \DIFdelbeginFL %DIFDELCMD < \gls{shf}%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{surface heat flow}\DIFaddendFL , but \DIFdelbeginFL %DIFDELCMD < \gls{shf} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{surface heat flow }\DIFaddendFL observations are low (bottomleft). Patterns in uncertainty differences generally reflect observation density. Note that computed differences off the colorbar scale in the bottom plots are colored \DIFdelbeginFL \DIFdelFL{grey}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray}\DIFaddendFL . Bold and thin white lines represent the \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zone }\DIFaddendFL segment boundary and subducting plate depth, respectively, as defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Pink triangles are volcano locations also from Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). \texttt{ThermoGlobe} data and Similarity estimates from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}).}\label{fig:centralAmericaDiff}
\end{figure}
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\linewidth,]{assets/figs/chpt3/KyushuRyukyuDiffComp} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.65\linewidth,]{assets/figs/chpt3/KyushuRyukyuDiffComp} 
\DIFaddendFL 

}

\caption[Similarity vs. Kriging estimates and uncertainties for Kyushyu Ryukyu]{Similarity vs.~Kriging estimates and uncertainties for Kyushyu Ryukyu. High observation density and spatial coverage near Kyushu Ryukyu produces interpolations with similar estimates and texture (top plots). The estimate and uncertainty differences (bottom plots) are thus small compared to other \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zone }\DIFaddendFL segments. Note that computed differences off the colorbar scale in the bottom plots are colored \DIFdelbeginFL \DIFdelFL{grey}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray}\DIFaddendFL . Bold and thin white lines represent the \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zone }\DIFaddendFL segment boundary and plate depth, respectively, as defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Pink triangles are volcano locations also from Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). \texttt{ThermoGlobe} data and Similarity estimates from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}).}\label{fig:kyushuRyukyuDiff}
\end{figure}
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\linewidth,]{assets/figs/chpt3/ScotiaDiffComp} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.55\linewidth,]{assets/figs/chpt3/ScotiaDiffComp} 
\DIFaddendFL 

}

\caption[Similarity vs. Kriging estimates and uncertainties for Scotia]{Similarity vs.~Kriging estimates and uncertainties for Scotia. Similarity (topleft) resolves two tectonic features, the East Scotia Ridge (ESR) and a transform fault (TF) separating the Scotia and Sandwich Plates (SP, SAN) from the Antartic Plate (AP). Kriging (topright) is featureless because of incredibly sparse data. Few observations make Kriging a poor estimator of \DIFdelbeginFL %DIFDELCMD < \gls{shf} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{surface heat flow }\DIFaddendFL across the interpolation domain and provides no more information than computing the arithmetic mean of observations within the domain. Note that computed differences off the colorbar scale in the bottom plots are colored \DIFdelbeginFL \DIFdelFL{grey}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray}\DIFaddendFL . Bold and thin white lines represent the \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\linewidth,]{assets/figs/chpt3/VanuatuDiffComp} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.45\linewidth,]{assets/figs/chpt3/VanuatuDiffComp} 
\DIFaddendFL 

}

\caption[Similarity vs. Kriging estimates and uncertainties for Vanuatu]{Similarity vs.~Kriging estimates and uncertainties for Vanuatu. Similarity (topleft) resolves the spreading center separating the New Hebrides Plate (NHP) from the Balmoral Reef (BR) and Conway Reef (CR) microplates. Sufficient \DIFdelbeginFL %DIFDELCMD < \gls{shf} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{surface heat flow }\DIFaddendFL observations allow Kriging to resolve additional ridge segments and transform faults outlining BR and CR (topright). The difference between Similarity and Kriging estimates (bottomleft) are irregular and difficult to interpret. Note that computed differences off the colorbar scale in the bottom plots are colored \DIFdelbeginFL \DIFdelFL{grey}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray}\DIFaddendFL . Bold and thin white lines represent the \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
...
The two interpolation approaches compared in this Chapter are fundamentally based on different underlying assumptions encapsulated by the First and Third Laws of Geography. Kriging is based on the First Law: \emph{everything is related, but nearer things are more related} (\protect\hyperlink{ref-krige1951}{Krige, 1951}). Similarity is based on the Third Law: \emph{two points with similar geographic configurations should have similar values} (\protect\hyperlink{ref-zhu2018}{Zhu et al., 2018}). The comparisons in Section \ref{chpt3Results} provide new context for researchers interested in using \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{to investigate }%DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow to investigate subduction zone }\DIFaddend geodynamics. While one approach is not evidently \DIFdelbegin \DIFdel{favourable }\DIFdelend \DIFaddbegin \DIFadd{favorable }\DIFaddend in principle, Similarity produces more accurate interpolations in practice (at the scale and scope of active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend ), especially in cases with low observation density and irregularly-spacing.

Similarity generally produces interpolations that resolve discrete tectonic features (spreading centers and large fault systems) with detailed regional texture (see Appendix \ref{interpDiffAppendix}). The texture is artificial insofar as it does not represent actual spatial changes in \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow}\DIFaddend , but appears to be geodynamically consistent across all 13 active \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend considered in this study. The success of the Similarity approach comes from integration of multiple sources of geologic information---carefully compiled and combined into a composite estimate of \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow}\DIFaddend . Combining several (or dozens of) proxy datasets may be more meticulous than ordinary Kriging, yet Similarity works reliably well across all 13 active \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments. Kriging estimates, on the other hand, provide no additional information beyond simple arithmetic means for \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments that lack sufficient observation density (e.g.~Scotia, Figure \ref{fig:scotiaDiff}). While some use cases may exist for Kriging's inherent smoothing effect, geodynamically-consistent estimates of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{near }%DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow near subduction zones }\DIFaddend are likely more desirable in most cases.

Two inconsistencies with the Similarity approach are noted, however. First, Similarity systematically overestimates \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend compared to Kriging (Figure \ref{fig:diffSummaryPlot}). This may be partially explained by the restricted range ((0 - 250{]} \(mWm^{-2}\)) of \texttt{ThermoGlobe} observations used for Kriging. Or it may represent skewed distributions or overweighting of some proxies used in the Similarity interpolation method (e.g.~proximity to spreading centers, Figure \ref{fig:centralAmericaDiff}). Second, known features within the tectonically-complex region near Vanuatu may be better resolved by Kriging than Similarity. It is important to note, however, that Vanuatu is the only case where Kriging resolves tectonic features that Similarity does not; the trend is otherwise opposite. Moreover, the inconsistencies near Vanuatu do not imply algorithmic issues with Similarity and can likely be resolved by using a finer-scale grid.

The most important inconsistencies to evaluate, regardless of interpolation method, are general discordance between estimates and observations (e.g.~with \gls{rmse}). Disagreements with observations imply failures of the underlying Geographic Laws, which are not easily correctable algorithmically in a generalized sense. Similarity is demonstrably successful at achieving low error rates at the global-scale even when randomly combining proxies (\protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}). Assuming error rates for Similarity interpolations constrained to regional scales (e.g.~near \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments) are consistent with \glspl{rmse} reported by Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) for global scales, Similarity is on average 1 to 10 times more accurate than simple ordinary Kriging (compare 7 \(mWm^{-2}\) Similarity \gls{rmse} to Kriging \glspl{rmse} in Table \ref{tab:vgrmSummaryTable}). This is sound basis for presently \DIFdelbegin \DIFdel{favouring }\DIFdelend \DIFaddbegin \DIFadd{favoring }\DIFaddend Similarity over Kriging across \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segment scales. Exceptions may include regions with high observation density and spatial coverage, or regions that are far beneath the resolution of global proxy datasets (approximately \(0.5^\circ \times 0.5^\circ\)) used for Similarity (\protect\hyperlink{ref-goutorbe2011}{Goutorbe et al., 2011}; \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}).

Regardless of methodology, the accuracy and resolution of interpolations compared in this study are enough to probe hypotheses about regional geodynamic (in)consistencies among active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . Similarity and Kriging interpolations qualitatively show diverse patterns in \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{among }%DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow among subduction zone }\DIFaddend segments. Diverse patterns in \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend may imply spatially heterogeneous lithospheric thickness (contrary to expectations from Chapter \ref{chpt2}), spatially heterogeneous dynamics, spatially heterogeneous near-surface perturbations, and/or undersampling relative to the scale and magnitude of spatial variability. Please note, however, that spatially continuous \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend patterns also appear across \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments (e.g.~Sumatra Banda Sea, see Appendix \ref{interpDiffAppendix}). At present, cautious interpretations of \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics on the basis of spatial \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend patterns are encouraged. Scaling datasets and developing composite interpolation approaches (e.g.~layering Similarity + Kriging + \(\cdots\)) promises better tools for scrutinizing differences among regional tectonic domains.

\hypertarget{d-vs.-2d-spatial-variability}{%
\subsection{1D vs.~2D Spatial Variability}\label{d-vs.-2d-spatial-variability}}

Testing hypotheses relating to \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics requires careful sampling of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend in order to apply statistical models. Previous studies commonly use a four-part sampling strategy: 1) draw a cross-section line perpendicular to a trench, 2) draw a rectangle with arbitrary width encompassing the section line, 3) gather all \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations within the rectangle, and 4) project the gathered observations onto the section line (e.g. \protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-hyndman2005}{Hyndman et al., 2005}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). This sampling strategy is simple and effective if measurements along section lines are equally spaced with high spatial density. However, the strategy has two major limitations. First, the First Law of Geography is increasingly violated with the size of the sampling rectangle as more disparate points are projected onto the section line for comparison. Second, transects characterize \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend patterns within a narrow scope, and do not consider spatial variability in 2D (along strike in map view).

Hypotheses such as uniformly thin upper-plate lithospheres (Chapter \ref{chpt2}) and depths of plate coupling among \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (\protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}) are inferred from 1D sampling strategies like the one described above. However, the true extent of such characterizations of \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics is yet to be evaluated in 2D. Similarity and Kriging interpolations in Section \ref{chpt3Results} show spatial variability in \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend that appear to contradict such claims of uniformity within, or among, \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments. Insofar as \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend can answer questions about \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics, claims of broad uniformity among active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend are better qualified with observations that characterize the spatial variability of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend to the fullest extent possible.

\hypertarget{conclusions-1}{%
\section{Conclusions}\label{conclusions-1}}

This study uses ordinary Kriging to interpolate global \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend observations sampled within 1000 \(km\) buffers of 13 active \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments. Kriging interpolations are directly compared to Similarity interpolations within the same domains to evaluate the accuracy and effectiveness of each technique in distinguishing spatial patterns of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdel{near }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow near subduction zones}\DIFaddend . Differences between interpolation estimates and uncertainties highlight four important points of consideration:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Similarity and Kriging methods produce broadly comparable results, but Similarity interpolations are \DIFdelbegin \DIFdel{favoured }\DIFdelend \DIFaddbegin \DIFadd{favored }\DIFaddend for their lower error rates and geodynamically-consistent results across all 13 \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments
\item
  Interpolations show diverse 2D spatial patterns of (dis)continuous \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow}\DIFaddend , encouraging cautious interpretations of subsurface geodynamics without characterizing \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend distributions to the fullest extent possible
\item
  Dataset scaling and composite interpolation approaches promise better tools for evaluating geodynamic diversity within, and among, \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments and is proposed for future research
\end{enumerate}
...
\begin{itemize}
\item
  Over one-million markers are traced across 64 \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend simulations
\item
...
\Glsfirst{hp} metamorphic rocks that are detached (recovered) from subducting oceanic-plates and exhumed to the Earth's surface become invaluable records of \DIFdelbegin %DIFDELCMD < \glsfirst{pts} %%%
\DIFdelend \DIFaddbegin \DIFadd{P-T-strain }\DIFaddend fields deep in \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . For example, comparing metamorphic \glsfirst{ptt} estimates from suites of \gls{hp} rocks allows for evaluation of \gls{pt} gradients along the plate interface through time. However, some incongruent interpretations concerning \gls{pt} gradients, recovery rates, and recovery depths arise when comparing globally aggregated \gls{ptt} estimates with \gls{pt} gradients from numerical geodynamic models. This study evaluates marker recovery in numerical simulations of oceanic-continental convergence across a range of initial \DIFdelbegin %DIFDELCMD < \glsfirst{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend representing presently active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . Over one-million markers traced from 64 simulated \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend are classified as recovered, or lost, by implementing a soft clustering classification algorithm. Marker \gls{ptt} distributions are compared across models and with the rock record to address the following questions. How do recovery rates vary among \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend ? How is recovery distributed along the plate interface, and how does it vary among \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend and through time? Marker \gls{ptt} distributions and recovery rates show sensitivity to oceanic-plate age, convergence velocity, and relative detachment timing, but not to upper-plate lithospheric thickness. Marker \gls{ptt} distributions are distinct from the rock record across all but the slowest-converging (40 \(km/Ma\)) simulations. Four geodynamic regimes with different recovery modes are recognized and discussed with implications for interpreting the rock record. This study highlights the immediate usefulness of augmenting observational constraints with a large (91,733) simulated dataset.

\hypertarget{chpt4Intro}{%
\section{Introduction}\label{chpt4Intro}}

Maximum metamorphic conditions, in terms of \glsfirst{pt}, have been estimated for hundreds of \glsfirst{hp} rocks exhumed from \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (Figure \ref{fig:pd15}, \protect\hyperlink{ref-agard2018}{Agard et al., 2018}; \protect\hyperlink{ref-penniston2015}{Penniston-Dorland et al., 2015}). Aggregated suites of \gls{hp} rocks (the \emph{rock record}) are the only tangible record of \DIFdelbegin %DIFDELCMD < \glsfirst{pts} %%%
\DIFdelend \DIFaddbegin \DIFadd{P-T-strain }\DIFaddend fields experienced by Earth's lithosphere during deformation and chemical processing in \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (e.g. \protect\hyperlink{ref-agard2009}{Agard et al., 2009}, \protect\hyperlink{ref-agard2018}{2018}; \protect\hyperlink{ref-penniston2015}{Penniston-Dorland et al., 2015}). Together with geophysical imaging (e.g. \protect\hyperlink{ref-ferris2003}{Ferris et al., 2003}; \protect\hyperlink{ref-hyndman2003}{Hyndman \& Peacock, 2003}; \protect\hyperlink{ref-naif2015}{Naif et al., 2015}; \protect\hyperlink{ref-rondenay2008}{Rondenay et al., 2008}; \protect\hyperlink{ref-syracuse2006}{Syracuse \& Abers, 2006}), surface heat flow (e.g.~Chapter \ref{chpt3}, \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-gao2014}{Gao \& Wang, 2014}; \protect\hyperlink{ref-hyndman2005}{Hyndman et al., 2005}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}), and forward numerical modelling (e.g. \protect\hyperlink{ref-gerya2008}{Gerya et al., 2008}; \protect\hyperlink{ref-gerya2002}{Gerya et al., 2002}; \protect\hyperlink{ref-gerya2006}{Gerya \& Stöckhert, 2006}; \protect\hyperlink{ref-hacker2003}{Hacker et al., 2003}; \protect\hyperlink{ref-mckenzie1969}{McKenzie, 1969}; \protect\hyperlink{ref-peacock1990}{Peacock, 1990}, \protect\hyperlink{ref-peacock1996}{1996}; \protect\hyperlink{ref-sizova2010}{Sizova et al., 2010}; \protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}; \protect\hyperlink{ref-yamato2007}{Yamato et al., 2007}; \protect\hyperlink{ref-yamato2008}{Yamato et al., 2008}), the rock record underpins contemporary understandings of \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics (e.g. \protect\hyperlink{ref-agard2009}{Agard et al., 2009}, \protect\hyperlink{ref-agard2018}{2018}; \protect\hyperlink{ref-bebout2007}{Bebout, 2007}).
...
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend near 2.3 \(GPa\) (\protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}) is consistent with a relative probability decrease above 2.4 \(GPa\) implied by \texttt{pd15}'s \gls{cdf}, Chapter \ref{chpt3} shows evidence from 2D interpolations of \DIFdelbegin %DIFDELCMD < \glsfirst{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend in contradiction of uniform coupling depths. Moreover, it is unclear if \texttt{pd15}'s \gls{cdf} implies a shift in the probability of \emph{recovery} or \emph{exhumation} of oceanic material from around 2.4 \(GPa\), or perhaps a simpler explanation such as sampling bias (i.e.~more greenschists and blueschists have been studied relative to (ultra-)\gls{hp} rocks).

Second, \gls{hp} rocks recovered from pressures of \(\leq\) 2 \(GPa\) generally record higher temperatures than estimated by some numerical experiments (\protect\hyperlink{ref-penniston2015}{Penniston-Dorland et al., 2015}). Potential explanations for non-overlapping \gls{pt} distributions among \gls{hp} rocks and numerical models include choice of \DIFdelbegin %DIFDELCMD < \glsfirst{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend for numerical experiments (oceanic-plate age, convergence velocity, subduction dip angle, upper-plate thickness, heating sources, etc.), differential exhumation of \gls{hp} rocks from \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend with higher average \gls{pt} gradients, and comparisons among suites of undifferentiated \gls{hp} rocks with variable relative detachment timing (\protect\hyperlink{ref-abers2017}{Abers et al., 2017}; \protect\hyperlink{ref-agard2018}{Agard et al., 2018}; \protect\hyperlink{ref-kohn2018}{Kohn et al., 2018}; \protect\hyperlink{ref-penniston2015}{Penniston-Dorland et al., 2015}; \protect\hyperlink{ref-vankeken2019}{van Keken et al., 2019}). Please note, however, that many comparisons among diverse numerical experiments and metamorphic terranes show various extents of agreement depending on one's choice of initial \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend and preferred suite(s) of \gls{hp} rocks (\protect\hyperlink{ref-angiboust2012b}{Angiboust et al., 2012b}; \protect\hyperlink{ref-burov2014}{Burov et al., 2014}; \protect\hyperlink{ref-holt2021}{Holt \& Condit, 2021}; \protect\hyperlink{ref-plunder2018}{Plunder et al., 2018}; \protect\hyperlink{ref-roda2010}{Roda et al., 2010}, \protect\hyperlink{ref-roda2012}{2012}, \protect\hyperlink{ref-roda2020}{2020}; \protect\hyperlink{ref-ruh2015}{Ruh et al., 2015}; \protect\hyperlink{ref-yamato2007}{Yamato et al., 2007}; \protect\hyperlink{ref-yamato2008}{Yamato et al., 2008}). Such assorted conclusions warrant further investigation into the general response of \gls{ptt} distributions to broad ranges of \DIFdelbegin %DIFDELCMD < \gls{tkbc}%%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions}\DIFaddend .
...
Two hypotheses regarding mechanical processing of oceanic material in \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend follow from the above observations:
...
\item
  Recovery rates of \gls{hp} rocks vary with \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend (null: recovery rates are not different among \DIFdelbegin %DIFDELCMD < \gls{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone}\DIFaddend )
\end{enumerate}
\end{quote}

These hypotheses aim at important questions in \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend research. Are \gls{hp} rocks recovered broadly along the plate interface or discretely? Are \gls{hp} rocks differentially recovered from \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdel{with favourable }%DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones with favorable thermo-kinematic boundary conditions }\DIFaddend or is recovery ubiquitous among \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend ? How do recovery rates change across diverse \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend ?

The primary obstacle in addressing such questions is differentiating an unrestrained number of possible forward models with relatively few (dozens) \gls{ptt} estimates from any particular exhumed \gls{hp} metamorphic terrane. In other words, there is an imbalance between the size and scope of possible \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend models and the size and scope of observational constraints. This Chapter addresses the problem by augmenting observational constraints with a large (91,733) simulated \gls{ptt} dataset. More than one million markers are traced from 64 numerical experiments representing the range of \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend for presently active oceanic-continental margins (experiments from Chapter \ref{chpt2}, \protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}; \protect\hyperlink{ref-syracuse2006}{Syracuse \& Abers, 2006}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). Traced markers are classified as recovered, or lost, according to characteristics of their \gls{ptt} paths using a soft clustering classification algorithm. \gls{pt} distributions of markers appear sensitive to convergence rate and oceanic-plate age, but insensitive to \DIFdelbegin %DIFDELCMD < \glsfirst{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend (contrary to expectations from Chapter \ref{chpt2}). Further, recovery rates are strongly dependent on initial \DIFdelbegin %DIFDELCMD < \gls{tkbc}%%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions}\DIFaddend , characterized by the thermal parameter \(\Phi\). Four distinct geodynamic regimes are identified and their implications are discussed for interpreting aggregate \gls{pt} datasets like \texttt{pd15}.

\hypertarget{chpt4Methods}{%
\section{Methods}\label{chpt4Methods}}

This study presents a dataset of Lagrangian markers (described below) from the numerical experiments in Chapter \ref{chpt2} (\protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}). The experiments simulate 64 oceanic-continental convergent margins with \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend (oceanic-plate age, convergence velocity, and upper-plate lithospheric thickness) that generally represent the range of presently active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
...
\DIFdelbegin %DIFDELCMD < \hypertarget{maker-classification}{%
%DIFDELCMD < \subsection{Maker Classification}\label{maker-classification}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \hypertarget{marker-classification}{%
...
Classifying markers as either \emph{recovered} or \emph{lost} based solely on their undifferentiated traced histories defines an unsupervised classification problem (\protect\hyperlink{ref-barlow1989}{Barlow, 1989}). This study implements a \DIFdelbegin %DIFDELCMD < \gls{gmm} %%%
\DIFdelend \DIFaddbegin \DIFadd{Gaussian mixture model }\DIFaddend (Appendix \ref{gmm}, \protect\hyperlink{ref-reynolds2009}{Reynolds, 2009}), which is a type of ``soft'' clustering algorithm used extensively to solve such problems. In this case, \DIFdelbegin %DIFDELCMD < \gls{gmm} %%%
\DIFdelend \DIFaddbegin \DIFadd{Gaussian mixture model }\DIFaddend organizes markers into groups (clusters) by fitting \(k=10\) bivariate Gaussian distributions to their maximum \gls{pt} (attained at depths of at least 20 \(km\); maximum P and T are considered independently). ``Fitting'' refers to adjusting parameters of all \(k\) Gaussians (centroids and covariance matrices) until the Gaussian ellipsoids and data achieve maximum likelihood (see Appendix \ref{gmm}). Groups of markers are then labeled as either \emph{recovered} or \emph{lost} based on cluster centroid locations in \gls{pt} space and other simple rules given in Table \ref{tab:rules}.
...
\caption[\gls{pt} distribution of recovered markers from all simulations]{\gls{pt} distribution of recovered markers from all simulations. Maximum \gls{pt} for 91,733 recovered markers compiled from all 64 \DIFdelbeginFL %DIFDELCMD < \gls{sz} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subduction zone }\DIFaddendFL simulations (left; colored contours) show an asymmetric, bimodal distribution with a high-probability peak around 1 \(GPa\) (upper-greenschist to lower-blueschist facies) and a modest probability hill around 2.5 \(GPa\) (upper-blueschist to eclogite facies). Recovered markers neither completely overlap with the rock record (\texttt{pd15}; light \DIFdelbeginFL \DIFdelFL{grey }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray }\DIFaddendFL density contours) in absolute \gls{pt} nor in terms of probability density. The \gls{cdf} (right) shows markers recovered between approximately 0.8 and 2.4 \(GPa\) (greenschists to upper-blueschist) are especially overrepresented in the rock record (\texttt{pd15}; \DIFdelbeginFL \DIFdelFL{grey }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray }\DIFaddendFL line) compared to simulations (black line). Rocks with maximum pressures above 2.4 \(GPa\) (eclogites) are also overrepresented in the rock record (to a lesser degree) compared to simulations. Note that the gap between the \DIFdelbeginFL \DIFdelFL{grey }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray }\DIFaddendFL and black lines (right) represents the relative difference in abundance of recovered material between \texttt{pd15} and simulations. Thin black lines are average \gls{pt} gradients of 5 \(K/km\) and 20 \(K/km\) (calculated with a lithostatic gradient of 35 \(km/GPa\)).}\label{fig:meta}
\end{figure}

To better understand how rock recovery varies among \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend , marker \gls{pt} distributions are visualized in terms of convergence velocity (Figure \ref{fig:cvDensity}), oceanic-plate age (Figure \ref{fig:ageDensity}), upper-plate lithospheric thickness (Figure \ref{fig:zupDensity}), and relative detachment timing (Figure \ref{fig:detachDensity}). Each of these effects is summarised below.

\begingroup
\DIFdelbegin %DIFDELCMD < \renewcommand{\baselinestretch}{1}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \renewcommand{\baselinestretch}{1.5}
\DIFaddend 
...
\item \uline{\textit{note}}: $\sigma_{rec}\%$ is computed from 100 initializations of \DIFdelbegin %DIFDELCMD < \gls{gmm} %%%
\DIFdelend \DIFaddbegin \DIFadd{Gaussian mixture model }\DIFaddend clustering with 10 percent of markers randomly left out
\end{TableNotes}
\begin{longtable}[t]{lrrrrrrrrrrrrrr}
\caption{\label{tab:recSummary}\DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{Subduction zone }\DIFaddend parameters and marker recovery rates}\\
\toprule
...
\endfirsthead
\caption[]{\label{tab:recSummary}\DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{Subduction zone }\DIFaddend parameters and marker recovery rates \textit{(continued)}}\\
\toprule
\multicolumn{5}{c}{Model Parameters} & \multicolumn{10}{c}{Marker Classification} \\
\cmidrule(l{3pt}r{3pt}){1-5} \cmidrule(l{3pt}r{3pt}){6-15}
model & $\Phi$ & $Z_{UP}$ & age & $\vec{v}$ & n & recov' & lost & subd' & collsn & phase chng & P anom' & T anom' & recov'\% & $\sigma_{rec'}\%$\\
...
\caption[\gls{pt} distribution of recovered markers by convergence velocity]{\gls{pt} distribution of recovered markers by convergence velocity (panel headers = \(km/Ma\)). Marker \gls{pt} distributions (colored contours) are remarkably different for the lowest-convergence simulations (topleft; 40 \(km/Ma\)) compared to all other convergence rates (\(\geq\) 66 \(km/Ma\)). The slowest-converging simulations recover fewer markers (distribution is smoother) along lower average \gls{pt} gradients, and have more uniform probability density across pressures \(\geq\) 2 \(GPa\). Faster-converging simulations (\(\geq\) 66 \(km/Ma\)) show more segregated distributions with significant gaps in recovery around 2 \(GPa\) (blueschist facies). The rock record (\texttt{pd15}; light \DIFdelbeginFL \DIFdelFL{grey }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray }\DIFaddendFL contours) is most consistent with slow convergence (\(<\) 66 \(km/Ma\)) in terms of probability density but more consistent with the faster convergence (\(\geq\) 66 \(km/Ma\)) in terms of absolute \gls{pt}. An apparent threshold and geodynamic shift exists between velocities of 40 to 66 \(km/Ma\). Thin black lines are average \gls{pt} gradients of 5 \(K/km\) and 20 \(K/km\) (calculated with a lithostatic gradient of 35 \(km/GPa\)).}\label{fig:cvDensity}
\end{figure}
...
\caption[\gls{pt} distribution of recovered markers by oceanic-plate age]{\gls{pt} distribution of recovered markers by oceanic-plate age (panel headers = \(Ma\)). Marker \gls{pt} distributions (colored contours) show a trend towards lower recovery rates (smoother contours), a shift towards higher average pressures, and more uniform probability density across 1.5 to 2.5 \(GPa\) (lower-blueschist to lower-eclogite facies) with increasing oceanic-plate age. The rock record (\texttt{pd15}; light \DIFdelbeginFL \DIFdelFL{grey }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gray }\DIFaddendFL contours) generally agrees more with older oceanic-plates (\(\geq\) 85 \(Ma\)), yet is still distinct. Thin black lines are average \gls{pt} gradients of 5 \(K/km\) and 20 \(K/km\) (calculated with a lithostatic gradient of 35 \(km/GPa\)).}\label{fig:ageDensity}
\end{figure}

\hypertarget{upper-plate-thickness-effect}{%
\subsubsection{Upper-plate Thickness Effect}\label{upper-plate-thickness-effect}}

Chapter \ref{chpt2} demonstrates an association between \DIFdelbegin %DIFDELCMD < \glsfirst{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend and coupling depth in the same numerical experiments that markers are sampled from (\protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020} ). \gls{pt} distributions of markers are therefore expected to respond strongly to changes in \DIFdelbegin %DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness}\DIFaddend , especially with respect to pressure (depth). However, a surprisingly modest effect is observed (Figure \ref{fig:zupDensity}). Marker density transitions towards more uniform distributions and higher top-end pressures with increasing \DIFdelbegin %DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness}\DIFaddend , while average \gls{pt} gradients significantly decrease. The shift towards more abundant (ultra-)\gls{hp} rocks with increasing \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend is more modest than anticipated from Chapter \ref{chpt2} but still consistent with a general increase in mechanical coupling depth with increasing \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend (\protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}; \protect\hyperlink{ref-ruh2015}{Ruh et al., 2015}).
...
\caption[Recovery rates for all 64 subduction simulations]{Recovery rates for all 64 subduction simulations by \DIFdelbeginFL %DIFDELCMD < \glsfirst{tkbc}%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{thermo-kinematic boundary conditions}\DIFaddendFL . Negative correlations are observed among recovery rate, oceanic-plate age (\(Ma\)), convergence velocity (\(km/Ma\)), and thermal parameter (\(\Phi\); \(km/100\)). Note that \(\Phi\) is simply the product of oceanic-plate age and convergence velocity. No apparent correlation is observed between recovery rate and upper-plate thickness (\(km\)). Data point size and color represent the \DIFdelbeginFL %DIFDELCMD < \glsfirst{iqr} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{interquartile range }\DIFaddendFL of maximum marker pressures (\(GPa\)). The youngest and slowest-moving oceanic-plates generally have the highest recovery rates and marker recovery across broader ranges of pressures.}\label{fig:recRate}
\end{figure}
...
Marker recovery rates show a smooth negative correlation with \(\Phi\) and no correlation with \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend (Figure \ref{fig:recRate}). Geodynamic factors contributing to this association are difficult to deduce, however, partly because \(\Phi\) itself was formulated from a general relationship among \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend to explain differences in earthquake distributions among \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (\protect\hyperlink{ref-gorbatov1997}{Gorbatov \& Kostoglodov, 1997}; \protect\hyperlink{ref-kirby1991}{Kirby et al., 1991}; \protect\hyperlink{ref-mckenzie1969}{McKenzie, 1969}; \protect\hyperlink{ref-molnar1979}{Molnar et al., 1979}), and likely never intended as a precise tool for investigating \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics. Notwithstanding, oceanic-plate age appears to explain most of the correlation between recovery rates and \(\Phi\). Average recovery rate drops systematically with increasing oceanic-plate age. In contrast, only the slowest-converging simulations (40 \(km/Ma\)) appear to have distinct recovery rates compared to more quickly-converging simulations (\(\geq\) 66 \(km/Ma\); Figure \ref{fig:recRate}).

A common observation among simulations with young oceanic-plates, especially at slow convergence rates, are high subduction angles. Moreover, simulations with high subduction angles tend to create more space for underplating detached material (see Figure \ref{fig:geodyn}, discussed below). These observations imply recovery rates respond to \(\Phi\) because of differences in plate flexibility and overall subduction geometry, rather than oceanic-plate age and convergence velocity \emph{per se}. Please note, however, that subduction angle appears to be most strongly correlated with subduction duration compared to other \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend (\protect\hyperlink{ref-hu2020}{Hu \& Gurnis, 2020}). Drawing a relationship among \(\Phi\), subduction angle, and recovery rates, without also considering subduction duration, is therefore inconclusive. Recovery rates may obviously correlate with \(\Phi\), but a concrete explanation is difficult to untangle.
...
\caption[Cumulative probability distributions of marker `maxP` by thermo-kinematic initial conditions]{\DIFdelbeginFL %DIFDELCMD < \glspl{cd} %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Coupling depths }\DIFaddendFL of recovered marker pressures by \DIFdelbeginFL %DIFDELCMD < \gls{tkbc}%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{thermo-kinematic boundary conditions}\DIFaddendFL . Convergence velocity has the largest effect on the pressure distributions of recovered markers (topleft). Only the slowest-converging simulations (40 \(km/Ma\)) resemble the rock record (\texttt{pd15}; thin jagged black line) and are distinct from faster-converging simulations (\(\geq\) 66 \(km/Ma\)), implying a geodynamic shift towards more discrete recovery along the plate interface at \textgreater{} 40 \(km/Ma\). Oceanic-plate ages have a moderate effect on marker recovery, with older plates recovering more markers from 1.5 to 2.5 \(GPa\) (topright). The thermal parameter shows a range of marker distributions that reflect the combined effects of convergence velocity and age (bottomleft). Upper-plate thickness has surprisingly little effect on marker recovery (bottomright). Regardless of \DIFdelbeginFL %DIFDELCMD < \gls{tkbc}%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{thermo-kinematic boundary conditions}\DIFaddendFL , most simulations present distributions that do overlap with \texttt{pd15}. \gls{hp} rocks between 0.8 and 2.4 \(GPa\) are overrepresented in \texttt{pd15} compared to most simulations.}\label{fig:ecdfs}
\end{figure}

The fact that very few simulations recover as many markers from 0.8 to 2.4 \(GPa\) compared to \texttt{pd15}, except for the slowest-converging systems (Figure \ref{fig:ecdfs}), is a key result of this study. Different possible interpretations may follow from this observation. For example, the rock record may be comprised of \gls{hp} rocks mostly recovered from slowly-converging \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . Alternatively, the rock record may not reflect the true distribution of \gls{hp} rocks recovered in \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend and is overrepresented (biased) by \gls{hp} rocks between 0.8 to 2.4 \(GPa\). A simple calculation may test the former interpretation:

\begin{quote}
One-half of modern day \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend segments have estimated convergence velocities below 66 \(km/Ma\) (\protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}). As a conservative estimate, the prior probability of sampling a \gls{hp} rock from a slowly-converging system is around 50\%, assuming the proportion of slowly-converging systems is constant through time and recovery rates are equal among \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . So the chance of sampling a \gls{hp} rock from a slowly-converging system is not exceedingly small. However, the probability that half (n = 130) of \gls{hp} rocks in \texttt{pd15} with pressure estimates between 0.8 and 2.4 \(GPa\) (n = 260) were sampled from slowly-converging systems can be approximated by a binomial probability distribution:
...
In other words, there is a 5\% chance that 130/260 \gls{hp} rocks in \texttt{pd15} were sampled exclusively from slowly-converging (\(\leq\) 66 \(km/Ma\)) \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . It is therefore unlikely that \texttt{pd15} represents preferential sampling of \gls{hp} rocks from only slowly-converging \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (the same principle can also be applied to other \DIFdelbegin %DIFDELCMD < \gls{tkbc}%%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions}\DIFaddend ). Rather, it is much more likely that \texttt{pd15} reflects an overabundance of undifferentiated samples between 0.8 and 2.4 \(GPa\). While the true distribution of \gls{hp} rock recovered globally cannot be known, rough calculations demonstrating the improbability of preferential sampling from a subset of \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend and a general inconsistency among marker \gls{pt} distributions and the rock record stress the importance of differentiating \gls{pt} estimates with relevant metadata. For example, sorting aggregated suites of \gls{hp} rocks by like metamorphic ages, lithologies, and estimates for \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend (e.g. \protect\hyperlink{ref-agard2018}{Agard et al., 2018}), make for better comparisons with natural and simulated \gls{ptt} datasets.
...
This study traces \gls{ptt} paths of more than one-million markers from 64 subduction simulations, identifies recovered markers, and computes their \gls{pt} distributions across a range of \DIFdelbegin %DIFDELCMD < \gls{tkbc}%%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions}\DIFaddend . \gls{ptt} distributions of recovered markers are compared with the rock record (\texttt{pd15}) to address the following hypotheses:
...
With respect to the first hypothesis, \gls{pt} distributions of recovered markers are distinct from the rock record (\texttt{pd15}) across almost all simulations except for a minority of slowly-converging models (40 \(km/Ma\), Figure \ref{fig:ecdfs}), and models that develop separated mantle wedges and diapirs (Figure \ref{fig:geodyn}). The majority of simulations recovery relatively few markers from 0.8 to 2.4 \(GPa\) compared to \texttt{pd15}. This result implies \texttt{pd15} is overrepresented (biased) by \gls{hp} rocks between 0.8 and 2.4 \(GPa\). Differentiating the rock record by relevant metadata (lithology, metamorphic ages, \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend estimates) is critically important to select against such bias (e.g. \protect\hyperlink{ref-agard2018}{Agard et al., 2018}).

With respect to the second hypothesis, recovered markers show a negative correlation between \(\Phi\) and recovery rate, implying a strong dependence of recovery rates on \DIFdelbegin %DIFDELCMD < \gls{tkbc}%%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions}\DIFaddend . However, simulations also show an apparent association between recovery rates and subduction angle. This may imply that recovery rates are sensitive to \(\Phi\) because of differences in subduction geometry, rather than oceanic-plate age or convergence velocity \emph{per se}. Correlations among recovery rate and \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend are difficult to untangle because \(\Phi\) conflates thermo-kinematic effects (by design) and is therefore not the most precise explanatory variable. While a correlation between recovery rates and \(\Phi\) is apparent, the sensitivity of recovery rates to \DIFdelbegin %DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{thermo-kinematic boundary conditions }\DIFaddend (Figure \ref{fig:recRate}), especially subduction geometry, warrants further investigation.
...
This work uses three computational approaches---simulation, interpolation, and applied statistics---to address the following question. How diverse is mechanical \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend along the plate interface across a range of plausible \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend configurations?

Plate coupling observed in numerical simulations from Chapter \ref{chpt2} demonstrate steady-state mechanical \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend regulated self-consistently by feedbacks involving heat transfer and metamorphic dehydration of ultramafic sheet silicates in the upper-plate mantle. \DIFdelbegin %DIFDELCMD < \Glsfirst{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{Coupling depth }\DIFaddend is only weakly correlated with \(\Phi\) but strongly correlated with upper-plate lithospheric thickness. Thus uniform \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend are expected if \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend have uniformly thick upper-plates, which is indeed the case when considering averaged backarc \DIFdelbegin %DIFDELCMD < \glsfirst{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend for 17 presently active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (\protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-hyndman2005}{Hyndman et al., 2005}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}).

However, 2D interpolations in Chapter \ref{chpt3} show diverse spatial patterns of \DIFdelbegin %DIFDELCMD < \gls{shf}%%%
\DIFdel{---some }\DIFdelend \DIFaddbegin \DIFadd{surface heat flow---some }\DIFaddend implying homogeneous thermal structure, others implying heterogeneous thermal structure---near 13 presently active \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . While Kriging methods yield inconsistent results for segments with low observation densities, Similarity methods show geologically-consistent interpolations of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend across all segments. Both methods, where applicable, generally agree and present \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend interpolations in contradiction of broadly uniform upper-plate lithospheric thickness inferred from other (1D) sampling strategies (e.g. \protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-hyndman2005}{Hyndman et al., 2005}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). These results imply broadly non-uniform \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdel{among }%DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths among subduction zones}\DIFaddend .

Chapter \ref{chpt4} takes a different approach by considering what \gls{pt} distributions of \gls{hp} rocks imply about mechanical variability among \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend . A large (91,733) dataset of recovered markers shows marker \gls{ptt} distributions and recovery rates correlate with \(\Phi\) and subduction duration, but not upper-plate lithospheric thickness (as expected from Chapter \ref{chpt2}). These results imply broad differences in the mechanics of rock recovery through time and among \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend .

While self-regulating mechanisms of uniform (and sustained) depths of plate coupling among different \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend are plausible (Chapter \ref{chpt2}), 2D interpolations of \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend (Chapter \ref{chpt3}), and \gls{ptt} distributions of recovered markers (Chapter \ref{chpt4}) imply a more diverse picture of mechanical \DIFdelbegin \DIFdel{behaviour across different }%DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{behavior across different subduction zone }\DIFaddend settings. One reason for such assorted conclusions is using a relatively crude explanatory variable (\(\Phi\)) for comparison. \(\Phi\) is demonstrably useful for explaining variability among some features of \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend geodynamics (\protect\hyperlink{ref-gorbatov1997}{Gorbatov \& Kostoglodov, 1997}; \protect\hyperlink{ref-kirby1991}{Kirby et al., 1991}; \protect\hyperlink{ref-molnar1979}{Molnar et al., 1979}; \protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}), but demonstrably ineffective in many cases (\protect\hyperlink{ref-maunder2019}{Maunder et al., 2019}). Future work may focus on developing new explanatory variables, scaling \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend datasets, and developing composite interpolation approaches to better estimate relative geodynamic variability among \DIFdelbegin %DIFDELCMD < \glspl{sz}%%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones}\DIFaddend .
...
\addcontentsline{toc}{chapter}{\texttt{ThermoGlobe} References}
...
\caption[Serpentine stability depth vs. time]{Serpentine stability depth at the plate interface vs. time for models cda, cdf, and cdp with $Z_{UP}$ = 46, 62, 78, and 94 $km$. Serpentine stabilization deepens for approximately 5 $Ma$ of subduction and then remains roughly constant for $\leq$ 10 $Ma$. The exceptions are models with very thin $Z_{UP}$, which exhibit transient behavior for at least 15 $Ma$. Overall serpentine stability depth after approximately 5 $Ma$ depends on \DIFdelbeginFL %DIFDELCMD < \gls{upt}%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{upper-plate thickness}\DIFaddendFL .}\label{fig:antDepth}
\end{figure}

Numerical experiments in this chapter suggest a negative dynamic feedback regulating coupling and serpentine dehydration can help explain how similar configurations, in terms of depths to subducting plates beneath arcs (\protect\hyperlink{ref-england2004}{England et al., 2004}) and thin \DIFdelbegin %DIFDELCMD < \glspl{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plates }\DIFaddend (\protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}), may occur in \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdel{with different }%DIFDELCMD < \gls{tkbc} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones with different thermo-kinematic boundary conditions }\DIFaddend and subduction durations. The results indicate that \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend quickly (\(<\) 5 \(Ma\)) develop and stabilize quasi-permanent, generalized configurations with \DIFdelbegin \DIFdel{glspl\{cd\} dependent on }%DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth dependent on upper-plate thickness}\DIFaddend .

Notable exceptions occur in models with the thinnest \DIFdelbegin %DIFDELCMD < \glspl{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plates }\DIFaddend (\(Z_{UP}\) = 46 \(km\)). Rapid extension due to thin \DIFdelbegin %DIFDELCMD < \glspl{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plates }\DIFaddend form spreading centers in the upper-plate within 5 \(Ma\). Passive asthenospheric upwelling near spreading centers diverts heat from deep within the upper-plate mantle. Enough heat is apparently diverted to disrupt thermal feedbacks regulating coupling and serpentine stability near the plate interface. In principle, diversion of heat from the plate interface could lead to cooler conditions, deeper serpentine stability, and thus deeper coupling. Further testing to confirm this \DIFdelbegin \DIFdel{behaviour }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend may artificially increase upper-plate strength in thin \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend experiments to prevent high rates of spreading.
...
\caption[Results for model cdf with $Z_{UP}$ = 78 $km$ at 5.05 $Ma$]{Visualizing model cdf with $Z_{UP}$ = 78 $km$ at 5.05 $Ma$. (a) Rock type. (b) Temperature. (c) Viscosity. (d) Streamlines. By 5 $Ma$ balance is achieved between cooling and heating in the shallow and deep upper-plate mantle, respectively. A feedback regulating heat transfer, serpentine destabilization, and mechanical coupling is already stabilizing \DIFdelbeginFL %DIFDELCMD < \gls{cd}%%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{coupling depth}\DIFaddendFL . Rock type colors are the same as Figure \ref{fig:init}.}\label{fig:cdfStep2}
\end{figure}
...
The form of the preferred quadratic regression model in Section \ref{cdEstimators} (Figure \ref{fig:results} \& Table \ref{tab:zcResults}) implies a lower limit to \DIFdelbegin %DIFDELCMD < \gls{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depth }\DIFaddend of approximately 60 \(km\), even for thin \DIFdelbegin %DIFDELCMD < \gls{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness }\DIFaddend and, presumably, under warm conditions during nascent subduction. In principle, thin \DIFdelbegin %DIFDELCMD < \glspl{upt} %%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plates }\DIFaddend could allow effective heat transfer in a flowing shallow asthenospheric mantle---hindering deep stabilization of serpentine. Olivine and pyroxene would be the stable mantle minerals, and strong, shallow coupling between plates would be expected Gerya et al. (\protect\hyperlink{ref-gerya2008}{2008}). However, even the warmest numerical experiments (low-\(\Phi\) \& thin \DIFdelbegin %DIFDELCMD < \gls{upt}%%%
\DIFdelend \DIFaddbegin \DIFadd{upper-plate thickness}\DIFaddend ) in Chapter \ref{chpt2} eventually stabilize serpentine in the shallow upper-plate mantle. This is evident by increasing depth of mechanical coupling with time for the first 5 \(Ma\) of subduction (Figure \ref{fig:antDepth}).
...
The material properties used in \DIFdelbegin \DIFdel{our }\DIFdelend \DIFaddbegin \DIFadd{the numerical }\DIFaddend experiments are listed in Table \ref{tab:materials} and Table \ref{tab:melts}. For details about the sedimentation and erosion, melting and extraction, and rheological models, please refer to Sizova et al. (\protect\hyperlink{ref-sizova2010}{2010}). Here we discuss only the hydrodynamic model, because it is the most relevant aspect of \DIFdelbegin \DIFdel{our results}\DIFdelend \DIFaddbegin \DIFadd{the numerical experiments}\DIFaddend .

\DIFdelbegin \DIFdel{The hydrodynamics in our models controls }\DIFdelend \DIFaddbegin \DIFadd{Hydrodynamics in the numerical models control }\DIFaddend the timing and magnitude of mantle wedge hydration. The main sources of water delivered to the mantle are altered basaltic crust and seafloor sediments, which we assumed to contain up to 5 \(wt.\% H_{2}O\). We assumed a gradual expulsion of water from pore space and through quasi-continuous dehydration reactions occurring within the slab. Water content is computed using the following equation:
...
Numerical modelling practitioners simulating \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend approach mechanical coupling between plates differently. A simple, but highly effective approach, is prescribing a layer of arbitrary strength extending from the surface to an arbitrary depth or temperature along the plate interface. This approach effectively inhibits transfer of shear stress between plates and is analogous to controlling a no-slip condition at the interface (plates move with the same velocity vector beyond the coupling point). Numerous models use this method (e.g. \protect\hyperlink{ref-peacock1996}{Peacock, 1996}; \protect\hyperlink{ref-peacock1999b}{Peacock \& Wang, 1999}; \protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}) in part because it allows fine-tuning to specific \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend configurations. Serpentine-or talc-rich horizons are typically invoked to justify implementing such a condition at shallow interface depths.

The experiments outlined in Section \ref{numMethods} do not explicitly define coupling, but rather use a rheologic model that explicitly follows experimentally determined flow laws and mineral stability fields. This approach conceptually follows and extends petrologic explanations for a weak interface (\protect\hyperlink{ref-hyndman2003}{Hyndman \& Peacock, 2003}; \protect\hyperlink{ref-peacock1999a}{Peacock \& Hyndman, 1999}). As a corollary, dehydration of serpentine, or possibly talc, at higher temperatures must strengthen the interface (\protect\hyperlink{ref-agard2016}{Agard et al., 2016}). Noting that talc is unstable at P \(>\) 2.0 \(GPa\) in an ultramafic rock (\protect\hyperlink{ref-schmidt1998}{Schmidt \& Poli, 1998}), a serpentine rheology is arguably the most relevant candidate responsible for a strength increase, and thus coupling, at \gls{pt} conditions inferred for coupling in active \DIFdelbegin %DIFDELCMD < \glspl{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zones }\DIFaddend (\protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}).
...
Only experiments 5 and 7 listed above were inconsistent with the results presented Section \ref{chpt2Results}. Experiment 5 results in transient \DIFdelbegin %DIFDELCMD < \glspl{cd} %%%
\DIFdelend \DIFaddbegin \DIFadd{coupling depths }\DIFaddend and discontinuous antigorite stability in the upper-plate mantle, whereas experiment 7 results in two-sided subduction (e.g. \protect\hyperlink{ref-gerya2008}{Gerya et al., 2008}). These sensitivity experiments imply numerical coupling mechanisms are mostly contingent on fluid flux to the upper-plate mantle and the implementation of serpentine stability. The experiments also show coupling is relatively insensitive to the exact flow law parameters.

\hypertarget{surface-heat-flow-1}{%
\section{Surface Heat Flow}\label{surface-heat-flow-1}}

Below is \DIFdelbegin %DIFDELCMD < \gls{shf} %%%
\DIFdelend \DIFaddbegin \DIFadd{surface heat flow }\DIFaddend calculated at 2 \(km\) beneath the topographic surface at approximately 10 \(Ma\) for all numerical experiments presented in Chapter \ref{chpt2}.
...
\caption{\label{tab:sigmaDiffSummaryTable}[Similarity $-$ Krige] uncertainty differences by segment}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llrrrrrrrr}
...
Segment & Model & Min & Max & Median & IQR & Mean & $\sigma$ & n & Cost\\
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{Bes} & \cellcolor{gray!6}{-30} & \cellcolor{gray!6}{58} & \cellcolor{gray!6}{-8} & \cellcolor{gray!6}{19} & \cellcolor{gray!6}{-7} & \cellcolor{gray!6}{13} & \cellcolor{gray!6}{5779} & \cellcolor{gray!6}{0.606}\\
Andes & Cir & -91 & 1286 & -27 & 37 & -19 & 87 & 7623 & 0.297\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{-68} & \cellcolor{gray!6}{1283} & \cellcolor{gray!6}{-14} & \cellcolor{gray!6}{29} & \cellcolor{gray!6}{21} & \cellcolor{gray!6}{158} & \cellcolor{gray!6}{2792} & \cellcolor{gray!6}{0.248}\\
Kamchatka Marianas & Lin & -33 & 381 & -1 & 17 & 3 & 16 & 7059 & 0.425\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{-39} & \cellcolor{gray!6}{58} & \cellcolor{gray!6}{-10} & \cellcolor{gray!6}{14} & \cellcolor{gray!6}{-9} & \cellcolor{gray!6}{13} & \cellcolor{gray!6}{2766} & \cellcolor{gray!6}{0.481}\\
Lesser Antilles & Cir & -22 & 68 & -5 & 11 & -3 & 10 & 2226 & 0.306\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{-40} & \cellcolor{gray!6}{143} & \cellcolor{gray!6}{-13} & \cellcolor{gray!6}{17} & \cellcolor{gray!6}{-13} & \cellcolor{gray!6}{14} & \cellcolor{gray!6}{1835} & \cellcolor{gray!6}{0.530}\\
New Britain Solomon & Lin & -27 & 73 & 2 & 20 & 3 & 16 & 2011 & 0.592\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{-36} & \cellcolor{gray!6}{547} & \cellcolor{gray!6}{-11} & \cellcolor{gray!6}{18} & \cellcolor{gray!6}{-7} & \cellcolor{gray!6}{27} & \cellcolor{gray!6}{3174} & \cellcolor{gray!6}{0.466}\\
Scotia & Exp & -67 & 1221 & -25 & 25 & -18 & 53 & 2719 & 0.199\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{-37} & \cellcolor{gray!6}{549} & \cellcolor{gray!6}{-19} & \cellcolor{gray!6}{18} & \cellcolor{gray!6}{-16} & \cellcolor{gray!6}{21} & \cellcolor{gray!6}{5932} & \cellcolor{gray!6}{0.263}\\
...
Taking the derivative of Equation \eqref{eq:loglik} with respect to each parameter, \(\pi\), \(\mu\), \(\Sigma\), setting the equation to zero, and solving for each parameter gives the \DIFdelbegin %DIFDELCMD < \glspl{mle}%%%
\DIFdelend \DIFaddbegin \DIFadd{maximum likelihood estimators}\DIFaddend :
...
where \(\omega_{i}\) (\(\omega_{i} \geq 0; \sum_{j=1}^k \omega_{i} = 1\)) are membership weights representing the probability of an observation \(x_i\) belonging to the \(j^{th}\) Gaussian and \(N_j\) represents the number of observations belonging to the \(j^{th}\) Gaussian. Please note that \(\omega_{i}\) is unknown for markers so \DIFdelbegin %DIFDELCMD < \gls{mle} %%%
\DIFdelend \DIFaddbegin \DIFadd{maximum likelihood estimator }\DIFaddend cannot be computed with Equation \eqref{eq:mle}. The solution to this problem is the \DIFdelbegin %DIFDELCMD < \gls{em} %%%
\DIFdelend \DIFaddbegin \DIFadd{Expectation-Maximization }\DIFaddend algorithm, which is defined below.

General purpose functions in the \texttt{R} package \texttt{Mclust} (\protect\hyperlink{ref-scrucca2016}{Scrucca et al., 2016}) are used to fit \DIFdelbegin %DIFDELCMD < \glspl{gmm}%%%
\DIFdelend \DIFaddbegin \DIFadd{Gaussian mixture models}\DIFaddend . ``Fitting'' refers to adjusting all \(k\) Gaussian parameters \(\mu_j\) and \(\Sigma_j\) until the data and Gaussian ellipsoids achieve maximum likelihood defined by Equation \eqref{eq:loglik}. After Banfield \& Raftery (\protect\hyperlink{ref-banfield1993}{1993}), covariance matrices \(\Sigma\) in \texttt{Mclust} are parameterized to be flexible in their shape, volume, and orientation (\protect\hyperlink{ref-scrucca2016}{Scrucca et al., 2016}):
...
where \(D_j\) is the orthogonal eigenvector matrix, \(A_j\) and \(\lambda_j\) are diagonal matrices of values proportional to the eigenvalues. This implementation allows fixing one, two, or three geometric elements of the covariance matrices. That is, the volume \(\lambda_j\), shape \(A_j\), and orientation \(D_j\) of Gaussian clusters can change or be fixed among all \(k\) clusters (e.g. \protect\hyperlink{ref-celeux1995}{Celeux \& Govaert, 1995}; \protect\hyperlink{ref-fraley2002}{Fraley \& Raftery, 2002}). Fourteen parameterizations of Equation \eqref{eq:eigen} are tried, representing different geometric combinations of the covariance matrices \(\Sigma\) (see \protect\hyperlink{ref-scrucca2016}{Scrucca et al., 2016}) and the \DIFdelbegin %DIFDELCMD < \gls{bic} %%%
\DIFdelend \DIFaddbegin \DIFadd{Bayesian information criterion }\DIFaddend is computed (\protect\hyperlink{ref-schwarz1978}{Schwarz et al., 1978}). The parameterization for Equation \eqref{eq:eigen} is chosen by \DIFdelbegin %DIFDELCMD < \gls{bic}%%%
\DIFdelend \DIFaddbegin \DIFadd{Bayesian information criterion}\DIFaddend .

\hypertarget{expectation-maximization}{%
\section{Expectation-Maximization}\label{expectation-maximization}}

The \DIFdelbegin %DIFDELCMD < \gls{em} %%%
\DIFdel{algorithm estimates }%DIFDELCMD < \gls{gmm} %%%
\DIFdelend \DIFaddbegin \DIFadd{Expectation-Maximization algorithm estimates Gaussian mixture model }\DIFaddend parameters by initializing \(k\) Gaussians with parameters \((\pi_j, \mu_j, \Sigma_j)\), then iteratively computing membership weights with Equation \eqref{eq:posterior} and updating Gaussian parameters with Equation \eqref{eq:mle} until reaching a convergence threshold (\protect\hyperlink{ref-dempster1977}{Dempster et al., 1977}).
...
The following pages contain visualizations of marker classifications, marker PT distributions, and summary geodynamic snapshots for all 64 \DIFdelbegin %DIFDELCMD < \gls{sz} %%%
\DIFdelend \DIFaddbegin \DIFadd{subduction zone }\DIFaddend simulations presented in Chapter \ref{chpt4}. All data and visualizations are available online at \url{https://github.com/buchanankerswell/kerswell_et_al_marx}.
