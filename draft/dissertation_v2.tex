...
\item
  Fundamentally different interpolation methods, Kriging and Similarity, both show cases of along-strike variability in average upper-plate surface heat flow
\item
  Variations in upper-plate surface heat flow imply non-uniform upper-plate thickness and discontinuous geodynamics
\end{itemize}
\end{quote}
...
While ThermoGlobe currently contains 69,729 observations, the regional coverage near subduction zones is uneven and irregularly-spaced (Table \ref{tab:hfSummaryTable} \& Figure \ref{fig:globalhfComp}). Many methods may be considered to interpolate surface heat flow including inverse distance weighting, various splines and linear regressions, nearest-neighbor, general additive models, Kriging, and Similarity, to name a few. Generally speaking, these methods predict surface heat flow across a grid of arbitrarily defined locations with unknown surface heat flow (the targets) by fitting mathematical models to available surface heat flow observations (the examples). The two interpolation methods compared in this study, Kriging and Similarity, are chosen because they represent end-member methodological classes based on fundamentally different principles. Their comparative differences, therefore, may be important for advancing understanding of subduction zone processes, for targeting areas for future heat flow research, for improving either method in the context of subduction zone research, and for developing new layered interpolation methods that combine the strengths of Kriging and Similarity techniques.
...
\caption[Similarity interpolation of near 13 active subduction zone segments]{Surface heat flow near subduction zone segments. (a) ThermoGlobe data from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) cropped within 1000 \(km\)-radius circular buffers around 13 active subduction zone segments show uneven regional coverage. For example, note the relatively high observational density in the NW Pacific compared to other regions. (b) In contrast, Similarity interpolation cropped within the same buffers presents an evenly-distributed approximation of regional surface heat flow. Similarity interpolation from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). Subduction zone boundaries (bold white lines) defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Plate boundaries (solid green lines) defined by Lawver et al. (\protect\hyperlink{ref-lawver2018}{2018}). Segments: AA {[}Alaska Aleutians{]}, AN {[}Andes{]}, CA \protect\hyperlink{central-america}{Central America}, KM {[}Kamchatka Marianas{]}, KR \protect\hyperlink{kyushu-ryukyu}{Kyushu Ryukyu}, LA {[}Lesser Antilles{]}, NBS {[}New Britain Solomon{]}, NP {[}N Philippines{]}, SBS {[}Sumatra Banda Sea{]}, SC \protect\hyperlink{scotia}{Scotia}, SP {[}S Philippines{]}, TNZ {[}Tonga New Zealand{]}, VN {[}Vanuatu{]}.}\label{fig:globalhfComp}
\end{figure}
...
\caption[Distributions of ThermoGlobe observations near 13 active subduction zone segments]{Distribution of ThermoGlobe observations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) cropped within 1000 \(km\)-radius circular buffers around 13 active subduction zone segments. Heat flow distributions are centered between 41 and 108 \(mWm^{-2}\) and highly right-skewed. Skewness represents near-surface perturbations from geothermal systems and tectonic regions with high thermal activity. Diverse interactions between tectonic and near-surface processes are apparent from the broad, irregular surface heat flow distributions. Distributions are colored by quartiles (25\%, 50\%, 75\%).}\label{fig:hfSummaryPlot}
\end{figure}
...
\caption[Example of an interpolation domain constructed around Kyushu Ryukyu]{Example of an interpolation domain constructed around Kyushu Ryukyu. (a) ThermoGlobe data are cropped within a domain defined by drawing a 1000 \(km\)-radius circular buffer (thin black line) around the segment boundary (bold white line). Note that Kyushu Ryukyu is one of the most densely sampled regions, yet still has considerable observational gaps. (b) Similarity presents a textured interpolation by layering many geologic proxy datasets. Similarity interpolation from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). Segment boundary defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Plate boundaries (solid green lines) defined by Lawver et al. (\protect\hyperlink{ref-lawver2018}{2018}).}\label{fig:domainConstruct}
\end{figure}
...
\toprule
Segment & Model & Cutoff & Lags & Shift & $n_{max}$ & Sill & Range & Cost\\
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{15.0} & \cellcolor{gray!6}{1.6} & \cellcolor{gray!6}{10.0} & \cellcolor{gray!6}{824} & \cellcolor{gray!6}{258} & \cellcolor{gray!6}{0.647}\\
Andes & Exp & 7.3 & 24.8 & 1.6 & 11.9 & 2575 & 12 & 0.306\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{Cir} & \cellcolor{gray!6}{13.0} & \cellcolor{gray!6}{24.7} & \cellcolor{gray!6}{1.3} & \cellcolor{gray!6}{11.2} & \cellcolor{gray!6}{2038} & \cellcolor{gray!6}{10} & \cellcolor{gray!6}{0.262}\\
Kamchatka Marianas & Sph & 1.0 & 17.3 & 2.1 & 11.2 & 1799 & 814 & 0.426\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{20.5} & \cellcolor{gray!6}{1.5} & \cellcolor{gray!6}{31.9} & \cellcolor{gray!6}{1873} & \cellcolor{gray!6}{119} & \cellcolor{gray!6}{0.484}\\
Lesser Antilles & Sph & 2.9 & 27.2 & 1.5 & 29.0 & 782 & 141 & 0.310\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{1.3} & \cellcolor{gray!6}{15.4} & \cellcolor{gray!6}{1.6} & \cellcolor{gray!6}{14.2} & \cellcolor{gray!6}{1206} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{0.541}\\
New Britain Solomon & Lin & 13.1 & 22.6 & 1.6 & 10.0 & 806 & 65 & 0.790\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{Bes} & \cellcolor{gray!6}{13.1} & \cellcolor{gray!6}{23.5} & \cellcolor{gray!6}{1.5} & \cellcolor{gray!6}{10.0} & \cellcolor{gray!6}{849} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{0.498}\\
Scotia & Sph & 1.0 & 33.0 & 1.3 & 49.6 & 1915 & 315 & 0.293\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{23.9} & \cellcolor{gray!6}{1.6} & \cellcolor{gray!6}{33.0} & \cellcolor{gray!6}{2276} & \cellcolor{gray!6}{342} & \cellcolor{gray!6}{0.268}\\
Tonga New Zealand & Cir & 1.1 & 15.1 & 1.9 & 23.4 & 1318 & 343 & 0.529\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{1.4} & \cellcolor{gray!6}{15.3} & \cellcolor{gray!6}{1.6} & \cellcolor{gray!6}{10.1} & \cellcolor{gray!6}{3033} & \cellcolor{gray!6}{286} & \cellcolor{gray!6}{0.520}\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \uline{\textit{key}}: $n_{max}$: max point-pairs, Sill $[(mWm^{-2})^2]$, Range $[km]$, Cost $[mWm^{-2}]$
\end{tablenotes}
\end{threeparttable}}
\end{table}
...
\toprule
Segment & Min & Max & Median & IQR & Mean & $\sigma$ & $RMSE_S$ & $RMSE_K$\\
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{-141} & \cellcolor{gray!6}{126} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{21} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{22} & \cellcolor{gray!6}{9.3} & \cellcolor{gray!6}{26.7}\\
Andes & -118 & 145 & -2 & 47 & -2 & 35 & 15.0 & 34.8\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{-109} & \cellcolor{gray!6}{203} & \cellcolor{gray!6}{12} & \cellcolor{gray!6}{47} & \cellcolor{gray!6}{21} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{25.8} & \cellcolor{gray!6}{30.9}\\
Kamchatka Marianas & -134 & 180 & 5 & 18 & 6 & 23 & 15.2 & 32.0\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{-110} & \cellcolor{gray!6}{186} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{22} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{24} & \cellcolor{gray!6}{17.8} & \cellcolor{gray!6}{35.8}\\
Lesser Antilles & -102 & 135 & 3 & 15 & 2 & 21 & 12.4 & 9.7\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{-72} & \cellcolor{gray!6}{150} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{23} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{21} & \cellcolor{gray!6}{15.0} & \cellcolor{gray!6}{28.6}\\
New Britain Solomon & -56 & 137 & 7 & 19 & 9 & 19 & 7.6 & 23.2\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{-67} & \cellcolor{gray!6}{193} & \cellcolor{gray!6}{6} & \cellcolor{gray!6}{23} & \cellcolor{gray!6}{9} & \cellcolor{gray!6}{22} & \cellcolor{gray!6}{12.5} & \cellcolor{gray!6}{28.3}\\
Scotia & -58 & 190 & 3 & 29 & 11 & 27 & 6.4 & 21.8\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{-134} & \cellcolor{gray!6}{143} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{20} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{20} & \cellcolor{gray!6}{9.5} & \cellcolor{gray!6}{20.8}\\
Tonga New Zealand & -117 & 190 & 1 & 23 & 1 & 25 & 11.4 & 32.8\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{-147} & \cellcolor{gray!6}{205} & \cellcolor{gray!6}{14} & \cellcolor{gray!6}{31} & \cellcolor{gray!6}{13} & \cellcolor{gray!6}{34} & \cellcolor{gray!6}{17.8} & \cellcolor{gray!6}{48.0}\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \uline{\textit{note}}: Showing optimal Krige models from Table \ref{tab:vgrmSummaryTable}, all units are $mWm^{-2}$
\end{tablenotes}
\end{threeparttable}}
\end{table}
...
The broad distributions of differences between Similarity and Kriging interpolations arise from their contrasting mathematical frameworks. Kriging tends to spatially smooth surface heat flow gradients (e.g., across the trench, forearc, arc, and backarc), whereas Similarity is agnostic to gradients and may present very textured interpolations. Although Kriging and Similarity medians compare well, subtle but important differences appear on the grid-step (0.5\(^\circ \times\) 0.5\(^\circ\)) scale. The broadest distributions (e.g.~Central America) indicate less subtle differences like the presence (or lack) of tectonic features in one interpolation compared to the other. For example, a low surface heat flow feature (e.g.~oceanic plate or thick upper-plate lithosphere) or high surface heat flow feature (e.g.~transform fault or spreading center) may be resolved by one method but not the other.

\hypertarget{regional-differences}{%
\subsubsection{Regional Differences}\label{regional-differences}}

Examples given in this section highlight the range of differences observed between Similarity and Kriging across complex tectonic environments (Central America), simple tectonic environments (Kyushyu Ryukyu), and regions with very few observations (Scotia).

\hypertarget{central-america}{%
\paragraph{Central America}\label{central-america}}

Similarity predicts the arms of the Galápagos triple junction to the SW of the Central America segment, but Kriging does not (Figure \ref{fig:centralAmericaDiff}). Consequently, the interpolation comparison highlights two distinct regions---large differences along the arms of the triple junction and within the subducting Cocos Plate, and small differences to the E and NE of the Cocos Plate behind the volcanic arc (Figure \ref{fig:centralAmericaDiff}). Note the moderate interpolation differences within the Cocos Plate in Figure \ref{fig:centralAmericaDiff} where Similarity predicts relatively high surface heat flow by proximity to the nearby spreading centers, but Kriging predictions are relatively low.
...
\caption[Similarity and Kriging interpolations for Kyushyu Ryukyu]{Similarity and Kriging interpolations for Kyushyu Ryukyu. (a) Similarity predicts a textured interpolation within the tectonically complex region. (b) Kriging interpolation is generally smoother, but corroborate much of the same texture predicted by Similarity because of relatively high observational density and regular spatial coverage near Kyushu Ryukyu. Segment boundary (bold white line) and volcanoes (gold diamonds) defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Similarity interpolation from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). Plate boundaries (solid green lines) defined by Lawver et al. (\protect\hyperlink{ref-lawver2018}{2018}).}\label{fig:kyushuRyukyuDiff}
\end{figure}

\hypertarget{scotia}{%
\paragraph{Scotia}\label{scotia}}

The Scotia segment illustrates a case where surface heat flow observations are incredibly sparse. Similarity resolves the East Scotia Ridge and the WSW-ENE trending transform boundary separating the Scotia and Sandwich Plates from the Antarctic Plate (Figure \ref{fig:scotiaDiff}). Kriging indicates a heat flow anomaly more or less in the region of the East Scotia Ridge, but does not resolve structure in a way that is geologically useful because of very few surface heat flow observations (n = 25). Kriging predictions thus approximate the expected (mean: 79 \(mWm^{-2}\)) value for the entire domain according to Equation \eqref{eq:linEstimate}. That is, Kriging provides no more geodynamic information than computing the arithmetic mean for surface heat flow observations within a 1000 \(km\)-radius of the Scotia segment.
...
Lateral surface heat flow variability across upper-plates may be categorized in 1 of 8 ways based on Similarity and Kriging prediction patterns within upper-plate sectors (Table \ref{tab:lateralDiffTable}). Each upper-plate can be characterized as having (dis)continuous Similarity prediction patterns, and/or (dis)continuous Kriging prediction patterns, and/or (in)comparable Similarity vs.~Kriging prediction patterns. Discontinuous upper-plate surface heat flow patterns are more commonly predicted by either interpolation method than continuous upper-plate surface heat flow patterns (see Appendix \ref{lateralDiffAppendix}). Discontinuous surface heat flow patterns are predicted by either Similarity or Kriging for 12/13 segments and by both Similarity and Kriging for 7/13 segments (e.g., Kyushu Ryukyu; Figure \ref{fig:kyushuRyukyuUpper}). In contrast, continuous upper-plate surface heat flow patterns are predicted by either Similarity or Kriging for 6/13 segments and by both Similarity and Kriging for only 1/13 segments (Kamchatka Marianas; Figure \ref{fig:kamchatkaMarianasUpper}). At least 7/13 segments show incomparable upper-plate surface heat flow patterns predicted by Similarity and Kriging (e.g.~Central America; Figure \ref{fig:centralAmericaUpper}).

\begin{table}

\caption{\label{tab:lateralDiffTable}Comparing surface heat flow patterns across upper-plate sectors}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{llll}
\toprule
Segment & Kriging & Similarity & Comparison\\
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{comparable}\\
Andes & discontinuous & discontinuous & comparable\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{incomparable}\\
Kamchatka Marianas & continuous & continuous & comparable\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{comparable}\\
Lesser Antilles & discontinuous & discontinuous & comparable\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{continuous} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{incomparable}\\
New Britain Solomon & continuous & discontinuous & incomparable\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{incomparable}\\
Scotia & continuous & discontinuous & incomparable\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{continuous} & \cellcolor{gray!6}{incomparable}\\
Tonga New Zealand & discontinuous & continuous & incomparable\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{discontinuous} & \cellcolor{gray!6}{comparable}\\
\bottomrule
\end{tabular}}
\end{table}
...
\caption[Along strike variability of upper-plate surface heat flow near Central America]{Along strike variability of upper-plate surface heat flow near Central America. (a) Distances are computed orthogonally between the subduction zone segment boundary (bold black line) and interpolated upper-plate surface heat flow targets within eight 500 \(km\)-wide sectors (colored polygons). (b) Similarity predictions (dashed curves) and Kriging predictions (solid curves) are distinguishable across all sectors with up to approximately 25 \(mWm^{-2}\) of average offset. (c) Both Similarity and Kriging predictions show discontinuous upper-plate surface heat flow with up to 25-30 \(mWm^{-2}\) differences in average upper-plate surface heat flow among sectors, but are distinguishable from each other because of an average offset of approximately 25 \(mWm^{-2}\). Segment boundary defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Curves in (c) are LOESS regressions through five-point running averages.}\label{fig:centralAmericaUpper}
\end{figure}
...
\hypertarget{lateral-upper-plate-surface-heat-flow-variability}{%
\subsection{Lateral Upper-plate Surface Heat Flow Variability}\label{lateral-upper-plate-surface-heat-flow-variability}}
...
\caption{\label{tab:nloptrBounds}Search bounds for nloptr minimization}
\centering
\begin{tabular}[t]{lll}
\toprule
...
Below are all variogram models fitted to experimental variograms for each subduction zone segment. Please refer to Table \ref{tab:vgrmSummaryTable} for variogram parameters.
...
Below are all Similarity and Kriging interpolation not presented in the main text of Chapter \ref{chpt3}.
...
\caption[Along strike variability of upper-plate surface heat flow near Alaska Aleutians]{Along strike variability of upper-plate surface heat flow near Alaska Aleutians. Please refer to the main text for explanation of panels and colors.}\label{fig:alaskaAleutiansUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near Andes]{Along strike variability of upper-plate surface heat flow near Andes. Please refer to the main text for explanation of panels and colors.}\label{fig:andesUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near Kamchatka Marianas]{Along strike variability of upper-plate surface heat flow near Kamchatka Marianas. Please refer to the main text for explanation of panels and colors.}\label{fig:kamchatkaMarianasUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near Kyushu Ryukyu]{Along strike variability of upper-plate surface heat flow near Kyushu Ryukyu. Please refer to the main text for explanation of panels and colors.}\label{fig:kyushuRyukyuUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near Lesser Antilles]{Along strike variability of upper-plate surface heat flow near Lesser Antilles. Please refer to the main text for explanation of panels and colors.}\label{fig:lesserAntillesUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near N Philippines]{Along strike variability of upper-plate surface heat flow near N Philippines. Please refer to the main text for explanation of panels and colors.}\label{fig:nPhilippinesUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near New Britain Solomon]{Along strike variability of upper-plate surface heat flow near New Britain Solomon. Please refer to the main text for explanation of panels and colors.}\label{fig:newBritainSolomonUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near S Philippines]{Along strike variability of upper-plate surface heat flow near S Philippines. Please refer to the main text for explanation of panels and colors.}\label{fig:sPhilippinesUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near Scotia]{Along strike variability of upper-plate surface heat flow near Scotia. Please refer to the main text for explanation of panels and colors.}\label{fig:scotiaUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near Sumatra Banda Sea]{Along strike variability of upper-plate surface heat flow near Sumatra Banda Sea. Please refer to the main text for explanation of panels and colors.}\label{fig:sumatraBandaSeaUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near Tonga New Zealand]{Along strike variability of upper-plate surface heat flow near Tonga New Zealand. Please refer to the main text for explanation of panels and colors.}\label{fig:tongaNewZealandUpper}
\end{figure}
...
\caption[Along strike variability of upper-plate surface heat flow near Vanuatu]{Along strike variability of upper-plate surface heat flow near Vanuatu. Please refer to the main text for explanation of panels and colors.}\label{fig:vanuatuUpper}
\end{figure}
