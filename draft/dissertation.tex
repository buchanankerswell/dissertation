...
Subduction occurs when two lithospheric plates converge and the denser plate \emph{subducts} beneath the other at a \glsfirst{sz}. \glspl{sz} are implicated in myriad geodynamic phenomena, including seismicity, metamorphism, volatile flux, volcanism, dynamic plate motions, and crustal deformation (\protect\hyperlink{ref-cizkova2013}{Čížková \& Bina, 2013}; \protect\hyperlink{ref-gao2017}{Gao \& Wang, 2017}; \protect\hyperlink{ref-gonzalez2016}{Gonzalez et al., 2016}; \protect\hyperlink{ref-grove2012}{Grove et al., 2012}; \protect\hyperlink{ref-hacker2003}{Hacker et al., 2003}; \protect\hyperlink{ref-hirauchi2010}{Hirauchi et al., 2010}; \protect\hyperlink{ref-peacock1990}{Peacock, 1990}, \protect\hyperlink{ref-peacock1991}{1991}, \protect\hyperlink{ref-peacock1993}{1993}, \protect\hyperlink{ref-peacock1996}{1996}; \protect\hyperlink{ref-peacock1999a}{Peacock \& Hyndman, 1999}; \protect\hyperlink{ref-vankeken2011}{van Keken et al., 2011}). These phenomena are largely defined by plate motions and mechanical behaviour along the plate interface (\protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-peacock1994}{Peacock et al., 1994}; \protect\hyperlink{ref-peacock1996}{Peacock, 1996}; \protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}). While a diverse set of \glsfirst{tkbc} intuitively implies an equally diverse range of mechanical behaviour, previous work suggests mechanical behaviour is rather uniform among presently active \glspl{sz} (\protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-wada2008}{Wada et al., 2008}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). An apparent juxtaposition between uniform mechanical behaviour vs.~diverse boundary conditions implies a very unintuitive model of subduction.

This dissertation is motivated by the following question. How can one quantify the diversity of mechanical behaviour across a range of plausible \gls{sz} configurations? Each chapter focuses on quantifying an aspect of \gls{sz} mechanics using different computational approaches and datasets.

Chapter \ref{chpt2} numerically simulates oceanic-continental subduction across a range of \gls{tkbc} and plate coupling is observed after 10 \(Ma\). Multivariate linear regression is then used to formulate an expression for estimating \glsfirst{cd}. The expression requires estimates for upper-plate thickness, which can be inverted from \glsfirst{shf}. Average upper-plate \gls{shf} for 13 presently active \glspl{sz} yield a narrow distribution of \glspl{cd}---supporting the idea of broadly uniform mechanical behaviour among \glspl{sz}.

Chapter \ref{chpt3} takes a closer look \gls{shf} by quantifying its spatial variability in 2D. Two interpolations methods, Kriging and Similarity, are compared to assess their relative effectiveness. While one approach yields more favourable error rates, both show diverse spatial patterns of \gls{shf} in contradiction to broadly uniform \gls{cd} predicted in Chapter \ref{chpt2}. Dataset scaling and new improvements to interpolation methods promise better tools for evaluating geodynamic variability among \glspl{sz}.

Finally, Chapter \ref{chpt4} applies machine learning techniques to recognize detachment of subducting markers (representing recovered rock fragments) from the numerical simulations in Chapter \ref{chpt2}. A large (91,733) \glsfirst{ptt} dataset of recovered marker is compared across numerical experiments and with a global compilation of \glsfirst{hp} metamorphic terranes (the rock record). Marker \gls{ptt} distributions are distinct from the rock record, likely pointing to inherent sampling bias introduced by aggregating undifferentiated \gls{hp} rocks into a single composite dataset. Both marker \gls{ptt} distributions and marker recovery rates correlate with \gls{tkbc}, suggesting non-uniform mechanical behaviour among \glspl{sz}.
...
\begin{itemize}
\item
  Plate coupling responds strongly to \gls{upt}
\item
...
Deep mechanical coupling between converging plates is implicated in dynamic plate motions, crustal deformation, seismic cycles, arc magmatism, detachment (recovery) of subducting material, and is considered a key feature of \glsfirst{sz} geodynamics. This study uses two-dimensional numerical simulations of oceanic-continental convergent margins to investigate effects of \glsfirst{tkbc} on coupling---specifically focusing on thermal parameter (\(\Phi\)) and \glsfirst{upt}. Numerical simulations implement coupling by including the metamorphic (de)hydration reaction \(antigorite \allowbreak \Leftrightarrow olivine + orthopyroxene + H_{2}O\) in the upper-plate mantle. Visualizing \glsfirst{pts} fields show thermal feedbacks regulating \glsfirst{cd} dynamically with strong responses to \gls{upt} and weak responses to \(\Phi\). The results imply estimation of \gls{cd} is possible by inverting \gls{upt} from \glsfirst{shf}. Moreover, \gls{shf} sampled from the backarc region near 17 presently active \glspl{sz} imply uniform \gls{upt}, and thus uniform \glspl{cd} among \glspl{sz}.

\hypertarget{chpt2Intro}{%
\section{Introduction}\label{chpt2Intro}}

Subduction geodynamics are largely defined by plate motions and mechanical behaviour along the plate interface. For example, a transition from mechanically decoupled (plates moving differentially with respect to each other) to coupled plates (plates moving with the same local velocity) dramatically increases temperature by inducing mantle circulation in the upper-plate asthenospheric mantle (\protect\hyperlink{ref-peacock1994}{Peacock et al., 1994}; \protect\hyperlink{ref-peacock1996}{Peacock, 1996}). Observations from numerical simulations and forearc \gls{shf} imply coupling transitions occur globally within a narrow range of depths in modern \glspl{sz} (70-80 \(km\)). Further, coupling appears essentially unresponsive to diverse \gls{tkbc}, including oceanic-plate age, convergence velocity, and subduction geometry (\protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-wada2008}{Wada et al., 2008}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). While uniform \glspl{cd} among \glspl{sz} are inferred from numerical simulations and \gls{shf}, this phenomenon remains curious and unconfirmed to a large extent. To understand \gls{sz} geodynamics, it is essential to understand why modern \glspl{sz} appear to achieve similar \glspl{cd} despite differences in their physical characteristics.
...
\item
  Uniform \gls{shf} in circum-Pacific \glspl{sz} (\protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}) may indicate uniform \glspl{cd} at approximately 80 \(km\).
\end{enumerate}

Questions remain, however, including: how do warm (thin) upper-plates persist over 100's of kilometers behind arcs and throughout the lifespan of \glspl{sz}? How abruptly are dehydration reaction occurring along the subduction interface? How can expressions like Equation \eqref{eq:zCpl} be improved using natural datasets? Each of these questions may be considered for future research.
...
\item
  New interpolation approaches and dataset scaling will improve \gls{sz} research
\end{itemize}
\end{quote}
...
This Chapter focuses on comparing the accuracy, resolution, and diversity of \gls{shf} interpolations produced by Similarity and Kriging methods for 13 presently active \glspl{sz}. The following questions are considered. At what resolution can spatial \gls{shf} patterns be confidently resolved with the current global database? Are Kriging and Similarity methods comparable when applied to \gls{shf} near \glspl{sz}? What do the differences (if any) imply about geodynamic variability among active \glspl{sz}, especially with respect to uniform upper-plate thickness discussed in Chapter \ref{chpt2}?

First, ordinary Kriging is applied to the \texttt{ThermoGlobe} database (\protect\hyperlink{ref-jennings2021}{Jennings \& Hasterok, 2021}; \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}) cropped within 1000 \(km\) buffers around 13 presently active \glspl{sz} defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Kriging estimates and uncertainties are then directly compared (point-by-point) to Similarity interpolations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). The results show Kriging and Similarity methods are generally comparable for most subduction segments but Similarity estimates have considerably less error. This study highlights present challenges in inferring \gls{sz} geodynamics quantitatively from \gls{shf} datasets and encourages characterization \gls{shf} patterns to the fullest extent possible. Scaling datasets and developing composite interpolation approaches promise better tools for distinguishing geodynamic variability near active \glspl{sz}.
...
\caption[Distributions of \texttt{ThermoGlobe} observations near 13 active \gls{sz} segments]{Distribution of \texttt{ThermoGlobe} observations cropped within 1000 \(km\) circular buffers around 13 active \gls{sz} segments. Heat flow distributions are centered between 41 and 108 \(mWm^{-2}\) and highly skewed right. Skewness represents near-surface perturbations from geothermal systems and tectonic regions with high thermal activity. Diverse interactions between tectonic and near-surface processes are apparent from the broad, irregular \gls{shf} distributions. Distributions are colored by quantiles (25\%, 50\%, 75\%). Data from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}).}\label{fig:hfSummaryPlot}
\end{figure}
...
\texttt{ThermoGlobe} data and Similarity interpolations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) are transformed into a Pacific-centered Robinson \gls{crs} defined using the \texttt{proj4} string ``\texttt{+proj=robin\ +lon\_0=-155\ +lon\_wrap=-155\ +x\_0=0\ +y\_0=0\ +ellps=WGS84\ +datum=WGS84\ +units=m\ +no\_defs}'' (\protect\hyperlink{ref-proj2021}{PROJ contributors, 2021}). All geographic operations, including transformation, cropping, Kriging, and comparing interpolations, are performed in the above \gls{crs} using general-purpose functions in the \texttt{R} package \texttt{sf} (\protect\hyperlink{ref-pebesma2018}{Pebesma, 2018}). The Kriging domains (Figure \ref{fig:domainConstruct}) are defined by drawing 1000 \(km\) circular buffers around each \gls{sz} segment defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Target locations for Kriging are defined across the same grid used by Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) to compute point-by-point differences with their Similarity interpolation.



\begin{figure}[htbp]

{\centering \includegraphics[width=1\linewidth,]{assets/figs/chpt3/KyushuRyukyuComp} 

}

\caption[Example of an interpolation domain constructed around Kyushu Ryukyu]{Example of a interpolation domain constructed around Kyushu Ryukyu. Interpolation domains are defined by drawing a 1000 \(km\) circular buffer (thin black line) around the segment boundary (bold black line). \texttt{ThermoGlobe} data is cropped within the buffered region by intersection (left). Note that Kyushu Ryukyu is one of the most densely sampled regions, yet still has considerable gaps. Similarity interpolation (right) fills in the gaps and presents a textured distribution by combining many underlying geologic proxy datasets. Note that \gls{shf} above 250 \(mWm^{-2}\) is colored white. Data and interpolations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). Segment boundary defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}).}\label{fig:domainConstruct}
\end{figure}
...
Kriging cross-validation errors are within 3 (Lesser Antilles) to 63 (Vanuatu) \(mWm^{-2}\) of the quoted 7 \(mWm^{-2}\) \gls{rmse} for Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019})'s preferred Similarity model (7 proxy observables, Table \ref{tab:vgrmSummaryTable}). As expected, Kriging errors can be relatively small compared to Similarity for domains with high observation density (Lesser Antilles; n = 3,011) but relatively large where observational density is comparatively low (Vanuatu; n = 137). Please note, however, that Kriging error is evaluated only on observations within 1000 \(km\) buffers of \gls{sz} segments. The quoted 7 \(mWm^{-2}\) \gls{rmse} from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}) evaluates error on \gls{shf} observations across all oceans and continents. Differentiating \glspl{rmse} in Table \ref{tab:vgrmSummaryTable} from errors reported by Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}; or other global interpolations: e.g. \protect\hyperlink{ref-goutorbe2011}{Goutorbe et al., 2011}; \protect\hyperlink{ref-pollack1993}{Pollack et al., 1993}; \protect\hyperlink{ref-shapiro2004}{Shapiro \& Ritzwoller, 2004}) are therefore only rough comparisons. It is unclear how Similarity uncertainty will scale overall when the domain is restricted to regional tectonic scales.
...
\caption[Summary of optimized variogram models]{Summary of optimized Kriging parameters. Differences in cost (error) are small among Kriging domains despite a diverse set of observation densities, tectonic configurations, initial search parameters, and variogram models. Cost does not correlate with Kriging parameters (with a possible exception of variogram sills), indicating the optimization procedure is successfully generalizeable across \gls{sz} segments.}\label{fig:vgrmSummaryPlot}
\end{figure}

\hypertarget{globalDiff}{%
...
The Scotia segment illustrates a case where \gls{shf} observations are incredibly sparse. Similarity resolves the East Scotia Ridge (ESR) and the WSW-ENE trending transform boundary separating the Scotia and Sandwich Plates from the Antartic Plate (Figure \ref{fig:scotiaDiff}). Kriging, on the other hand, appears featureless because very few \gls{shf} observations (n = 25) poorly define experimental variograms. Kriging estimates thus approximate the expected (mean: 79 \(mWm^{-2}\)) value for the entire domain according to Equation \eqref{eq:linEstimate}. That is, Kriging provides no more geodynamic information than computing the arithmetic mean for \gls{shf} observations within 1000 \(km\) of the Scotia segment. Resolving spatial (dis)continuity is unfeasible and Similarity methods become the obvious choice in such cases.
...
\caption[Similarity vs. Kriging estimates and uncertainties for Scotia]{Similarity vs.~Kriging estimates and uncertainties for Scotia. Similarity (topleft) resolves two tectonic features, the East Scotia Ridge (ESR) and a transform fault (TF) separating the Scotia and Sandwich Plates (SP, SAN) from the Antartic Plate (AP). Kriging (topright) is featureless because of incredibly sparse data. Few observations make Kriging a poor estimator of \gls{shf} across the interpolation domain and provides no more information than computing the arithmetic mean of observations within the domain. Note that computed differences off the colorbar scale in the bottom plots are colored grey. Bold and thin white lines represent the \gls{sz} segment boundary and plate depth, respectively, as defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Pink triangles are volcano locations also from Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). \texttt{ThermoGlobe} data and Similarity prediction from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}).}\label{fig:scotiaDiff}
\end{figure}
...
\tightlist
\item
  Similarity and Kriging methods produce broadly comparable results, but Similarity interpolations are favoured for their lower error rates and geodynamically-consistent results across all 13 \gls{sz} segments
\item
  Interpolations show diverse 2D spatial patterns of (dis)continuous \gls{shf}, encouraging cautious interpretations of subsurface geodynamics without characterizing \gls{shf} distributions to the fullest extent possible
\item
  Dataset scaling and composite interpolation approaches promise better tools for evaluating geodynamic diversity within, and among, \gls{sz} segments and is proposed for future research
\end{enumerate}
...
\begin{itemize}
\item
  Over one-million markers are traced across 64 \gls{sz} simulations
\item
...
Two hypotheses regarding mechanical processing of oceanic material in \glspl{sz} follow from the above observations:
...
\hypertarget{maker-classification}{%
\subsection{Maker Classification}\label{maker-classification}}
...
\caption[\gls{pt} distribution of recovered markers from all simulations]{\gls{pt} distribution of recovered markers from all simulations. Maximum \gls{pt} for 91,733 recovered markers compiled from all 64 \gls{sz} simulations (left; colored contours) show an asymmetric, bimodal distribution with a high-probability peak around 1 \(GPa\) (upper-greenschist to lower-blueschist facies) and a modest probability hill around 2.5 \(GPa\) (upper-blueschist to eclogite facies). Recovered markers neither completely overlap with the rock record (\texttt{pd15}; light grey density contours) in absolute \gls{pt} nor in terms of probability density. The \gls{cdf} (right) shows markers recovered between approximately 0.8 and 2.4 \(GPa\) (greenschists to upper-blueschist) are especially overrepresented in the rock record (\texttt{pd15}; grey line) compared to simulations (black line). Rocks with maximum pressures above 2.4 \(GPa\) (eclogites) are also overrepresented in the rock record (to a lesser degree) compared to simulations. Note that the gap between the grey and black lines (right) represents the relative difference in abundance of recovered material between \texttt{pd15} and simulations. Thin black lines are average \gls{pt} gradients of 5 \(K/km\) and 20 \(K/km\) (calculated with a lithostatic gradient of 35 \(km/GPa\)).}\label{fig:meta}
\end{figure}

To better understand how rock recovery varies among \glspl{sz}, marker \gls{pt} distributions are visualized in terms of convergence velocity (Figure \ref{fig:cvDensity}), oceanic-plate age (Figure \ref{fig:ageDensity}), upper-plate lithospheric thickness (Figure \ref{fig:zupDensity}), and relative detachment timing (Figure \ref{fig:detachDensity}). Each of these effects is summarised below.
...
\item \uline{\textit{note}}: $\sigma_{rec}\%$ is computed from 100 initializations of \gls{gmm} clustering with 10 percent of markers randomly left out
\end{TableNotes}
\begin{longtable}[t]{lrrrrrrrrrrrrrr}
\caption{\label{tab:recSummary}\gls{sz} parameters and marker recovery rates}\\
\toprule
...
\midrule
\endfirsthead
\caption[]{\label{tab:recSummary}\gls{sz} parameters and marker recovery rates \textit{(continued)}}\\
\toprule
\multicolumn{5}{c}{Model Parameters} & \multicolumn{10}{c}{Marker Classification} \\
\cmidrule(l{3pt}r{3pt}){1-5} \cmidrule(l{3pt}r{3pt}){6-15}
model & $\Phi$ & $Z_{UP}$ & age & $\vec{v}$ & n & recov' & lost & subd' & collsn & phase chng & P anom' & T anom' & recov'\% & $\sigma_{rec'}\%$\\
...
\caption[\gls{pt} distribution of recovered markers by oceanic-plate age]{\gls{pt} distribution of recovered markers by oceanic-plate age (panel headers = \(Ma\)). Marker \gls{pt} distributions (colored contours) show a trend towards lower recovery rates (smoother contours), a shift towards higher average pressures, and more uniform probability density across 1.5 to 2.5 \(GPa\) (lower-blueschist to lower-eclogite facies) with increasing oceanic-plate age. The rock record (\texttt{pd15}; light grey contours) generally agrees more with older oceanic-plates (\(\geq\) 85 \(Ma\)), yet is still distinct. Thin black lines are average \gls{pt} gradients of 5 \(K/km\) and 20 \(K/km\) (calculated with a lithostatic gradient of 35 \(km/GPa\)).}\label{fig:ageDensity}
\end{figure}

\hypertarget{upper-plate-thickness-effect}{%
\subsubsection{Upper-plate Thickness Effect}\label{upper-plate-thickness-effect}}

Chapter \ref{chpt2} demonstrates an association between \glsfirst{upt} and coupling depth in the same numerical experiments that markers are sampled from (\protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020} ). \gls{pt} distributions of markers are therefore expected to respond strongly to changes in \gls{upt}, especially with respect to pressure (depth). However, a surprisingly modest effect is observed (Figure \ref{fig:zupDensity}). Marker density transitions towards more uniform distributions and higher top-end pressures with increasing \gls{upt}, while average \gls{pt} gradients significantly decrease. The shift towards more abundant (ultra-)\gls{hp} rocks with increasing \gls{upt} is more modest than anticipated from Chapter \ref{chpt2} but still consistent with a general increase in mechanical coupling depth with increasing \gls{upt} (\protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}; \protect\hyperlink{ref-ruh2015}{Ruh et al., 2015}).
...
In other words, there is a 5\% chance that 130/260 \gls{hp} rocks in \texttt{pd15} were sampled exclusively from slowly-converging (\(\leq\) 66 \(km/Ma\)) \glspl{sz}. It is therefore unlikely that \texttt{pd15} represents preferential sampling of \gls{hp} rocks from only slowly-converging \glspl{sz} (the same principle can also be applied to other \gls{tkbc}). Rather, it is much more likely that \texttt{pd15} reflects an overabundance of undifferentiated samples between 0.8 and 2.4 \(GPa\). While the true distribution of \gls{hp} rock recovered globally cannot be known, rough calculations demonstrating the improbability of preferential sampling from a subset of \glspl{sz} and a general inconsistency among marker \gls{pt} distributions and the rock record stress the importance of differentiating \gls{pt} estimates with relevant metadata. For example, sorting aggregated suites of \gls{hp} rocks by like metamorphic ages, lithologies, and estimates for \gls{tkbc} (e.g. \protect\hyperlink{ref-agard2018}{Agard et al., 2018}), make for better comparisons with natural and simulated \gls{ptt} datasets.
...
With respect to the first hypothesis, \gls{pt} distributions of recovered markers are distinct from the rock record (\texttt{pd15}) across almost all simulations except for a minority of slowly-converging models (40 \(km/Ma\), Figure \ref{fig:ecdfs}), and models that develop separated mantle wedges and diapirs (Figure \ref{fig:geodyn}). The majority of simulations recovery relatively few markers from 0.8 to 2.4 \(GPa\) compared to \texttt{pd15}. This result implies \texttt{pd15} is overrepresented (biased) by \gls{hp} rocks between 0.8 and 2.4 \(GPa\). Differentiating the rock record by relevant metadata (lithology, metamorphic ages, \gls{tkbc} estimates) is critically important to select against such bias (e.g. \protect\hyperlink{ref-agard2018}{Agard et al., 2018}).

With respect to the second hypothesis, recovered markers show a negative correlation between \(\Phi\) and recovery rate, implying a strong dependence of recovery rates on \gls{tkbc}. However, simulations also show an apparent association between recovery rates and subduction angle. This may imply that recovery rates are sensitive to \(\Phi\) because of differences in subduction geometry, rather than oceanic-plate age or convergence velocity \emph{per se}. Correlations among recovery rate and \gls{tkbc} are difficult to untangle because \(\Phi\) conflates thermo-kinematic effects (by design) and is therefore not the most precise explanatory variable. While a correlation between recovery rates and \(\Phi\) is apparent, the sensitivity of recovery rates to \gls{tkbc} (Figure \ref{fig:recRate}), especially subduction geometry, warrants further investigation.
...
This work uses three computational approaches---simulation, interpolation, and applied statistics---to address the following question. How diverse is mechanical behaviour along the plate interface across a range of plausible \gls{sz} configurations?

Plate coupling observed in numerical simulations from Chapter \ref{chpt2} demonstrate steady-state mechanical behaviour regulated self-consistently by feedbacks involving heat transfer and metamorphic dehydration of ultramafic sheet silicates in the upper-plate mantle. \Glsfirst{cd} is only weakly correlated with \(\Phi\) but strongly correlated with upper-plate lithospheric thickness. Thus uniform \glspl{cd} are expected if \glspl{sz} have uniformly thick upper-plates, which is indeed the case when considering averaged backarc \glsfirst{shf} for 17 presently active \glspl{sz} (\protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-hyndman2005}{Hyndman et al., 2005}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}).

However, 2D interpolations in Chapter \ref{chpt3} show diverse spatial patterns of \gls{shf}---some implying homogeneous thermal structure, others implying heterogeneous thermal structure---near 13 presently active \glspl{sz}. While Kriging methods yield inconsistent results for segments with low observation densities, Similarity methods show geologically-consistent interpolations of \gls{shf} across all segments. Both methods, where applicable, generally agree and present \gls{shf} interpolations in contradiction of broadly uniform upper-plate lithospheric thickness inferred from other (1D) sampling strategies (e.g. \protect\hyperlink{ref-currie2004}{Currie et al., 2004}; \protect\hyperlink{ref-currie2006}{Currie \& Hyndman, 2006}; \protect\hyperlink{ref-hyndman2005}{Hyndman et al., 2005}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}). These results imply broadly non-uniform \glspl{cd} among \glspl{sz}.

Chapter \ref{chpt4} takes a different approach by considering what \gls{pt} distributions of \gls{hp} rocks imply about mechanical variability among \glspl{sz}. A large (91,733) dataset of recovered markers shows marker \gls{ptt} distributions and recovery rates correlate with \(\Phi\) and subduction duration, but not upper-plate lithospheric thickness (as expected from Chapter \ref{chpt2}). These results imply broad differences in the mechanics of rock recovery through time and among \glspl{sz}.

While self-regulating mechanisms of uniform (and sustained) depths of plate coupling among different \glspl{sz} are plausible (Chapter \ref{chpt2}), 2D interpolations of \gls{shf} (Chapter \ref{chpt3}), and \gls{ptt} distributions of recovered markers (Chapter \ref{chpt4}) imply a more diverse picture of mechanical behaviour across different \gls{sz} settings. One reason for such assorted conclusions is using a relatively crude explanatory variable (\(\Phi\)) for comparison. \(\Phi\) is demonstrably useful for explaining variability among some features of \gls{sz} geodynamics (\protect\hyperlink{ref-gorbatov1997}{Gorbatov \& Kostoglodov, 1997}; \protect\hyperlink{ref-kirby1991}{Kirby et al., 1991}; \protect\hyperlink{ref-molnar1979}{Molnar et al., 1979}; \protect\hyperlink{ref-syracuse2010}{Syracuse et al., 2010}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}), but demonstrably ineffective in many cases (\protect\hyperlink{ref-maunder2019}{Maunder et al., 2019}). Future work may focus on developing new explanatory variables, scaling \gls{shf} datasets, and developing composite interpolation approaches to better estimate relative geodynamic variability among \glspl{sz}.
...
Taking the derivative of Equation \eqref{eq:loglik} with respect to each parameter, \(\pi\), \(\mu\), \(\Sigma\), setting the equation to zero, and solving for each parameter gives the \glspl{mle}:
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda46_snaps.png}
\caption[Geodynamic evolution of model cda46]{Geodynamic evolution of model cda46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda46_class.png}
\caption[Marker classification for model cda46]{Marker classification for model cda46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda46_meta.png}
\caption[PT distribution of recovered markers from model cda46]{PT distribution of recovered markers from model cda46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda62_snaps.png}
\caption[Geodynamic evolution of model cda62]{Geodynamic evolution of model cda62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda62_class.png}
\caption[Marker classification for model cda62]{Marker classification for model cda62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda62_meta.png}
\caption[PT distribution of recovered markers from model cda62]{PT distribution of recovered markers from model cda62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda78_snaps.png}
\caption[Geodynamic evolution of model cda78]{Geodynamic evolution of model cda78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda78_class.png}
\caption[Marker classification for model cda78]{Marker classification for model cda78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda78_meta.png}
\caption[PT distribution of recovered markers from model cda78]{PT distribution of recovered markers from model cda78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda94_snaps.png}
\caption[Geodynamic evolution of model cda94]{Geodynamic evolution of model cda94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda94_class.png}
\caption[Marker classification for model cda94]{Marker classification for model cda94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cda94_meta.png}
\caption[PT distribution of recovered markers from model cda94]{PT distribution of recovered markers from model cda94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb46_snaps.png}
\caption[Geodynamic evolution of model cdb46]{Geodynamic evolution of model cdb46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb46_class.png}
\caption[Marker classification for model cdb46]{Marker classification for model cdb46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb46_meta.png}
\caption[PT distribution of recovered markers from model cdb46]{PT distribution of recovered markers from model cdb46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb62_snaps.png}
\caption[Geodynamic evolution of model cdb62]{Geodynamic evolution of model cdb62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb62_class.png}
\caption[Marker classification for model cdb62]{Marker classification for model cdb62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb62_meta.png}
\caption[PT distribution of recovered markers from model cdb62]{PT distribution of recovered markers from model cdb62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb78_snaps.png}
\caption[Geodynamic evolution of model cdb78]{Geodynamic evolution of model cdb78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb78_class.png}
\caption[Marker classification for model cdb78]{Marker classification for model cdb78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb78_meta.png}
\caption[PT distribution of recovered markers from model cdb78]{PT distribution of recovered markers from model cdb78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb94_snaps.png}
\caption[Geodynamic evolution of model cdb94]{Geodynamic evolution of model cdb94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb94_class.png}
\caption[Marker classification for model cdb94]{Marker classification for model cdb94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdb94_meta.png}
\caption[PT distribution of recovered markers from model cdb94]{PT distribution of recovered markers from model cdb94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc46_snaps.png}
\caption[Geodynamic evolution of model cdc46]{Geodynamic evolution of model cdc46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc46_class.png}
\caption[Marker classification for model cdc46]{Marker classification for model cdc46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc46_meta.png}
\caption[PT distribution of recovered markers from model cdc46]{PT distribution of recovered markers from model cdc46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc62_snaps.png}
\caption[Geodynamic evolution of model cdc62]{Geodynamic evolution of model cdc62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc62_class.png}
\caption[Marker classification for model cdc62]{Marker classification for model cdc62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc62_meta.png}
\caption[PT distribution of recovered markers from model cdc62]{PT distribution of recovered markers from model cdc62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc78_snaps.png}
\caption[Geodynamic evolution of model cdc78]{Geodynamic evolution of model cdc78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc78_class.png}
\caption[Marker classification for model cdc78]{Marker classification for model cdc78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc78_meta.png}
\caption[PT distribution of recovered markers from model cdc78]{PT distribution of recovered markers from model cdc78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc94_snaps.png}
\caption[Geodynamic evolution of model cdc94]{Geodynamic evolution of model cdc94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc94_class.png}
\caption[Marker classification for model cdc94]{Marker classification for model cdc94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdc94_meta.png}
\caption[PT distribution of recovered markers from model cdc94]{PT distribution of recovered markers from model cdc94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd46_snaps.png}
\caption[Geodynamic evolution of model cdd46]{Geodynamic evolution of model cdd46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd46_class.png}
\caption[Marker classification for model cdd46]{Marker classification for model cdd46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd46_meta.png}
\caption[PT distribution of recovered markers from model cdd46]{PT distribution of recovered markers from model cdd46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd62_snaps.png}
\caption[Geodynamic evolution of model cdd62]{Geodynamic evolution of model cdd62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd62_class.png}
\caption[Marker classification for model cdd62]{Marker classification for model cdd62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd62_meta.png}
\caption[PT distribution of recovered markers from model cdd62]{PT distribution of recovered markers from model cdd62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd78_snaps.png}
\caption[Geodynamic evolution of model cdd78]{Geodynamic evolution of model cdd78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd78_class.png}
\caption[Marker classification for model cdd78]{Marker classification for model cdd78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd78_meta.png}
\caption[PT distribution of recovered markers from model cdd78]{PT distribution of recovered markers from model cdd78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd94_snaps.png}
\caption[Geodynamic evolution of model cdd94]{Geodynamic evolution of model cdd94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd94_class.png}
\caption[Marker classification for model cdd94]{Marker classification for model cdd94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdd94_meta.png}
\caption[PT distribution of recovered markers from model cdd94]{PT distribution of recovered markers from model cdd94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde46_snaps.png}
\caption[Geodynamic evolution of model cde46]{Geodynamic evolution of model cde46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde46_class.png}
\caption[Marker classification for model cde46]{Marker classification for model cde46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde46_meta.png}
\caption[PT distribution of recovered markers from model cde46]{PT distribution of recovered markers from model cde46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde62_snaps.png}
\caption[Geodynamic evolution of model cde62]{Geodynamic evolution of model cde62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde62_class.png}
\caption[Marker classification for model cde62]{Marker classification for model cde62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde62_meta.png}
\caption[PT distribution of recovered markers from model cde62]{PT distribution of recovered markers from model cde62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde78_snaps.png}
\caption[Geodynamic evolution of model cde78]{Geodynamic evolution of model cde78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde78_class.png}
\caption[Marker classification for model cde78]{Marker classification for model cde78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde78_meta.png}
\caption[PT distribution of recovered markers from model cde78]{PT distribution of recovered markers from model cde78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde94_snaps.png}
\caption[Geodynamic evolution of model cde94]{Geodynamic evolution of model cde94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde94_class.png}
\caption[Marker classification for model cde94]{Marker classification for model cde94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cde94_meta.png}
\caption[PT distribution of recovered markers from model cde94]{PT distribution of recovered markers from model cde94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf46_snaps.png}
\caption[Geodynamic evolution of model cdf46]{Geodynamic evolution of model cdf46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf46_class.png}
\caption[Marker classification for model cdf46]{Marker classification for model cdf46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf46_meta.png}
\caption[PT distribution of recovered markers from model cdf46]{PT distribution of recovered markers from model cdf46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf62_snaps.png}
\caption[Geodynamic evolution of model cdf62]{Geodynamic evolution of model cdf62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf62_class.png}
\caption[Marker classification for model cdf62]{Marker classification for model cdf62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf62_meta.png}
\caption[PT distribution of recovered markers from model cdf62]{PT distribution of recovered markers from model cdf62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf78_snaps.png}
\caption[Geodynamic evolution of model cdf78]{Geodynamic evolution of model cdf78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf78_class.png}
\caption[Marker classification for model cdf78]{Marker classification for model cdf78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf78_meta.png}
\caption[PT distribution of recovered markers from model cdf78]{PT distribution of recovered markers from model cdf78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf94_snaps.png}
\caption[Geodynamic evolution of model cdf94]{Geodynamic evolution of model cdf94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf94_class.png}
\caption[Marker classification for model cdf94]{Marker classification for model cdf94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdf94_meta.png}
\caption[PT distribution of recovered markers from model cdf94]{PT distribution of recovered markers from model cdf94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg46_snaps.png}
\caption[Geodynamic evolution of model cdg46]{Geodynamic evolution of model cdg46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg46_class.png}
\caption[Marker classification for model cdg46]{Marker classification for model cdg46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg46_meta.png}
\caption[PT distribution of recovered markers from model cdg46]{PT distribution of recovered markers from model cdg46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg62_snaps.png}
\caption[Geodynamic evolution of model cdg62]{Geodynamic evolution of model cdg62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg62_class.png}
\caption[Marker classification for model cdg62]{Marker classification for model cdg62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg62_meta.png}
\caption[PT distribution of recovered markers from model cdg62]{PT distribution of recovered markers from model cdg62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg78_snaps.png}
\caption[Geodynamic evolution of model cdg78]{Geodynamic evolution of model cdg78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg78_class.png}
\caption[Marker classification for model cdg78]{Marker classification for model cdg78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg78_meta.png}
\caption[PT distribution of recovered markers from model cdg78]{PT distribution of recovered markers from model cdg78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg94_snaps.png}
\caption[Geodynamic evolution of model cdg94]{Geodynamic evolution of model cdg94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg94_class.png}
\caption[Marker classification for model cdg94]{Marker classification for model cdg94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdg94_meta.png}
\caption[PT distribution of recovered markers from model cdg94]{PT distribution of recovered markers from model cdg94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh46_snaps.png}
\caption[Geodynamic evolution of model cdh46]{Geodynamic evolution of model cdh46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh46_class.png}
\caption[Marker classification for model cdh46]{Marker classification for model cdh46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh46_meta.png}
\caption[PT distribution of recovered markers from model cdh46]{PT distribution of recovered markers from model cdh46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh62_snaps.png}
\caption[Geodynamic evolution of model cdh62]{Geodynamic evolution of model cdh62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh62_class.png}
\caption[Marker classification for model cdh62]{Marker classification for model cdh62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh62_meta.png}
\caption[PT distribution of recovered markers from model cdh62]{PT distribution of recovered markers from model cdh62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh78_snaps.png}
\caption[Geodynamic evolution of model cdh78]{Geodynamic evolution of model cdh78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh78_class.png}
\caption[Marker classification for model cdh78]{Marker classification for model cdh78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh78_meta.png}
\caption[PT distribution of recovered markers from model cdh78]{PT distribution of recovered markers from model cdh78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh94_snaps.png}
\caption[Geodynamic evolution of model cdh94]{Geodynamic evolution of model cdh94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh94_class.png}
\caption[Marker classification for model cdh94]{Marker classification for model cdh94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdh94_meta.png}
\caption[PT distribution of recovered markers from model cdh94]{PT distribution of recovered markers from model cdh94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi46_snaps.png}
\caption[Geodynamic evolution of model cdi46]{Geodynamic evolution of model cdi46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi46_class.png}
\caption[Marker classification for model cdi46]{Marker classification for model cdi46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi46_meta.png}
\caption[PT distribution of recovered markers from model cdi46]{PT distribution of recovered markers from model cdi46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi62_snaps.png}
\caption[Geodynamic evolution of model cdi62]{Geodynamic evolution of model cdi62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi62_class.png}
\caption[Marker classification for model cdi62]{Marker classification for model cdi62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi62_meta.png}
\caption[PT distribution of recovered markers from model cdi62]{PT distribution of recovered markers from model cdi62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi78_snaps.png}
\caption[Geodynamic evolution of model cdi78]{Geodynamic evolution of model cdi78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi78_class.png}
\caption[Marker classification for model cdi78]{Marker classification for model cdi78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi78_meta.png}
\caption[PT distribution of recovered markers from model cdi78]{PT distribution of recovered markers from model cdi78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi94_snaps.png}
\caption[Geodynamic evolution of model cdi94]{Geodynamic evolution of model cdi94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi94_class.png}
\caption[Marker classification for model cdi94]{Marker classification for model cdi94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdi94_meta.png}
\caption[PT distribution of recovered markers from model cdi94]{PT distribution of recovered markers from model cdi94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj46_snaps.png}
\caption[Geodynamic evolution of model cdj46]{Geodynamic evolution of model cdj46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj46_class.png}
\caption[Marker classification for model cdj46]{Marker classification for model cdj46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj46_meta.png}
\caption[PT distribution of recovered markers from model cdj46]{PT distribution of recovered markers from model cdj46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj62_snaps.png}
\caption[Geodynamic evolution of model cdj62]{Geodynamic evolution of model cdj62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj62_class.png}
\caption[Marker classification for model cdj62]{Marker classification for model cdj62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj62_meta.png}
\caption[PT distribution of recovered markers from model cdj62]{PT distribution of recovered markers from model cdj62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj78_snaps.png}
\caption[Geodynamic evolution of model cdj78]{Geodynamic evolution of model cdj78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj78_class.png}
\caption[Marker classification for model cdj78]{Marker classification for model cdj78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj78_meta.png}
\caption[PT distribution of recovered markers from model cdj78]{PT distribution of recovered markers from model cdj78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj94_snaps.png}
\caption[Geodynamic evolution of model cdj94]{Geodynamic evolution of model cdj94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj94_class.png}
\caption[Marker classification for model cdj94]{Marker classification for model cdj94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdj94_meta.png}
\caption[PT distribution of recovered markers from model cdj94]{PT distribution of recovered markers from model cdj94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk46_snaps.png}
\caption[Geodynamic evolution of model cdk46]{Geodynamic evolution of model cdk46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk46_class.png}
\caption[Marker classification for model cdk46]{Marker classification for model cdk46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk46_meta.png}
\caption[PT distribution of recovered markers from model cdk46]{PT distribution of recovered markers from model cdk46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk62_snaps.png}
\caption[Geodynamic evolution of model cdk62]{Geodynamic evolution of model cdk62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk62_class.png}
\caption[Marker classification for model cdk62]{Marker classification for model cdk62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk62_meta.png}
\caption[PT distribution of recovered markers from model cdk62]{PT distribution of recovered markers from model cdk62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk78_snaps.png}
\caption[Geodynamic evolution of model cdk78]{Geodynamic evolution of model cdk78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk78_class.png}
\caption[Marker classification for model cdk78]{Marker classification for model cdk78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk78_meta.png}
\caption[PT distribution of recovered markers from model cdk78]{PT distribution of recovered markers from model cdk78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk94_snaps.png}
\caption[Geodynamic evolution of model cdk94]{Geodynamic evolution of model cdk94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk94_class.png}
\caption[Marker classification for model cdk94]{Marker classification for model cdk94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdk94_meta.png}
\caption[PT distribution of recovered markers from model cdk94]{PT distribution of recovered markers from model cdk94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl46_snaps.png}
\caption[Geodynamic evolution of model cdl46]{Geodynamic evolution of model cdl46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl46_class.png}
\caption[Marker classification for model cdl46]{Marker classification for model cdl46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl46_meta.png}
\caption[PT distribution of recovered markers from model cdl46]{PT distribution of recovered markers from model cdl46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl62_snaps.png}
\caption[Geodynamic evolution of model cdl62]{Geodynamic evolution of model cdl62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl62_class.png}
\caption[Marker classification for model cdl62]{Marker classification for model cdl62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl62_meta.png}
\caption[PT distribution of recovered markers from model cdl62]{PT distribution of recovered markers from model cdl62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl78_snaps.png}
\caption[Geodynamic evolution of model cdl78]{Geodynamic evolution of model cdl78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl78_class.png}
\caption[Marker classification for model cdl78]{Marker classification for model cdl78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl78_meta.png}
\caption[PT distribution of recovered markers from model cdl78]{PT distribution of recovered markers from model cdl78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl94_snaps.png}
\caption[Geodynamic evolution of model cdl94]{Geodynamic evolution of model cdl94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl94_class.png}
\caption[Marker classification for model cdl94]{Marker classification for model cdl94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdl94_meta.png}
\caption[PT distribution of recovered markers from model cdl94]{PT distribution of recovered markers from model cdl94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm46_snaps.png}
\caption[Geodynamic evolution of model cdm46]{Geodynamic evolution of model cdm46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm46_class.png}
\caption[Marker classification for model cdm46]{Marker classification for model cdm46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm46_meta.png}
\caption[PT distribution of recovered markers from model cdm46]{PT distribution of recovered markers from model cdm46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm62_snaps.png}
\caption[Geodynamic evolution of model cdm62]{Geodynamic evolution of model cdm62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm62_class.png}
\caption[Marker classification for model cdm62]{Marker classification for model cdm62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm62_meta.png}
\caption[PT distribution of recovered markers from model cdm62]{PT distribution of recovered markers from model cdm62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm78_snaps.png}
\caption[Geodynamic evolution of model cdm78]{Geodynamic evolution of model cdm78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm78_class.png}
\caption[Marker classification for model cdm78]{Marker classification for model cdm78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm78_meta.png}
\caption[PT distribution of recovered markers from model cdm78]{PT distribution of recovered markers from model cdm78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm94_snaps.png}
\caption[Geodynamic evolution of model cdm94]{Geodynamic evolution of model cdm94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm94_class.png}
\caption[Marker classification for model cdm94]{Marker classification for model cdm94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdm94_meta.png}
\caption[PT distribution of recovered markers from model cdm94]{PT distribution of recovered markers from model cdm94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn46_snaps.png}
\caption[Geodynamic evolution of model cdn46]{Geodynamic evolution of model cdn46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn46_class.png}
\caption[Marker classification for model cdn46]{Marker classification for model cdn46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn46_meta.png}
\caption[PT distribution of recovered markers from model cdn46]{PT distribution of recovered markers from model cdn46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn62_snaps.png}
\caption[Geodynamic evolution of model cdn62]{Geodynamic evolution of model cdn62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn62_class.png}
\caption[Marker classification for model cdn62]{Marker classification for model cdn62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn62_meta.png}
\caption[PT distribution of recovered markers from model cdn62]{PT distribution of recovered markers from model cdn62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn78_snaps.png}
\caption[Geodynamic evolution of model cdn78]{Geodynamic evolution of model cdn78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn78_class.png}
\caption[Marker classification for model cdn78]{Marker classification for model cdn78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn78_meta.png}
\caption[PT distribution of recovered markers from model cdn78]{PT distribution of recovered markers from model cdn78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn94_snaps.png}
\caption[Geodynamic evolution of model cdn94]{Geodynamic evolution of model cdn94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn94_class.png}
\caption[Marker classification for model cdn94]{Marker classification for model cdn94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdn94_meta.png}
\caption[PT distribution of recovered markers from model cdn94]{PT distribution of recovered markers from model cdn94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo46_snaps.png}
\caption[Geodynamic evolution of model cdo46]{Geodynamic evolution of model cdo46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo46_class.png}
\caption[Marker classification for model cdo46]{Marker classification for model cdo46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo46_meta.png}
\caption[PT distribution of recovered markers from model cdo46]{PT distribution of recovered markers from model cdo46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo62_snaps.png}
\caption[Geodynamic evolution of model cdo62]{Geodynamic evolution of model cdo62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo62_class.png}
\caption[Marker classification for model cdo62]{Marker classification for model cdo62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo62_meta.png}
\caption[PT distribution of recovered markers from model cdo62]{PT distribution of recovered markers from model cdo62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo78_snaps.png}
\caption[Geodynamic evolution of model cdo78]{Geodynamic evolution of model cdo78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo78_class.png}
\caption[Marker classification for model cdo78]{Marker classification for model cdo78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo78_meta.png}
\caption[PT distribution of recovered markers from model cdo78]{PT distribution of recovered markers from model cdo78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo94_snaps.png}
\caption[Geodynamic evolution of model cdo94]{Geodynamic evolution of model cdo94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo94_class.png}
\caption[Marker classification for model cdo94]{Marker classification for model cdo94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdo94_meta.png}
\caption[PT distribution of recovered markers from model cdo94]{PT distribution of recovered markers from model cdo94}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp46_snaps.png}
\caption[Geodynamic evolution of model cdp46]{Geodynamic evolution of model cdp46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp46_class.png}
\caption[Marker classification for model cdp46]{Marker classification for model cdp46}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp46_meta.png}
\caption[PT distribution of recovered markers from model cdp46]{PT distribution of recovered markers from model cdp46}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp62_snaps.png}
\caption[Geodynamic evolution of model cdp62]{Geodynamic evolution of model cdp62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp62_class.png}
\caption[Marker classification for model cdp62]{Marker classification for model cdp62}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp62_meta.png}
\caption[PT distribution of recovered markers from model cdp62]{PT distribution of recovered markers from model cdp62}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp78_snaps.png}
\caption[Geodynamic evolution of model cdp78]{Geodynamic evolution of model cdp78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp78_class.png}
\caption[Marker classification for model cdp78]{Marker classification for model cdp78}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp78_meta.png}
\caption[PT distribution of recovered markers from model cdp78]{PT distribution of recovered markers from model cdp78}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp94_snaps.png}
\caption[Geodynamic evolution of model cdp94]{Geodynamic evolution of model cdp94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp94_class.png}
\caption[Marker classification for model cdp94]{Marker classification for model cdp94}
\end{figure}

\begin{figure}
\centering
\includegraphics{assets/figs/chpt4/k10/cdp94_meta.png}
\caption[PT distribution of recovered markers from model cdp94]{PT distribution of recovered markers from model cdp94}
\end{figure}
