...
\caption{\label{tab:hfSummaryTable}Heat flow observation summary}
\centering
\begin{threeparttable}
...
The optimal variogram models and associated errors are given in (\protect\hyperlink{ref-tbl:variogramSummaryTable}{\textbf{tbl:variogramSummaryTable?}}). Almost twice as many experimental variograms are fit with spherical models (10) compared to exponential models (3). Variogram model sills vary substantially among the subduction zone segments between 9 and 1181 \(mWm^{-2}\). Variogram model ranges also vary substantially among segments from 4 to 1397 \(km\).

No apparent correlation exists between variogram model range and subduction zone segment length, number of heat flow observations, nor domain area ((\protect\hyperlink{ref-fig:variogramSummaryPlot}{\textbf{fig:variogramSummaryPlot?}})). Most subduction zone segments show spatial dependence of a few hundred kilometers or less, irrespective of the number of observations or segment size. The exceptions are Kyushu Ryukyu (range = 1397 \(km\)) and Vanuatu (range = 573 \(km\)), whose model variogram ranges are, perhaps, anomalously high.

\begin{table}

\caption{\label{tab:variogramSummaryTable}Variogram model summary}
\centering
\begin{threeparttable}
...
Segment & Model & $s$ & $a$\\
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{285} & \cellcolor{gray!6}{222}\\
Andes & Sph & 91 & 369\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{85} & \cellcolor{gray!6}{335}\\
Kamchatka Marianas & Exp & 602 & 270\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{760} & \cellcolor{gray!6}{1397}\\
\addlinespace
Lesser Antilles & Sph & 60 & 379\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{1181} & \cellcolor{gray!6}{238}\\
New Britain Solomon & Exp & 29 & 90\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{1011} & \cellcolor{gray!6}{415}\\
Scotia & Exp & 9 & 4\\
\addlinespace
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{67} & \cellcolor{gray!6}{135}\\
Tonga New Zealand & Sph & 47 & 132\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{Sph} & \cellcolor{gray!6}{48} & \cellcolor{gray!6}{573}\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \uline{\textit{key}}: $s$: sill $[mWm^{-2}]$, $a$: range $[km]$
\end{tablenotes}
\end{threeparttable}
\end{table}
