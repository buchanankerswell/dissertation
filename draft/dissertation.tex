...
First, ordinary Kriging is applied to the \texttt{ThermoGlobe} database (\protect\hyperlink{ref-jennings2021}{Jennings \& Hasterok, 2021}; \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}) cropped within 1000 \(km\) buffers around 13 active \glspl{sz} defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Kriging estimates and uncertainties are then directly compared (point-by-point) to Similarity interpolations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). The results show Kriging and Similarity methods are generally comparable for most subduction segments but considerable uncertainty exists at the \gls{sz} segment scale. This study highlights challenges in inferring \gls{sz} geodynamics quantitatively from \gls{shf} datasets without significant assumptions. Strategically scaling global datasets and inventing composite interpolation schema promise better tools for distinguishing geodynamic variability near active \glspl{sz}.
...
\caption[Distribution of \texttt{ThermoGlobe} observations near \gls{sz} segments]{Distribution of \texttt{ThermoGlobe} observations cropped within 1000 \(km\) circular buffers around 13 active \gls{sz} segments. Heat flow distributions are centered between 41 and 107 \(mWm^{-2}\) and highly skewed right. Skewness represents near-surface perturbations from geothermal systems and tectonic regions with high thermal activity. Diverse interactions between tectonic and near-surface processes are apparent from the broad, irregular \gls{shf} distributions. Data from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}).}\label{fig:hfSummaryPlot}
\end{figure}
...
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{289} & \cellcolor{gray!6}{6} & \cellcolor{gray!6}{196} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{27} & \cellcolor{gray!6}{71} & \cellcolor{gray!6}{28}\\
Andes & 1399 & 7 & 250 & 107 & 120 & 119 & 66\\
...
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{1894} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{250} & \cellcolor{gray!6}{76} & \cellcolor{gray!6}{42} & \cellcolor{gray!6}{84} & \cellcolor{gray!6}{42}\\
\addlinespace
Lesser Antilles & 3010 & 13 & 242 & 41 & 8 & 46 & 18\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{567} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{231} & \cellcolor{gray!6}{71} & \cellcolor{gray!6}{26} & \cellcolor{gray!6}{75} & \cellcolor{gray!6}{33}\\
...
\addlinespace
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{1415} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{247} & \cellcolor{gray!6}{59} & \cellcolor{gray!6}{63} & \cellcolor{gray!6}{68} & \cellcolor{gray!6}{42}\\
Tonga New Zealand & 354 & 5 & 218 & 49 & 41 & 59 & 37\\
...
\item \uline{\textit{note}}: Data are filtered and cropped within 1000 $km$ of segment boundaries
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\caption[Example of an interpolation domain constructed around Kyushu Ryukyu]{Example of a interpolation domain constructed around Kyushu Ryukyu. Interpolation domains are defined by drawing a 1000 \(km\) circular buffer (thin black line) around the segment boundary (bold black line). \texttt{ThermoGlobe} data is cropped within the buffered region by intersection (left). Note that Kyushu Ryukyu is one of the most densely sampled regions, yet still has considerable gaps. Similarity interpolation (right) fills in the gaps and presents a textured distribution by combining many underlying geologic proxy datasets. \gls{shf} above 250 \(mWm^{-2}\) is colored white. Data and interpolations from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). Segment boundary defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}).}\label{fig:domainConstruct}
\end{figure}
...
The optimal variogram models and associated errors are given in Table \ref{tab:variogramSummaryTable}. Almost twice as many experimental variograms are fit with spherical models (13) compared to exponential models (13). Variogram model sills vary substantially among the subduction zone segments between 1 and 13.7788512 \(mWm^{-2}\). Variogram model ranges also vary substantially among segments from 15 to 49.9605659 \(km\).

No apparent correlation exists between variogram model range and subduction zone segment length, number of heat flow observations, nor domain area (Figure \ref{fig:variogramSummaryPlot}). Most subduction zone segments show spatial dependence of a few hundred kilometers or less, irrespective of the number of observations or segment size. The exceptions are Kyushu Ryukyu (range = c(30.4965214468065, 28.2132183147438, 23.2205951304064, 49.9605659016366, 49.9289849284022, 29.5454979939797) \(km\)) and Vanuatu (range = c(16.6610790513437, 30.1017868415855, 18.0602372009109, 38.277012463659, 26.9856112683897, 29.527012463659) \(km\)), whose model variogram ranges are, perhaps, anomalously high.
...
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{Bes} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{29.7} & \cellcolor{gray!6}{6.7} & \cellcolor{gray!6}{14.5} & \cellcolor{gray!6}{723} & \cellcolor{gray!6}{108} & \cellcolor{gray!6}{47} & \cellcolor{gray!6}{0.099}\\
Andes & Lin & 1.0 & 15.0 & 10.0 & 13.7 & 3358 & 2788 & 42 & 0.060\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{6.6} & \cellcolor{gray!6}{41.6} & \cellcolor{gray!6}{9.4} & \cellcolor{gray!6}{15.3} & \cellcolor{gray!6}{2979} & \cellcolor{gray!6}{233} & \cellcolor{gray!6}{48} & \cellcolor{gray!6}{0.060}\\
Kamchatka Marianas & Sph & 8.9 & 48.5 & 8.8 & 17.1 & 1821 & 241 & 47 & 0.103\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{49.9} & \cellcolor{gray!6}{10.0} & \cellcolor{gray!6}{14.7} & \cellcolor{gray!6}{1798} & \cellcolor{gray!6}{657} & \cellcolor{gray!6}{49} & \cellcolor{gray!6}{0.098}\\
\addlinespace
Lesser Antilles & Sph & 3.9 & 31.1 & 7.1 & 13.7 & 397 & 326 & 49 & 0.065\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{13.5} & \cellcolor{gray!6}{29.5} & \cellcolor{gray!6}{6.6} & \cellcolor{gray!6}{13.7} & \cellcolor{gray!6}{1370} & \cellcolor{gray!6}{65} & \cellcolor{gray!6}{47} & \cellcolor{gray!6}{0.115}\\
New Britain Solomon & Cir & 7.3 & 23.7 & 8.0 & 10.0 & 722 & 214 & 47 & 0.127\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{30.7} & \cellcolor{gray!6}{9.1} & \cellcolor{gray!6}{13.9} & \cellcolor{gray!6}{1446} & \cellcolor{gray!6}{1320} & \cellcolor{gray!6}{47} & \cellcolor{gray!6}{0.092}\\
Scotia & Exp & 4.4 & 32.1 & 6.0 & 10.0 & 4980 & 1103 & 45 & 0.041\\
\addlinespace
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{10.0} & \cellcolor{gray!6}{31.8} & \cellcolor{gray!6}{7.3} & \cellcolor{gray!6}{18.5} & \cellcolor{gray!6}{2232} & \cellcolor{gray!6}{422} & \cellcolor{gray!6}{47} & \cellcolor{gray!6}{0.056}\\
Tonga New Zealand & Lin & 1.0 & 30.8 & 7.2 & 13.4 & 1420 & 1016 & 47 & 0.106\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{8.5} & \cellcolor{gray!6}{27.0} & \cellcolor{gray!6}{9.2} & \cellcolor{gray!6}{13.5} & \cellcolor{gray!6}{2837} & \cellcolor{gray!6}{272} & \cellcolor{gray!6}{45} & \cellcolor{gray!6}{0.099}\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \uline{\textit{note}}: Optimum model selected by minimum cost (excluding Gau models)
\item \uline{\textit{key}}: $n_{max}$: max point-pairs for local Kriging, Sill $[(mWm^{-2})^2]$, Range $[km]$, Cost $[mWm^{-2}]$
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{Bes} & \cellcolor{gray!6}{0.099} & \cellcolor{gray!6}{5779} & \cellcolor{gray!6}{-1185} & \cellcolor{gray!6}{852} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{23} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{70}\\
Andes & Lin & 0.060 & 7624 & -139 & 2014 & 3 & 44 & 7 & 76\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{0.060} & \cellcolor{gray!6}{2792} & \cellcolor{gray!6}{-140} & \cellcolor{gray!6}{2306} & \cellcolor{gray!6}{16} & \cellcolor{gray!6}{60} & \cellcolor{gray!6}{43} & \cellcolor{gray!6}{136}\\
Kamchatka Marianas & Sph & 0.103 & 7059 & -135 & 179 & 3 & 17 & 3 & 21\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{0.098} & \cellcolor{gray!6}{2766} & \cellcolor{gray!6}{-99} & \cellcolor{gray!6}{160} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{20} & \cellcolor{gray!6}{6} & \cellcolor{gray!6}{22}\\
\addlinespace
Lesser Antilles & Sph & 0.065 & 2225 & -113 & 129 & 3 & 18 & 2 & 26\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{0.115} & \cellcolor{gray!6}{1835} & \cellcolor{gray!6}{-74} & \cellcolor{gray!6}{150} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{23} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{21}\\
New Britain Solomon & Cir & 0.127 & 2011 & -68 & 158 & 7 & 20 & 9 & 21\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{0.092} & \cellcolor{gray!6}{3174} & \cellcolor{gray!6}{-72} & \cellcolor{gray!6}{365} & \cellcolor{gray!6}{7} & \cellcolor{gray!6}{25} & \cellcolor{gray!6}{10} & \cellcolor{gray!6}{26}\\
Scotia & Exp & 0.041 & 2719 & -107 & 1012 & 3 & 39 & 6 & 42\\
\addlinespace
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{0.056} & \cellcolor{gray!6}{5932} & \cellcolor{gray!6}{-137} & \cellcolor{gray!6}{365} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{20} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{22}\\
Tonga New Zealand & Lin & 0.106 & 4091 & -121 & 190 & -1 & 24 & -2 & 27\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{0.099} & \cellcolor{gray!6}{2508} & \cellcolor{gray!6}{-166} & \cellcolor{gray!6}{1684} & \cellcolor{gray!6}{15} & \cellcolor{gray!6}{30} & \cellcolor{gray!6}{15} & \cellcolor{gray!6}{52}\\
\bottomrule
\end{tabular}
\begin{tablenotes}
