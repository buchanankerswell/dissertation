...
(ref:lucahfCap) Global heat flow from the ThermoGlobe database (n = `r format(nrow(hf),big.mark=',')`) and interpolation by similarity method. Data from @lucazeau2019 & @jennings2021.
