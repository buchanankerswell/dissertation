...
This study applies ordinary Kriging to the ThermoGlobe database [@lucazeau2019; @jennings2021] sampled within 1000 $km$ buffers around 13 active \glspl{sz} defined by @syracuse2006. Kriging interpolations are directly compared (point-to-point) to Similarity interpolations from @lucazeau2019. Kriging and Similarity methods are generally comparable for most subduction segments, but uncertain at the \gls{sz} segment scale. The results highlight challenges in inferring \gls{sz} geodynamics from \gls{shf} datasets without significant assumptions. 
