...
hf.summary %>%
kable(
  caption = 'Heat flow observation summary',
...
footnote(
  general_title = '',
  general = c('\\\\uline{\\\\textit{key}}: $s$: sill $[mWm^{-2}]$, $a$: range $[km]$'),
  threeparttable = T,
  escape = F
)
```
