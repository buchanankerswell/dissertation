...
\tightlist
\item
  Everything is related, but nearer things are more related (\protect\hyperlink{ref-krige1951}{Krige, 1951}; \protect\hyperlink{ref-matheron1963}{Matheron, 1963})
\item
  Geographic phenomena are inherently heterogeneous (\protect\hyperlink{ref-goodchild2004}{Goodchild, 2004})
\item
  Locations with similar geographic configurations have similar values for other target variables (\protect\hyperlink{ref-zhu2018}{Zhu et al., 2018})
\end{enumerate}
\end{quote}
...
\hypertarget{upper-plate-surface-heat-flow-continuity}{%
...
In principle, combining the desirable properties of Similarity (spatial-independence) and Kriging (conserving ground-truth) during the interpolation process is possible by layering Similarity and Kriging interpolations. A layered approach simultaneously respects the First (\protect\hyperlink{ref-krige1951}{Krige, 1951}) and Third Laws of Geography (\protect\hyperlink{ref-zhu2018}{Zhu et al., 2018}) by integrating geologic and spatial information. Any number of methods may be applied to combine Similarity and Kriging predictions. As a basic example: (1) compare Similarity and Kriging layers to detect anomalies, (2) compute weights proportional to the squared difference between Similarity and Kriging predictions to emphasized (or subdue) anomalies, (3) combine Similarity and Kriging layers using a weighted average scheme.

\hypertarget{conclusions-1}{%
\section{Conclusions}\label{conclusions-1}}

This study evaluates spatial patterns of surface heat flow near subduction zones by comparing Kriging and Similarity interpolation methods applied to a (processed) global surface heat flow dataset (ThermoGlobe, \protect\hyperlink{ref-lucazeau2019}{Lucazeau, 2019}). Surface heat flow distributions and trench-orthogonal profiles predicted by Similarity and Kriging highlight at least three important points of consideration:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Irregular spacing of ThermoGlobe data
\item
...
\item
  Layered interpolation approaches can combine the strengths of Similarity (spatial-independence) and Kriging (conserving ground-truth) to produce more accurate surface heat flow predictions
\end{enumerate}
