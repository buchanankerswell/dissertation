...
% Make title page
  \title{Computational Approaches to Understanding Subduction Zone Geodynamics, Surface Heat Flow, and Metamorphic Rock Record}
...
\def\maketitle{
  ...
  \begin{titlepage}
    ...
    \begin{center}
        % Title
        {\huge Computational Approaches to Understanding Subduction Zone Geodynamics, Surface Heat Flow, and Metamorphic Rock Record \par}
        \vspace*{0.5in}
  ...
  \begin{flushleft}
    \begin{singlespace}
      \begin{tabularx}{\textwidth}{@{}lX} 
        Dissertation Title: & {Computational Approaches to Understanding Subduction Zone Geodynamics, Surface Heat Flow, and Metamorphic Rock Record}
      \end{tabularx}
    \end{singlespace}
    \begin{tabularx}{\textwidth}{@{}lX} 
...
\caption{\label{tab:vgrmSummaryTable}Optimum variogram models and interpolation accuracy by segment}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
\begin{tabular}[t]{llrrrrrrrr}
\toprule
\multicolumn{1}{c}{Segment} & \multicolumn{1}{c}{Model} & \multicolumn{1}{c}{Cutoff} & \multicolumn{1}{c}{Lags} & \multicolumn{1}{c}{Shift} & \multicolumn{1}{c}{$n_{max}$} & \multicolumn{1}{c}{Sill} & \multicolumn{1}{c}{Range} & \multicolumn{1}{c}{$RMSE_K$} & \multicolumn{1}{c}{$RMSE_S$} \\
...
\midrule
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{Bes} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{16.3} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{8.4} & \cellcolor{gray!6}{841} & \cellcolor{gray!6}{77} & \cellcolor{gray!6}{17.6} & \cellcolor{gray!6}{74.6}\\
Andes & Exp & 1.6 & 20.8 & 8.5 & 12.4 & 4631 & 165 & 52.6 & 34.9\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{Exp} & \cellcolor{gray!6}{4.9} & \cellcolor{gray!6}{21.2} & \cellcolor{gray!6}{3.9} & \cellcolor{gray!6}{12.4} & \cellcolor{gray!6}{4683} & \cellcolor{gray!6}{265} & \cellcolor{gray!6}{52.5} & \cellcolor{gray!6}{33.4}\\
Kamchatka Marianas & Sph & 1.7 & 18.5 & 7.5 & 6.9 & 1787 & 1355 & 33.1 & 31.2\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{Lin} & \cellcolor{gray!6}{3.2} & \cellcolor{gray!6}{19.8} & \cellcolor{gray!6}{3.3} & \cellcolor{gray!6}{8.3} & \cellcolor{gray!6}{1898} & \cellcolor{gray!6}{183} & \cellcolor{gray!6}{34.5} & \cellcolor{gray!6}{37.8}\\
Lesser Antilles & Lin & 1.5 & 24.2 & 1.1 & 11.0 & 653 & 77 & 11.5 & 13.3\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{Bes} & \cellcolor{gray!6}{1.4} & \cellcolor{gray!6}{18.3} & \cellcolor{gray!6}{1.0} & \cellcolor{gray!6}{7.9} & \cellcolor{gray!6}{1258} & \cellcolor{gray!6}{19} & \cellcolor{gray!6}{27.1} & \cellcolor{gray!6}{32.0}\\
...
\item
  Layered interpolation approaches may produce more accurate surface heat flow predictions by combining the properties of Similarity and Kriging methods
\end{enumerate}
...
\def\labelenumi{\arabic{enumi}.}
\item
  The probability of recovering \gls{hp} oceanic sediments and crustal fragments is relatively uniform up to 2.5 \(GPa\)
\item
  Less than 5-19\% of recovered \gls{hp} oceanic sediments and crustal fragments equilibrate at pressures greater than 2.5 \(GPa\)
\item
  Between 37-48\% of oceanic sediments and crustal fragments record thermal gradients below 10 \(K/km\)
\end{enumerate}
\end{quote}
...
\midrule
\cellcolor{gray!6}{1} & \cellcolor{gray!6}{max P is reached after collision with convergence region} & \cellcolor{gray!6}{collision (lost)} & \cellcolor{gray!6}{0}\\
2 & marker changes into melt or water & phase change (lost) & 0\\
\cellcolor{gray!6}{3} & \cellcolor{gray!6}{T never exceeds 50 $^\circ$C} & \cellcolor{gray!6}{T anomaly (lost)} & \cellcolor{gray!6}{0}\\
4 & extreme non-lithostatic max P & P anomaly (lost) & 0\\
\cellcolor{gray!6}{5} & \cellcolor{gray!6}{max P is 7.5$\sigma$ above the mean (recovered) max P} & \cellcolor{gray!6}{P anomaly (lost)} & \cellcolor{gray!6}{0}\\
6 & cluster centroid is below a $5\ K/km$ gradient & subducted (lost) & 0\\
\cellcolor{gray!6}{7} & \cellcolor{gray!6}{none of the above} & \cellcolor{gray!6}{recovered} & \cellcolor{gray!6}{0}\\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
{\centering \includegraphics[width=1\linewidth,]{assets/figs/chpt4/cdf78_k10_class} 

}

\caption[Example of marker classification for model cdf78]{Example of marker classification for model cdf78. Clustering assigns 19,959 markers (squares) into ten classes according to their maximum \gls{pt} relative to all other markers (left). The size of cluster centroids (triangles) are proportional to the number of markers in a class. Markers belonging to clusters with centroids that have average \gls{pt} gradients greater than 5 \(K/km\) (plotting to the right of the thin black line labelled ``5'') classify as recovered. Additional rules are applied to (re)classify individual markers (right; see Table \ref{tab:rules}). Thin black lines are average \gls{pt} gradients of 5 \(K/km\) and 20 \(K/km\) (calculated with a lithostatic gradient of 35 \(km/GPa\)).}\label{fig:class}
\end{figure}
...
\toprule
\multicolumn{5}{c}{Model Parameters} & \multicolumn{8}{c}{Marker Classification} \\
\cmidrule(l{3pt}r{3pt}){1-5} \cmidrule(l{3pt}r{3pt}){6-13}
model & $\Phi$ & $Z_{UP}$ & age & $\vec{v}$ & n & recov & recov\% & med max P & med max T & < 625 C & < 2.5 GPa & < 10 C/km\\
\midrule
\endfirsthead
...
\insertTableNotes
\endlastfoot
\cellcolor{gray!6}{cda46} & \cellcolor{gray!6}{13.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{21527} & \cellcolor{gray!6}{1447} & \cellcolor{gray!6}{6.72} & \cellcolor{gray!6}{11452.9} & \cellcolor{gray!6}{665.3} & \cellcolor{gray!6}{99.2} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{71.3}\\
cda62 & 13.00 & 62 & 32.6 & 40 & 21382 & 1340 & 6.27 & 12033.4 & 659.5 & 90.4 & 99.4 & 92.7\\
\cellcolor{gray!6}{cda78} & \cellcolor{gray!6}{13.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{21444} & \cellcolor{gray!6}{1869} & \cellcolor{gray!6}{8.72} & \cellcolor{gray!6}{15492.0} & \cellcolor{gray!6}{721.1} & \cellcolor{gray!6}{79.3} & \cellcolor{gray!6}{85.7} & \cellcolor{gray!6}{96.8}\\
cda94 & 13.00 & 94 & 32.6 & 40 & 20856 & 1931 & 9.26 & 13513.0 & 651.1 & 94.6 & 71.3 & 97.2\\
\cellcolor{gray!6}{cdb46} & \cellcolor{gray!6}{21.50} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{19219} & \cellcolor{gray!6}{1723} & \cellcolor{gray!6}{8.97} & \cellcolor{gray!6}{13754.5} & \cellcolor{gray!6}{665.0} & \cellcolor{gray!6}{96.5} & \cellcolor{gray!6}{99.9} & \cellcolor{gray!6}{82.2}\\
cdb62 & 21.50 & 62 & 32.6 & 66 & 20029 & 1384 & 6.91 & 12524.5 & 620.9 & 98.9 & 99.4 & 92.5\\
\cellcolor{gray!6}{cdb78} & \cellcolor{gray!6}{21.50} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{20336} & \cellcolor{gray!6}{1861} & \cellcolor{gray!6}{9.15} & \cellcolor{gray!6}{15394.8} & \cellcolor{gray!6}{610.6} & \cellcolor{gray!6}{99.1} & \cellcolor{gray!6}{95.9} & \cellcolor{gray!6}{98.5}\\
cdb94 & 21.50 & 94 & 32.6 & 66 & 21385 & 2184 & 10.21 & 14269.0 & 658.5 & 92.8 & 92.8 & 96.3\\
\cellcolor{gray!6}{cdc46} & \cellcolor{gray!6}{26.10} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{18907} & \cellcolor{gray!6}{1633} & \cellcolor{gray!6}{8.64} & \cellcolor{gray!6}{13086.7} & \cellcolor{gray!6}{673.6} & \cellcolor{gray!6}{89.8} & \cellcolor{gray!6}{97.0} & \cellcolor{gray!6}{66.2}\\
cdc62 & 26.10 & 62 & 32.6 & 80 & 19270 & 1206 & 6.26 & 14057.4 & 672.2 & 97.9 & 99.7 & 90.2\\
\cellcolor{gray!6}{cdc78} & \cellcolor{gray!6}{26.10} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{19510} & \cellcolor{gray!6}{1781} & \cellcolor{gray!6}{9.13} & \cellcolor{gray!6}{14038.0} & \cellcolor{gray!6}{606.6} & \cellcolor{gray!6}{99.2} & \cellcolor{gray!6}{96.6} & \cellcolor{gray!6}{96.5}\\
cdc94 & 26.10 & 94 & 32.6 & 80 & 20368 & 2058 & 10.10 & 17622.0 & 607.4 & 97.4 & 93.3 & 97.8\\
\cellcolor{gray!6}{cdd46} & \cellcolor{gray!6}{32.60} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{19232} & \cellcolor{gray!6}{908} & \cellcolor{gray!6}{4.72} & \cellcolor{gray!6}{11552.4} & \cellcolor{gray!6}{714.6} & \cellcolor{gray!6}{81.8} & \cellcolor{gray!6}{99.5} & \cellcolor{gray!6}{51.8}\\
cdd62 & 32.60 & 62 & 32.6 & 100 & 18951 & 1182 & 6.24 & 14620.5 & 684.0 & 91.4 & 99.8 & 55.8\\
\cellcolor{gray!6}{cdd78} & \cellcolor{gray!6}{32.60} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{19210} & \cellcolor{gray!6}{1654} & \cellcolor{gray!6}{8.61} & \cellcolor{gray!6}{14480.3} & \cellcolor{gray!6}{684.2} & \cellcolor{gray!6}{96.7} & \cellcolor{gray!6}{97.6} & \cellcolor{gray!6}{81.0}\\
cdd94 & 32.60 & 94 & 32.6 & 100 & 19131 & 2359 & 12.33 & 21924.3 & 643.0 & 99.7 & 76.3 & 99.6\\
\cellcolor{gray!6}{cde46} & \cellcolor{gray!6}{22.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{22015} & \cellcolor{gray!6}{1297} & \cellcolor{gray!6}{5.89} & \cellcolor{gray!6}{11578.6} & \cellcolor{gray!6}{634.9} & \cellcolor{gray!6}{99.3} & \cellcolor{gray!6}{99.8} & \cellcolor{gray!6}{86.9}\\
cde62 & 22.00 & 62 & 55.0 & 40 & 21309 & 1747 & 8.20 & 15169.9 & 625.4 & 93.3 &  & 98.9\\
\cellcolor{gray!6}{cde78} & \cellcolor{gray!6}{22.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{21465} & \cellcolor{gray!6}{1779} & \cellcolor{gray!6}{8.29} & \cellcolor{gray!6}{14942.1} & \cellcolor{gray!6}{631.4} & \cellcolor{gray!6}{91.7} & \cellcolor{gray!6}{91.4} & \cellcolor{gray!6}{99.5}\\
cde94 & 22.00 & 94 & 55.0 & 40 & 21225 & 1796 & 8.46 & 17076.3 & 668.5 & 75.8 & 74.8 & 99.8\\
\cellcolor{gray!6}{cdf46} & \cellcolor{gray!6}{36.30} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{19165} & \cellcolor{gray!6}{1885} & \cellcolor{gray!6}{9.83} & \cellcolor{gray!6}{12648.9} & \cellcolor{gray!6}{637.1} & \cellcolor{gray!6}{98.0} & \cellcolor{gray!6}{99.8} & \cellcolor{gray!6}{73.1}\\
cdf62 & 36.30 & 62 & 55.0 & 66 & 19095 & 1365 & 7.15 & 11231.9 & 589.1 &  &  & 98.4\\
\cellcolor{gray!6}{cdf78} & \cellcolor{gray!6}{36.30} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{19959} & \cellcolor{gray!6}{1345} & \cellcolor{gray!6}{6.74} & \cellcolor{gray!6}{18676.8} & \cellcolor{gray!6}{594.0} & \cellcolor{gray!6}{98.8} & \cellcolor{gray!6}{77.1} & \cellcolor{gray!6}{98.0}\\
cdf94 & 36.30 & 94 & 55.0 & 66 & 19580 & 1605 & 8.20 & 17395.3 & 562.4 & 99.1 & 93.4 & 99.8\\
\cellcolor{gray!6}{cdg46} & \cellcolor{gray!6}{44.01} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{20614} & \cellcolor{gray!6}{1772} & \cellcolor{gray!6}{8.60} & \cellcolor{gray!6}{12222.9} & \cellcolor{gray!6}{704.8} & \cellcolor{gray!6}{99.2} & \cellcolor{gray!6}{99.2} & \cellcolor{gray!6}{47.4}\\
cdg62 & 44.01 & 62 & 55.0 & 80 & 19039 & 1079 & 5.67 & 12281.8 & 586.2 & 99.5 & 96.5 & 94.4\\
\cellcolor{gray!6}{cdg78} & \cellcolor{gray!6}{44.01} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{19734} & \cellcolor{gray!6}{1446} & \cellcolor{gray!6}{7.33} & \cellcolor{gray!6}{18433.4} & \cellcolor{gray!6}{600.7} & \cellcolor{gray!6}{99.5} & \cellcolor{gray!6}{80.0} & \cellcolor{gray!6}{97.2}\\
cdg94 & 44.01 & 94 & 55.0 & 80 & 19549 & 1507 & 7.71 & 16215.9 & 588.5 & 99.9 & 97.2 & 99.0\\
\cellcolor{gray!6}{cdh46} & \cellcolor{gray!6}{55.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{19682} & \cellcolor{gray!6}{891} & \cellcolor{gray!6}{4.53} & \cellcolor{gray!6}{11107.1} & \cellcolor{gray!6}{747.1} & \cellcolor{gray!6}{76.1} & \cellcolor{gray!6}{99.8} & \cellcolor{gray!6}{36.9}\\
cdh62 & 55.00 & 62 & 55.0 & 100 & 19595 & 1189 & 6.07 & 11483.8 & 581.9 & 99.6 & 97.8 & 96.4\\
\cellcolor{gray!6}{cdh78} & \cellcolor{gray!6}{55.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{19283} & \cellcolor{gray!6}{1331} & \cellcolor{gray!6}{6.90} & \cellcolor{gray!6}{12294.3} & \cellcolor{gray!6}{942.2} & \cellcolor{gray!6}{51.6} & \cellcolor{gray!6}{99.3} & \cellcolor{gray!6}{48.3}\\
cdh94 & 55.00 & 94 & 55.0 & 100 & 19521 & 1539 & 7.88 & 21944.8 & 666.8 & 89.8 & 68.1 & 95.0\\
\cellcolor{gray!6}{cdi46} & \cellcolor{gray!6}{34.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{21724} & \cellcolor{gray!6}{1184} & \cellcolor{gray!6}{5.45} & \cellcolor{gray!6}{11824.2} & \cellcolor{gray!6}{583.3} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{99.9} & \cellcolor{gray!6}{96.3}\\
cdi62 & 34.00 & 62 & 85.0 & 40 & 20974 & 1914 & 9.13 & 16954.9 & 623.9 & 91.5 & 99.8 & 99.7\\
\cellcolor{gray!6}{cdi78} & \cellcolor{gray!6}{34.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{21347} & \cellcolor{gray!6}{2028} & \cellcolor{gray!6}{9.50} & \cellcolor{gray!6}{16967.2} & \cellcolor{gray!6}{636.9} & \cellcolor{gray!6}{99.0} & \cellcolor{gray!6}{82.8} & \cellcolor{gray!6}{99.9}\\
cdi94 & 34.00 & 94 & 85.0 & 40 & 21509 & 1981 & 9.21 & 16866.9 & 626.2 & 99.4 & 87.4 & 99.9\\
\cellcolor{gray!6}{cdj46} & \cellcolor{gray!6}{56.10} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{20581} & \cellcolor{gray!6}{1527} & \cellcolor{gray!6}{7.42} & \cellcolor{gray!6}{11877.1} & \cellcolor{gray!6}{622.3} & \cellcolor{gray!6}{99.7} & \cellcolor{gray!6}{99.6} & \cellcolor{gray!6}{89.8}\\
cdj62 & 56.10 & 62 & 85.0 & 66 & 19174 & 1187 & 6.19 & 10886.6 & 544.8 &  &  & 97.7\\
\cellcolor{gray!6}{cdj78} & \cellcolor{gray!6}{56.10} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{19968} & \cellcolor{gray!6}{1020} & \cellcolor{gray!6}{5.11} & \cellcolor{gray!6}{11941.0} & \cellcolor{gray!6}{553.0} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{98.5}\\
cdj94 & 56.10 & 94 & 85.0 & 66 & 19861 & 1678 & 8.45 & 11836.4 & 543.4 &  & 94.6 & 99.6\\
\cellcolor{gray!6}{cdk46} & \cellcolor{gray!6}{68.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{19388} & \cellcolor{gray!6}{1326} & \cellcolor{gray!6}{6.84} & \cellcolor{gray!6}{11953.1} & \cellcolor{gray!6}{630.6} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{99.5} & \cellcolor{gray!6}{89.5}\\
cdk62 & 68.00 & 62 & 85.0 & 80 & 20289 & 1050 & 5.18 & 12511.6 & 662.4 & 98.5 &  & 60.3\\
\cellcolor{gray!6}{cdk78} & \cellcolor{gray!6}{68.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{20198} & \cellcolor{gray!6}{1149} & \cellcolor{gray!6}{5.69} & \cellcolor{gray!6}{13073.8} & \cellcolor{gray!6}{631.0} & \cellcolor{gray!6}{99.8} & \cellcolor{gray!6}{98.5} & \cellcolor{gray!6}{97.9}\\
cdk94 & 68.00 & 94 & 85.0 & 80 & 19142 & 1577 & 8.24 & 12189.6 & 559.1 & 99.9 & 88.3 & 97.9\\
\cellcolor{gray!6}{cdl46} & \cellcolor{gray!6}{85.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{20863} & \cellcolor{gray!6}{724} & \cellcolor{gray!6}{3.47} & \cellcolor{gray!6}{11542.6} & \cellcolor{gray!6}{626.1} & \cellcolor{gray!6}{80.5} & \cellcolor{gray!6}{99.6} & \cellcolor{gray!6}{55.5}\\
cdl62 & 85.00 & 62 & 85.0 & 100 & 19328 & 986 & 5.10 & 10838.6 & 718.5 & 87.1 &  & 53.6\\
\cellcolor{gray!6}{cdl78} & \cellcolor{gray!6}{85.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{19148} & \cellcolor{gray!6}{1410} & \cellcolor{gray!6}{7.36} & \cellcolor{gray!6}{17413.4} & \cellcolor{gray!6}{741.8} & \cellcolor{gray!6}{95.0} & \cellcolor{gray!6}{99.5} & \cellcolor{gray!6}{82.1}\\
cdl94 & 85.00 & 94 & 85.0 & 100 & 22199 & 1809 & 8.15 & 19684.4 & 703.7 & 89.2 & 95.4 & 83.4\\
\cellcolor{gray!6}{cdm46} & \cellcolor{gray!6}{44.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{20476} & \cellcolor{gray!6}{1334} & \cellcolor{gray!6}{6.51} & \cellcolor{gray!6}{13267.4} & \cellcolor{gray!6}{632.6} & \cellcolor{gray!6}{96.2} & \cellcolor{gray!6}{99.5} & \cellcolor{gray!6}{82.3}\\
cdm62 & 44.00 & 62 & 110.0 & 40 & 21290 & 2288 & 10.75 & 14511.0 & 610.1 & 92.6 & 90.1 & 99.9\\
\cellcolor{gray!6}{cdm78} & \cellcolor{gray!6}{44.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{21553} & \cellcolor{gray!6}{1671} & \cellcolor{gray!6}{7.75} & \cellcolor{gray!6}{15153.3} & \cellcolor{gray!6}{612.2} & \cellcolor{gray!6}{92.0} & \cellcolor{gray!6}{91.6} & \cellcolor{gray!6}{}\\
cdm94 & 44.00 & 94 & 110.0 & 40 & 22156 & 1894 & 8.55 & 16370.1 & 618.4 &  & 85.7 & \\
\cellcolor{gray!6}{cdn46} & \cellcolor{gray!6}{72.60} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{19265} & \cellcolor{gray!6}{1690} & \cellcolor{gray!6}{8.77} & \cellcolor{gray!6}{12174.7} & \cellcolor{gray!6}{704.1} & \cellcolor{gray!6}{96.6} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{45.9}\\
cdn62 & 72.60 & 62 & 110.0 & 66 & 22715 & 1209 & 5.32 & 11365.7 & 629.0 & 99.5 & 99.9 & 88.8\\
\cellcolor{gray!6}{cdn78} & \cellcolor{gray!6}{72.60} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{19675} & \cellcolor{gray!6}{1537} & \cellcolor{gray!6}{7.81} & \cellcolor{gray!6}{14611.5} & \cellcolor{gray!6}{593.0} & \cellcolor{gray!6}{99.9} & \cellcolor{gray!6}{83.4} & \cellcolor{gray!6}{98.4}\\
cdn94 & 72.60 & 94 & 110.0 & 66 & 19895 & 1388 & 6.98 & 14191.6 & 542.1 &  & 85.3 & 99.1\\
\cellcolor{gray!6}{cdo46} & \cellcolor{gray!6}{88.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{18891} & \cellcolor{gray!6}{1570} & \cellcolor{gray!6}{8.31} & \cellcolor{gray!6}{12271.5} & \cellcolor{gray!6}{640.9} & \cellcolor{gray!6}{99.7} & \cellcolor{gray!6}{99.3} & \cellcolor{gray!6}{97.9}\\
cdo62 & 88.00 & 62 & 110.0 & 80 & 19245 & 1310 & 6.81 & 15585.8 & 722.4 & 73.1 & 99.9 & 87.3\\
\cellcolor{gray!6}{cdo78} & \cellcolor{gray!6}{88.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{23832} & \cellcolor{gray!6}{1549} & \cellcolor{gray!6}{6.50} & \cellcolor{gray!6}{14079.1} & \cellcolor{gray!6}{724.7} & \cellcolor{gray!6}{72.5} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{65.3}\\
cdo94 & 88.00 & 94 & 110.0 & 80 & 22615 & 1743 & 7.71 & 17184.5 & 630.3 & 89.3 & 84.0 & 95.6\\
\cellcolor{gray!6}{cdp46} & \cellcolor{gray!6}{110.00} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{19065} & \cellcolor{gray!6}{1355} & \cellcolor{gray!6}{7.11} & \cellcolor{gray!6}{13018.1} & \cellcolor{gray!6}{919.5} & \cellcolor{gray!6}{59.1} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{33.3}\\
cdp62 & 110.00 & 62 & 110.0 & 100 & 18896 & 1305 & 6.91 & 14243.4 & 770.9 & 75.1 &  & 70.3\\
\cellcolor{gray!6}{cdp78} & \cellcolor{gray!6}{110.00} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{25756} & \cellcolor{gray!6}{1713} & \cellcolor{gray!6}{6.65} & \cellcolor{gray!6}{14588.2} & \cellcolor{gray!6}{811.7} & \cellcolor{gray!6}{67.8} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{64.2}\\
cdp94 & 110.00 & 94 & 110.0 & 100 & 19973 & 2299 & 11.51 & 16996.3 & 598.1 & 99.2 & 99.5 & 99.2\\*
\end{longtable}
\end{ThreePartTable}
\endgroup{}
\end{landscape}
...
{\centering \includegraphics[width=1\linewidth,]{assets/figs/chpt4/summary_comp} 
...
Powell, M. J. (1994). A direct search optimization method that models the objective and constraint functions by linear interpolation. In \emph{Advances in optimization and numerical analysis} (pp. 51--67). Springer.
...
\caption[Summary of optimized variogram models]{Summary of optimized Kriging parameters. Cost does not correlate strongly with most Kriging parameters (solid black line with ivory 95\% confidence intervals), indicating the optimization procedure is successfully generalizeable across subduction zone segments. The exception is a correlation between cost and the logarithm of the experimental variogram sill. Note that parameter values adjust from an initial value (solid white line) during the optimization procedure.}\label{fig:vgrmSummaryPlot}
\end{figure}
...
\caption{\label{tab:sigmaDiffSummaryTable}Summary of [Similarity $-$ Krige] uncertainty differences by segment}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
