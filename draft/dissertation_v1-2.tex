...
The magnitude of heat fluxing through the Earth's surface is directly related to the thermal state of Earth's lithosphere. Surface heat flow observations from continents and seafloors are thus critically important for understanding lithospheric thermal structure and thermal processing (e.g.~by fluids) within subduction zones. However, evaluating regional surface heat flow patterns across large tectonic features with sparse, irregularly-spaced observations requires careful interpolation. This study compares two interpolation methods based on fundamentally different principles, \emph{Kriging} and \emph{Similarity}, to investigate spatial variability of surface heat flow near 13 presently active subduction zones. Kriging and Similarity predictions show a Kaleidoscope of surface heat flow distributions and profiles among subduction zone segments. Mixed profiles imply various degrees of (dis)continuity exist among subduction zone segments in terms of their (1) lithospheric thermal structure, (2) heat-transferring dynamics, and/or (3) observational density relative to the local spatial variability of surface heat flow. Comparing independent interpolation methods can therefore identify anomalies and methodological strengths. In principle, carefully layering Similarity and Kriging methods may combine their properties to produce more accurate regional interpolations.
