...
\hypertarget{recovery-modes-and-rates}{%
\subsection{Recovery Modes and Rates}\label{recovery-modes-and-rates}}

\hypertarget{constraints-from-geophysical-observations}{%
\subsubsection{Constraints from Geophysical Observations}\label{constraints-from-geophysical-observations}}

The locations of important recovery modes implied by numerical experiments in this study are generally consistent with the depths of important mechanical transitions inferred from seismic imaging and surface heat flow observations. For example, the dominant recovery mode common among all numerical experiments (\texttt{mode\ 1} at about 1 \(GPa\) and 350 \(^\circ C\), Table \ref{tab:recSummary} \& Figure \ref{fig:marxComp}) are consistent with seismic velocity contrasts, thickening of a ubiquitous low-velocity layer, and locations of low-frequency and slow-slip seismic events near the base of the continental Moho (between 20-50 \(km\) depth, \protect\hyperlink{ref-audet2016}{Audet \& Kim, 2016}; \protect\hyperlink{ref-audet2018}{Audet \& Schaeffer, 2018}; \protect\hyperlink{ref-bostock2013}{Bostock, 2013}; \protect\hyperlink{ref-calvert2011}{Calvert et al., 2011}; \protect\hyperlink{ref-delph2021}{Delph et al., 2021}; \protect\hyperlink{ref-tewksbury2021b}{Tewksbury-Christle \& Behr, 2021}). While considerable unknowns persist about the nature of activity in this region (\protect\hyperlink{ref-tewksbury2021b}{Tewksbury-Christle \& Behr, 2021}), it is often interpreted as a locus of fluid release, transitional brittle-ductile seismicity, and underplating of sediments and/or formation of a tectonic mélange.

Relatively uniform geophysical properties and seismic quiescence then extend beyond the shallow region of activity until the low-velocity layer terminates (\protect\hyperlink{ref-abers2020}{Abers et al., 2020}; \protect\hyperlink{ref-rondenay2008}{Rondenay et al., 2008})---coinciding with the deeper recovery mode implied by numerical experiments (\texttt{mode\ 2} at about 2.5 \(GPa\) and 625 \(^\circ C\)). This second transition is often interpreted as pervasive eclogitization of the oceanic crust and onset of mechanical plate coupling near 80 \(km\) (\protect\hyperlink{ref-hacker2008}{Hacker, 2008}; \protect\hyperlink{ref-vankeken2011}{van Keken et al., 2011}). The established locations of these transitions, as well as the gap separating them, are consistent with the most reliable recovery modes observed in numerical experiments (Figure \ref{fig:marxComp}). While numerical experiments indicate considerable variance in the locations of recovery modes across individual simulations, the variance in marker recovery modes is on the same order as the variance in the locations of mechanical transition near the continental Moho (20-50 \(km\), \protect\hyperlink{ref-abers2020}{Abers et al., 2020}), and plate coupling depths inferred from surface heat flow (70-80 \(km\), Chapter \ref{chpt2}; \protect\hyperlink{ref-furukawa1993}{Furukawa, 1993}; \protect\hyperlink{ref-kerswell2020}{Kerswell et al., 2020}; \protect\hyperlink{ref-maunder2019}{Maunder et al., 2019}; \protect\hyperlink{ref-wada2009}{Wada \& Wang, 2009}).

\hypertarget{constraints-from-exhumed-plate-interfaces}{%
\subsubsection{Constraints from Exhumed Plate Interfaces}\label{constraints-from-exhumed-plate-interfaces}}

The overall picture drawn from \gls{pt} estimates of natural samples is consistent in terms of recovery modes, but inconsistent in terms of their locations in \gls{pt} space. This is especially apparent when comparing temperatures and thermal gradients between markers and natural samples. (\protect\hyperlink{ref-behr2018}{Behr et al., 2018}; \protect\hyperlink{ref-tewksbury2021a}{Tewksbury-Christle et al., 2021}; \protect\hyperlink{ref-tewksbury2021b}{Tewksbury-Christle \& Behr, 2021})

\hypertarget{the-marker-recovery-gap}{%
\subsubsection{The Marker Recovery Gap}\label{the-marker-recovery-gap}}

\hypertarget{recovery-mechanisms}{%
\subsection{Recovery Mechanisms}\label{recovery-mechanisms}}
