...
\item
  64-66\% of recovered rocks equilibrate between 1-2.5 \(GPa\)
\item
  5-19\% of recovered rocks equilibrate above 2.5 \(GPa\)
\item
  26-28\% of recovered rocks equilibrate between 350-500 \(^\circ C\)
\item
  27-31\% of recovered rocks equilibrate above 625 \(^\circ C\)
\item
  52-62\% of recovered rocks record gradients between 5-10 \(^\circ C/km\)
\item
  18-31\% of recovered rocks record gradients between 10-15 \(^\circ C/km\)
\item
  6-30\% of recovered rocks record gradients above 15 \(^\circ C/km\)
\end{enumerate}
\end{quote}
...
\tightlist
\item
  Trace markers for 115 timesteps
\item
  Get maximum marker \glspl{pt}\(^*\)
\item
  Apply Gaussian mixture modelling to maximum marker \glspl{pt}
\item
  Check for cluster centroids within the bounds (\(\geq\) 3 \(^\circ C/km\) AND \(\leq\) 1300 \(^\circ C\) AND \(\leq\) 120 \(km\))
\item
  Classify marker clusters found in step 5 as recovered
\item
  Classify all other markers as subducted
\end{enumerate}
...
\caption[Summary of classification results for model cdi62]{Summary of classification results for model cdi62. (a-d) Although the absolute range of recovered markers (black point cloud and blue Tanaka density contours) overlaps with \texttt{pd15} and \texttt{ag18}, marker density is concentrated along cooler thermal gradients compared to natural samples and clusters within three distinct regions coinciding with the continental Moho (about 1 \(GPa\)), the (a)seismic transition (about 1.6 \(GPa\) and 350 \(^\circ C\)), and onset of plate coupling (about 2.3 \(GPa\) and 600 \(^\circ C\). (e) The evolution of model cdi62 shows two major modes of underplating at shallower depths, followed by a narrowing of the plate interface and a final recovery mode near the onset of plate coupling. Note the few (0.1 \%) misclassified markers recovered from \(\geq\) 3 \(GPa\). See Figure \ref{fig:rockPTComp} for explanation of (a-d).}\label{fig:bigComp}
\end{figure}
...
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}than \texttt{ag18} (70\% between 5-15 \(^\circ C/km\)) and \texttt{pd15} (93\% between 5-15\\
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\(^\circ C/km\))\\
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}Figure \ref{fig:marxComp}d\\
\strut \\
\hspace*{0.333em}5. Like \texttt{pd15} and \texttt{ag18}, there is an insignificant amount of markers\\
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}recovered from thermal gradients not typically recognized, or not\\
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}typically measured, in natural samples (3\% from \(\leq\) 5 \(^\circ C/km\))\\
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}Figure \ref{fig:marxComp}d\\
\strut \\
\hspace*{0.333em}6. Virtually no markers (0.009\%) are recovered from \(\geq\) 15 \(^\circ C/km\)\\
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}compared to \texttt{pd15} and \texttt{ag18} (between 6-30\% from \(\geq\) 15 \(^\circ C/km\))\\
\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}\hspace*{0.333em}Figure \ref{fig:marxComp}d
\end{quote}
...
\caption[\gls{pt} distribution of recovered markers from all simulations]{Combined distribution of recovered markers from all 64 simulations. (a) Most markers (black point cloud and blue Tanaka density contours) are recovered from two major modes near the continental Moho around 1 \(GPa\) and 350 \(^\circ C\) and near the onset of plate coupling (antigorite dehydration depth) around 2.5 \(GPa\) and 625 \(^\circ C\), with some dispersion along the plate interface from 1-2 \(GPa\). Note the gap in recovery around 2 \(GPa\) and 550 \(^\circ C\) that coincides with the highest-density of natural samples. (b) A broad single-step \gls{cdf} in P shows high recovery rates between 0.8-1.5 \(GPa\) (72\%) compared to \texttt{pd15} and \texttt{ag18} (28-43\%). (c) Another broad single-step \gls{cdf} in T shows high recovery rates from \(\leq\) 500 \(^\circ C\) (92\%) compared to natural samples (37-44\%) with most deeply subducting markers recovered just before antigorite dehydration in the upper-plate mantle wedge. (d) Virtually all markers 99.99\% are recovered from \(\leq\) 15 \(^\circ C/km\)) compared to 70-94\% for natural samples. Explanation of (a-d) is the same as Figure \ref{fig:rockPTComp}.}\label{fig:marxComp}
\end{figure}

\hypertarget{correlations-summary}{%
\subsection{Correlations Summary}\label{correlations-summary}}

To better understand how rock recovery can vary among subduction zones with different boundary conditions, important modes of marker recovery are determined by finding peaks in marker density with respect to \gls{pt} and \gls{pt} gradients (Figure \ref{fig:corrComp}). The tallest density peak (\texttt{mode1}) gives a sense of where the greatest abundance of markers are being recovered from, and the highest density peak in terms of value (\texttt{mode2}) gives a sense of how the most deeply subducted markers (or markers with the highest gradients) vary across different numerical experiments. The overall picture drawn from many (non)correlations can be summarised as follows.
...
\subsubsection{Recovery Rates}\label{recovery-rates}}
...
\multicolumn{1}{c}{model} & \multicolumn{1}{c}{$\Phi$} & \multicolumn{1}{c}{$Z_{UP}$} & \multicolumn{1}{c}{age} & \multicolumn{1}{c}{$\vec{v}$} & \multicolumn{1}{c}{rec.} & \multicolumn{1}{c}{$\sigma$} & \multicolumn{1}{c}{rate} & \multicolumn{1}{c}{md1 P} & \multicolumn{1}{c}{md2 P} & \multicolumn{1}{c}{md1 T} & \multicolumn{1}{c}{md2 T} & \multicolumn{1}{c}{md1 $\nabla$} & \multicolumn{1}{c}{md2 $\nabla$} \\
...
\bottomrule
\endlastfoot
\cellcolor{gray!6}{cda46} & \cellcolor{gray!6}{13.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{1486} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{7.9} & \cellcolor{gray!6}{1.12} & \cellcolor{gray!6}{2.46} & \cellcolor{gray!6}{382.6} & \cellcolor{gray!6}{603.1} & \cellcolor{gray!6}{8.4} & \cellcolor{gray!6}{11.3}\\
cda62 & 13.0 & 62 & 32.6 & 40 & 1348 & 10 & 7.1 & 1.12 & 2.24 & 352.0 & 645.4 & 8.5 & 10.8\\
\cellcolor{gray!6}{cda78} & \cellcolor{gray!6}{13.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{1857} & \cellcolor{gray!6}{15} & \cellcolor{gray!6}{9.8} & \cellcolor{gray!6}{1.39} & \cellcolor{gray!6}{2.38} & \cellcolor{gray!6}{626.5} & \cellcolor{gray!6}{626.5} & \cellcolor{gray!6}{7.8} & \cellcolor{gray!6}{12.1}\\
cda94 & 13.0 & 94 & 32.6 & 40 & 1942 & 10 & 10.3 & 1.24 & 2.64 & 346.7 & 577.6 & 8.0 & 9.4\\
\cellcolor{gray!6}{cdb46} & \cellcolor{gray!6}{21.5} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{1819} & \cellcolor{gray!6}{25} & \cellcolor{gray!6}{9.6} & \cellcolor{gray!6}{1.04} & \cellcolor{gray!6}{2.23} & \cellcolor{gray!6}{377.6} & \cellcolor{gray!6}{661.9} & \cellcolor{gray!6}{8.6} & \cellcolor{gray!6}{11.9}\\
cdb62 & 21.5 & 62 & 32.6 & 66 & 1419 & 13 & 7.5 & 1.00 & 2.16 & 310.0 & 623.7 & 8.6 & 10.2\\
\cellcolor{gray!6}{cdb78} & \cellcolor{gray!6}{21.5} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{1893} & \cellcolor{gray!6}{17} & \cellcolor{gray!6}{10.0} & \cellcolor{gray!6}{0.92} & \cellcolor{gray!6}{2.49} & \cellcolor{gray!6}{292.3} & \cellcolor{gray!6}{595.1} & \cellcolor{gray!6}{8.4} & \cellcolor{gray!6}{8.4}\\
cdb94 & 21.5 & 94 & 32.6 & 66 & 2366 & 15 & 12.5 & 1.13 & 2.63 & 315.1 & 576.8 & 7.9 & 8.7\\
\cellcolor{gray!6}{cdc46} & \cellcolor{gray!6}{26.1} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{1740} & \cellcolor{gray!6}{24} & \cellcolor{gray!6}{9.2} & \cellcolor{gray!6}{1.02} & \cellcolor{gray!6}{1.60} & \cellcolor{gray!6}{358.8} & \cellcolor{gray!6}{649.0} & \cellcolor{gray!6}{9.5} & \cellcolor{gray!6}{11.5}\\
cdc62 & 26.1 & 62 & 32.6 & 80 & 1298 & 8 & 6.9 & 0.99 & 2.01 & 310.3 & 595.0 & 8.7 & 10.4\\
\cellcolor{gray!6}{cdc78} & \cellcolor{gray!6}{26.1} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{1805} & \cellcolor{gray!6}{17} & \cellcolor{gray!6}{9.6} & \cellcolor{gray!6}{0.91} & \cellcolor{gray!6}{2.90} & \cellcolor{gray!6}{315.4} & \cellcolor{gray!6}{592.3} & \cellcolor{gray!6}{8.3} & \cellcolor{gray!6}{9.6}\\
cdc94 & 26.1 & 94 & 32.6 & 80 & 2168 & 10 & 11.5 & 1.15 & 2.99 & 311.0 & 590.7 & 7.7 & 9.5\\
\cellcolor{gray!6}{cdd46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{1056} & \cellcolor{gray!6}{35} & \cellcolor{gray!6}{5.6} & \cellcolor{gray!6}{0.99} & \cellcolor{gray!6}{1.78} & \cellcolor{gray!6}{319.4} & \cellcolor{gray!6}{319.4} & \cellcolor{gray!6}{9.1} & \cellcolor{gray!6}{11.7}\\
cdd62 & 32.6 & 62 & 32.6 & 100 & 1364 & 16 & 7.2 & 0.99 & 1.63 & 334.0 & 596.0 & 8.8 & 11.1\\
\cellcolor{gray!6}{cdd78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{32.6} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{1892} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{10.0} & \cellcolor{gray!6}{0.99} & \cellcolor{gray!6}{1.94} & \cellcolor{gray!6}{314.0} & \cellcolor{gray!6}{620.2} & \cellcolor{gray!6}{8.7} & \cellcolor{gray!6}{14.0}\\
cdd94 & 32.6 & 94 & 32.6 & 100 & 2716 & 13 & 14.4 & 1.23 & 2.91 & 310.1 & 720.7 & 7.4 & 10.3\\
\cellcolor{gray!6}{cde46} & \cellcolor{gray!6}{22.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{1609} & \cellcolor{gray!6}{19} & \cellcolor{gray!6}{8.5} & \cellcolor{gray!6}{1.11} & \cellcolor{gray!6}{2.78} & \cellcolor{gray!6}{376.4} & \cellcolor{gray!6}{671.0} & \cellcolor{gray!6}{7.7} & \cellcolor{gray!6}{10.6}\\
cde62 & 22.0 & 62 & 55.0 & 40 & 1806 & 14 & 9.6 & 1.08 & 2.24 & 303.4 & 621.7 & 7.8 & 10.4\\
\cellcolor{gray!6}{cde78} & \cellcolor{gray!6}{22.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{1865} & \cellcolor{gray!6}{15} & \cellcolor{gray!6}{9.9} & \cellcolor{gray!6}{1.37} & \cellcolor{gray!6}{2.52} & \cellcolor{gray!6}{374.0} & \cellcolor{gray!6}{631.6} & \cellcolor{gray!6}{6.8} & \cellcolor{gray!6}{9.7}\\
cde94 & 22.0 & 94 & 55.0 & 40 & 1811 & 13 & 9.6 & 2.54 & 2.54 & 315.5 & 680.8 & 7.6 & 9.4\\
\cellcolor{gray!6}{cdf46} & \cellcolor{gray!6}{36.3} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{2276} & \cellcolor{gray!6}{25} & \cellcolor{gray!6}{12.1} & \cellcolor{gray!6}{1.12} & \cellcolor{gray!6}{2.68} & \cellcolor{gray!6}{351.6} & \cellcolor{gray!6}{696.1} & \cellcolor{gray!6}{8.0} & \cellcolor{gray!6}{9.9}\\
cdf62 & 36.3 & 62 & 55.0 & 66 & 1580 & 16 & 8.4 & 1.14 & 2.21 & 279.6 & 613.1 & 7.5 & 9.5\\
\cellcolor{gray!6}{cdf78} & \cellcolor{gray!6}{36.3} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{1624} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{8.6} & \cellcolor{gray!6}{0.99} & \cellcolor{gray!6}{2.73} & \cellcolor{gray!6}{313.6} & \cellcolor{gray!6}{623.8} & \cellcolor{gray!6}{7.1} & \cellcolor{gray!6}{8.7}\\
cdf94 & 36.3 & 94 & 55.0 & 66 & 1965 & 14 & 10.4 & 0.92 & 2.79 & 224.5 & 666.3 & 6.9 & 9.8\\
\cellcolor{gray!6}{cdg46} & \cellcolor{gray!6}{44.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{2130} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{11.3} & \cellcolor{gray!6}{1.20} & \cellcolor{gray!6}{1.97} & \cellcolor{gray!6}{373.8} & \cellcolor{gray!6}{525.3} & \cellcolor{gray!6}{8.7} & \cellcolor{gray!6}{12.4}\\
cdg62 & 44.0 & 62 & 55.0 & 80 & 1355 & 19 & 7.2 & 1.00 & 1.74 & 277.1 & 426.8 & 7.9 & 8.0\\
\cellcolor{gray!6}{cdg78} & \cellcolor{gray!6}{44.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{1597} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{8.5} & \cellcolor{gray!6}{1.01} & \cellcolor{gray!6}{2.14} & \cellcolor{gray!6}{299.0} & \cellcolor{gray!6}{621.6} & \cellcolor{gray!6}{7.6} & \cellcolor{gray!6}{10.1}\\
cdg94 & 44.0 & 94 & 55.0 & 80 & 2150 & 14 & 11.4 & 0.98 & 2.69 & 289.1 & 624.5 & 6.9 & 9.7\\
\cellcolor{gray!6}{cdh46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{987} & \cellcolor{gray!6}{54} & \cellcolor{gray!6}{5.2} & \cellcolor{gray!6}{0.98} & \cellcolor{gray!6}{1.45} & \cellcolor{gray!6}{377.4} & \cellcolor{gray!6}{377.4} & \cellcolor{gray!6}{9.8} & \cellcolor{gray!6}{11.0}\\
cdh62 & 55.0 & 62 & 55.0 & 100 & 1465 & 11 & 7.8 & 0.99 & 1.73 & 258.3 & 298.3 & 7.4 & 7.4\\
\cellcolor{gray!6}{cdh78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{1637} & \cellcolor{gray!6}{9} & \cellcolor{gray!6}{8.7} & \cellcolor{gray!6}{0.99} & \cellcolor{gray!6}{1.63} & \cellcolor{gray!6}{295.9} & \cellcolor{gray!6}{472.8} & \cellcolor{gray!6}{7.0} & \cellcolor{gray!6}{9.0}\\
cdh94 & 55.0 & 94 & 55.0 & 100 & 2296 & 13 & 12.2 & 0.88 & 1.20 & 306.9 & 484.8 & 7.0 & 12.3\\
\cellcolor{gray!6}{cdi46} & \cellcolor{gray!6}{34.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{1289} & \cellcolor{gray!6}{41} & \cellcolor{gray!6}{6.8} & \cellcolor{gray!6}{1.17} & \cellcolor{gray!6}{3.41} & \cellcolor{gray!6}{323.4} & \cellcolor{gray!6}{700.5} & \cellcolor{gray!6}{6.9} & \cellcolor{gray!6}{12.8}\\
cdi62 & 34.0 & 62 & 85.0 & 40 & 1914 & 16 & 10.1 & 1.33 & 2.28 & 273.4 & 632.8 & 6.7 & 8.0\\
\cellcolor{gray!6}{cdi78} & \cellcolor{gray!6}{34.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{2048} & \cellcolor{gray!6}{14} & \cellcolor{gray!6}{10.8} & \cellcolor{gray!6}{1.65} & \cellcolor{gray!6}{2.56} & \cellcolor{gray!6}{347.0} & \cellcolor{gray!6}{560.3} & \cellcolor{gray!6}{5.7} & \cellcolor{gray!6}{8.4}\\
cdi94 & 34.0 & 94 & 85.0 & 40 & 2008 & 13 & 10.6 & 1.66 & 2.94 & 370.5 & 562.5 & 5.3 & 8.6\\
\cellcolor{gray!6}{cdj46} & \cellcolor{gray!6}{56.1} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{1658} & \cellcolor{gray!6}{69} & \cellcolor{gray!6}{8.8} & \cellcolor{gray!6}{1.07} & \cellcolor{gray!6}{2.34} & \cellcolor{gray!6}{344.2} & \cellcolor{gray!6}{518.7} & \cellcolor{gray!6}{9.2} & \cellcolor{gray!6}{9.2}\\
cdj62 & 56.1 & 62 & 85.0 & 66 & 1400 & 18 & 7.4 & 1.09 & 2.11 & 261.0 & 572.3 & 7.0 & 10.1\\
\cellcolor{gray!6}{cdj78} & \cellcolor{gray!6}{56.1} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{1332} & \cellcolor{gray!6}{10} & \cellcolor{gray!6}{7.0} & \cellcolor{gray!6}{1.22} & \cellcolor{gray!6}{1.96} & \cellcolor{gray!6}{286.9} & \cellcolor{gray!6}{286.9} & \cellcolor{gray!6}{6.6} & \cellcolor{gray!6}{7.3}\\
cdj94 & 56.1 & 94 & 85.0 & 66 & 1869 & 19 & 9.9 & 1.03 & 1.52 & 217.2 & 310.5 & 6.2 & 8.3\\
\cellcolor{gray!6}{cdk46} & \cellcolor{gray!6}{68.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{1528} & \cellcolor{gray!6}{15} & \cellcolor{gray!6}{8.1} & \cellcolor{gray!6}{1.06} & \cellcolor{gray!6}{1.12} & \cellcolor{gray!6}{330.8} & \cellcolor{gray!6}{501.7} & \cellcolor{gray!6}{8.5} & \cellcolor{gray!6}{8.5}\\
cdk62 & 68.0 & 62 & 85.0 & 80 & 1259 & 12 & 6.7 & 1.07 & 1.82 & 295.4 & 486.9 & 6.7 & 7.9\\
\cellcolor{gray!6}{cdk78} & \cellcolor{gray!6}{68.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{1574} & \cellcolor{gray!6}{18} & \cellcolor{gray!6}{8.3} & \cellcolor{gray!6}{1.01} & \cellcolor{gray!6}{1.88} & \cellcolor{gray!6}{279.9} & \cellcolor{gray!6}{593.6} & \cellcolor{gray!6}{6.5} & \cellcolor{gray!6}{10.3}\\
cdk94 & 68.0 & 94 & 85.0 & 80 & 2085 & 21 & 11.0 & 1.04 & 3.20 & 302.8 & 702.9 & 6.4 & 8.6\\
\cellcolor{gray!6}{cdl46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{825} & \cellcolor{gray!6}{82} & \cellcolor{gray!6}{4.4} & \cellcolor{gray!6}{1.09} & \cellcolor{gray!6}{1.56} & \cellcolor{gray!6}{344.9} & \cellcolor{gray!6}{344.9} & \cellcolor{gray!6}{9.0} & \cellcolor{gray!6}{9.0}\\
cdl62 & 85.0 & 62 & 85.0 & 100 & 1134 & 14 & 6.0 & 1.02 & 2.23 & 336.0 & 544.3 & 8.2 & 8.4\\
\cellcolor{gray!6}{cdl78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{85.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{1731} & \cellcolor{gray!6}{13} & \cellcolor{gray!6}{9.2} & \cellcolor{gray!6}{1.04} & \cellcolor{gray!6}{1.94} & \cellcolor{gray!6}{257.1} & \cellcolor{gray!6}{318.0} & \cellcolor{gray!6}{6.6} & \cellcolor{gray!6}{10.9}\\
cdl94 & 85.0 & 94 & 85.0 & 100 & 2308 & 24 & 12.2 & 1.24 & 2.30 & 308.6 & 476.3 & 7.0 & 9.6\\
\cellcolor{gray!6}{cdm46} & \cellcolor{gray!6}{44.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{1418} & \cellcolor{gray!6}{21} & \cellcolor{gray!6}{7.5} & \cellcolor{gray!6}{1.39} & \cellcolor{gray!6}{3.14} & \cellcolor{gray!6}{362.9} & \cellcolor{gray!6}{613.1} & \cellcolor{gray!6}{7.1} & \cellcolor{gray!6}{14.0}\\
cdm62 & 44.0 & 62 & 110.0 & 40 & 2328 & 12 & 12.3 & 1.21 & 2.45 & 320.9 & 588.4 & 6.1 & 8.2\\
\cellcolor{gray!6}{cdm78} & \cellcolor{gray!6}{44.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{40} & \cellcolor{gray!6}{1824} & \cellcolor{gray!6}{20} & \cellcolor{gray!6}{9.7} & \cellcolor{gray!6}{1.48} & \cellcolor{gray!6}{2.51} & \cellcolor{gray!6}{374.8} & \cellcolor{gray!6}{631.7} & \cellcolor{gray!6}{6.4} & \cellcolor{gray!6}{7.7}\\
cdm94 & 44.0 & 94 & 110.0 & 40 & 1906 & 14 & 10.1 & 1.53 & 2.87 & 383.7 & 537.1 & 5.5 & 9.1\\
\cellcolor{gray!6}{cdn46} & \cellcolor{gray!6}{72.6} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{1991} & \cellcolor{gray!6}{57} & \cellcolor{gray!6}{10.5} & \cellcolor{gray!6}{1.25} & \cellcolor{gray!6}{2.36} & \cellcolor{gray!6}{404.3} & \cellcolor{gray!6}{691.2} & \cellcolor{gray!6}{10.1} & \cellcolor{gray!6}{14.2}\\
cdn62 & 72.6 & 62 & 110.0 & 66 & 1262 & 18 & 6.7 & 1.13 & 2.15 & 369.4 & 564.7 & 8.4 & 9.5\\
\cellcolor{gray!6}{cdn78} & \cellcolor{gray!6}{72.6} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{66} & \cellcolor{gray!6}{1705} & \cellcolor{gray!6}{20} & \cellcolor{gray!6}{9.0} & \cellcolor{gray!6}{1.38} & \cellcolor{gray!6}{1.48} & \cellcolor{gray!6}{295.4} & \cellcolor{gray!6}{325.8} & \cellcolor{gray!6}{7.2} & \cellcolor{gray!6}{8.3}\\
cdn94 & 72.6 & 94 & 110.0 & 66 & 1708 & 23 & 9.0 & 1.06 & 1.75 & 219.1 & 309.7 & 6.0 & 8.3\\
\cellcolor{gray!6}{cdo46} & \cellcolor{gray!6}{88.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{1461} & \cellcolor{gray!6}{17} & \cellcolor{gray!6}{7.7} & \cellcolor{gray!6}{1.20} & \cellcolor{gray!6}{1.57} & \cellcolor{gray!6}{381.9} & \cellcolor{gray!6}{381.9} & \cellcolor{gray!6}{8.6} & \cellcolor{gray!6}{8.6}\\
cdo62 & 88.0 & 62 & 110.0 & 80 & 1417 & 9 & 7.5 & 1.05 & 2.50 & 341.4 & 605.8 & 8.6 & 8.6\\
\cellcolor{gray!6}{cdo78} & \cellcolor{gray!6}{88.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{80} & \cellcolor{gray!6}{1720} & \cellcolor{gray!6}{19} & \cellcolor{gray!6}{9.1} & \cellcolor{gray!6}{0.92} & \cellcolor{gray!6}{1.38} & \cellcolor{gray!6}{290.8} & \cellcolor{gray!6}{290.8} & \cellcolor{gray!6}{6.4} & \cellcolor{gray!6}{9.6}\\
cdo94 & 88.0 & 94 & 110.0 & 80 & 2048 & 76 & 10.8 & 1.03 & 2.20 & 302.4 & 517.7 & 6.3 & 10.5\\
\cellcolor{gray!6}{cdp46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{46} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{1551} & \cellcolor{gray!6}{92} & \cellcolor{gray!6}{8.2} & \cellcolor{gray!6}{1.27} & \cellcolor{gray!6}{1.63} & \cellcolor{gray!6}{477.9} & \cellcolor{gray!6}{477.9} & \cellcolor{gray!6}{10.3} & \cellcolor{gray!6}{11.5}\\
cdp62 & 110.0 & 62 & 110.0 & 100 & 1428 & 24 & 7.6 & 1.12 & 2.06 & 296.8 & 430.2 & 5.8 & 13.2\\
\cellcolor{gray!6}{cdp78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{78} & \cellcolor{gray!6}{110.0} & \cellcolor{gray!6}{100} & \cellcolor{gray!6}{1810} & \cellcolor{gray!6}{19} & \cellcolor{gray!6}{9.6} & \cellcolor{gray!6}{1.11} & \cellcolor{gray!6}{1.89} & \cellcolor{gray!6}{333.5} & \cellcolor{gray!6}{477.9} & \cellcolor{gray!6}{7.3} & \cellcolor{gray!6}{7.3}\\
cdp94 & 110.0 & 94 & 110.0 & 100 & 2320 & 15 & 12.3 & 1.33 & 2.88 & 314.9 & 575.6 & 6.7 & 9.9\\*
\end{longtable}
\endgroup{}
\end{landscape}
...
\subsection{\texorpdfstring{\gls{pt} Distributions}{ Distributions}}\label{distributions}}
...
\caption[Recovery rates for all 4 subduction simulations with the youngest oceanic-plates and slowest convergence velocities]{Combined distribution of recovered markers from all 4 simulations with the youngest oceanic-plates and slowest convergence velocities. (a) Most markers (black point cloud and blue Tanaka density contours) are recovered from two major modes near the continental Moho around 1 \(GPa\) and 350 \(^\circ C\) and near the onset of plate coupling (antigorite dehydration depth) around 2.5 \(GPa\) and 625 \(^\circ C\), with some dispersion along the plate interface from 1-2 \(GPa\). Note the gap in recovery around 2 \(GPa\) and 550 \(^\circ C\) that coincides with the highest-density of natural samples. (b) A broad single-step \gls{cdf} in P shows high recovery rates between 0.8-1.5 \(GPa\) (72\%) compared to \texttt{pd15} and \texttt{ag18} (28-43\%). (c) Another broad single-step \gls{cdf} in T shows high recovery rates from \(\leq\) 500 \(^\circ C\) (92\%) compared to natural samples (37-44\%) with most deeply subducting markers recovered just before antigorite dehydration in the upper-plate mantle wedge. (d) Virtually all markers 99.99\% are recovered from \(\leq\) 15 \(^\circ C/km\)) compared to 70-94\% for natural samples. Explanation of (a-d) is the same as Figure \ref{fig:rockPTComp}.}\label{fig:youngSlow}
\end{figure}
...
The second step is fitting a variogram model \(\gamma(h)\) to the experimental variogram. This study fits six popular variogram models with sills (or theoretical sills) to the experimental variogram. The models are defined as (\protect\hyperlink{ref-pebesma2004}{P, 2004}):
\begin{equation}
  \begin{aligned}
