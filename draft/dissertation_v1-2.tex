...
The total number of ThermoGlobe data across all sectors is relatively small (from n = 9 to 1052) compared to Similarity and Kriging predictions (from 82 to 1169). For example, many (n = 0) sectors have a single observation (singular distribution; \gls{iqr} = 0) or only a few observations that may vary wildly---resulting in very wide distribution (Table \ref{tab:sectorSummaryTable}).
