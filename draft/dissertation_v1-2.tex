...
\begin{equation}
  ...
  \label{eq:binwidth}
\end{equation}
where \(\max(h)\) is the maximum separation distance within the Kriging domain, \(n_{lag}\) is the number of lags used to evaluate the variogram, \(l\) is a lag shift constant that shifts the variogram by an integer number of binwidths, \(c\) is a lag cutoff constant (by convention \(c=3\)). Then \(N(h)\) is the number of observations that fall within \(h = [h-\delta,\ h+\delta)\).
...
\begin{equation}
  ...
  \label{eq:idw}
\end{equation}
where \(Z(u_c)\) is the expected surface heat flow at a grid point \(u_c\), \(Z(u_i)\) is the surface heat flow observed at location \(u_i\), \(N\) is the number of observations contained within 55 \(km\) (approximately 0.5\(^\circ\)) of the grid point, \(\omega_i\) is the weight applied to \(Z(u_i)\), \(d(u_i, u_c)\) is a function measuring the distance between observation location \(u_i\) and grid point \(u_c\), and \(p=2\) is a power constant affecting the smoothness of the interpolation. Finally, Similarity accuracy is evaluated by directly computing \gls{rmse} at the set of all grid points with interpolated ThermoGlobe data.
...
Similarity predictions heavily depend on distance from plate boundaries. Consequently, Similarity highlights high surface heat flow along the arms of the Galápagos triple junction and within the subducting Cocos Plate (Figure \ref{fig:centralAmericaDiff}). In contrast, Kriging smooths out high heat flow gradients near spreading centers and predicts low surface heat flow within the Cocos Plate and volcanic arc. While Simlarity predicts higher surface heat flow within the Cocos Plate by proximity to the nearby spreading centers, Kriging predicts much lower surface heat flow within the Cocos Plate because low surface heat flow is observed in the region. Low surface heat flow predicted by Kriging along the volcanic arc is due to a lack of observations during the interpolation process either by dataset filtering or because none exist.



\begin{figure}[htbp]

{\centering \includegraphics[width=0.67\linewidth,]{assets/figs/chpt3/CentralAmericaDiffComp} 
...
\hypertarget{upper-plate-sector-samples}{%
\subsubsection{Upper-Plate Sector Samples}\label{upper-plate-sector-samples}}

Sampling Similarity and Kriging interpolations from adjacent upper-plate sectors allows for first-order quantitative evaluation of the along-strike variability in upper-plate surface heat flow. Surface heat flow distributions across sectors (in terms by their medians and interquartile ranges; Table \ref{tab:sectorSummaryTable}) generally show three patterns among subduction zone segments: (1) Similarity and Kriging predictions overlap well, (2) Similarity and Kriging predictions moderately overlap, or (3) Similarity and Kriging predictions overlap poorly. In addition to a range of overlapping Similarity and Kriging predictions, a range of sector profiles are observed. Profiles can be (1) consistent and narrowly distributed (\(\leq\) 10 \(mWm^{-2}\); continuous upper-plate surface heat flow), (2) consistent and widely distributed (up to 50 \(mWm^{-2}\); discontinuous upper-plate surface heat flow), or (3) varied in shape and/or distribution. This section presents three subduction zone segments that characterize the range of observed upper-plate surface heat flow patterns. Visualizations of the remaining segments are presented in Appendix \ref{lateralDiffAppendix}.

\hypertarget{kyushu-ryukyu-1}{%
\paragraph{Kyushu Ryukyu}\label{kyushu-ryukyu-1}}

In terms of the medians and interquartile ranges of predicted surface heat flow across all sectors, Kyushu Ryukyu characterizes a subduction zone segment with relatively consistent upper-plate surface heat flow for thousands of \(km\) along-strike (Figure \ref{fig:kyushuRyukyuUpper}). Distributions of Similarity and Kriging predictions overlap well with each other and with ThermoGlobe data. For example, median Similarity predictions differ from median Kriging predictions by only 8.1 \(mWm^{-2}\) on average across all sectors (Table \ref{tab:sectorSummaryTable}). Moreover, interquartile ranges across all sectors differ by only 14.6 \(mWm^{-2}\) on average.

Meanwhile, ThermoGlobe data within Kyushu Ryukyu upper-plate sectors are relatively abundant (total n = 339) and can range considerably within upper-plate sectors. Yet, all smoothed Similarity and Kriging profiles both gently arc through the approximate midrange of surface heat flow observations (Figure \ref{fig:kyushuRyukyuUpper}). All profiles gradually rise from approximately 50 \(mWm^{-2}\) at the trench to maximums of approximately 75-100 \(mWm^{-2}\) before gradually decreasing to approximately 75 \(mWm^{-2}\) at 500 \(km\) into the upper-plate. Moreover, profile forms are consistent across sectors and show relatively little spread (\(\leq\) 25 \(mWm^{-2}\)).
...
\caption[Surface heat flow profiles for Sumatra Banda Sea upper-plate sectors]{Surface heat flow profiles for Sumatra Banda Sea upper-plate sectors. (a) Profiles are computed by finding orthogonal distances between the segment boundary (trench; bold black line) and 965 surface heat flow predictions within eight 500 \(km\)-wide sectors (colored polygons). (b) Similarity and Kriging predictions across sectors are moderately distinguishable with mostly overlapping interquartile ranges (boxes), except for sectors 1 \& 6. (c) Profiles (colored curves with 95\% confidence intervals) of Kriging predictions show greater overall spread than Similarity profiles (e.g.~sector 1). Colored squares are ThermoGlobe data from Lucazeau (\protect\hyperlink{ref-lucazeau2019}{2019}). Segment boundary and volcanoes (gold diamonds) defined by Syracuse \& Abers (\protect\hyperlink{ref-syracuse2006}{2006}). Plate boundaries (bold black lines) defined by Lawver et al. (\protect\hyperlink{ref-lawver2018}{2018}). Profile curves in (c) are LOESS regressions through three-point running averages (small colored data points).}\label{fig:sumatraBandaSeaUpper}
\end{figure}
...
\toprule
\multicolumn{2}{c}{ } & \multicolumn{3}{c}{ThermoGlobe} & \multicolumn{2}{c}{Similarity} & \multicolumn{2}{c}{Krige} \\
\cmidrule(l{3pt}r{3pt}){3-5} \cmidrule(l{3pt}r{3pt}){6-7} \cmidrule(l{3pt}r{3pt}){8-9}
Segment & Sector & n & Median & IQR & Median & IQR & Median & IQR\\
\midrule
\endfirsthead
...
\insertTableNotes
\endlastfoot
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{96.1} & \cellcolor{gray!6}{42.6} & \cellcolor{gray!6}{82.7} & \cellcolor{gray!6}{33.0} & \cellcolor{gray!6}{96.1} & \cellcolor{gray!6}{38.7}\\
Alaska Aleutians & 2 & 1 & 62.0 & 0.0 & 75.2 & 16.8 & 69.9 & 14.1\\
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{62.0} & \cellcolor{gray!6}{0.0} & \cellcolor{gray!6}{75.0} & \cellcolor{gray!6}{16.7} & \cellcolor{gray!6}{66.4} & \cellcolor{gray!6}{10.0}\\
Alaska Aleutians & 6 & 13 & 45.3 & 25.5 & 74.0 & 17.5 & 68.3 & 16.5\\
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{7} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{55.0} & \cellcolor{gray!6}{11.1} & \cellcolor{gray!6}{76.6} & \cellcolor{gray!6}{13.2} & \cellcolor{gray!6}{55.3} & \cellcolor{gray!6}{9.8}\\
Alaska Aleutians & 8 & 4 & 45.6 & 15.1 & 79.9 & 6.8 & 51.8 & 16.7\\
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{9} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{134.6} & \cellcolor{gray!6}{60.5} & \cellcolor{gray!6}{80.7} & \cellcolor{gray!6}{14.4} & \cellcolor{gray!6}{95.1} & \cellcolor{gray!6}{54.5}\\
Alaska Aleutians & 11 & 2 & 41.9 & 25.1 & 75.3 & 13.7 & 52.5 & 17.7\\
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{12} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{74.5} & \cellcolor{gray!6}{15.2} & \cellcolor{gray!6}{76.3} & \cellcolor{gray!6}{17.3} & \cellcolor{gray!6}{76.2} & \cellcolor{gray!6}{48.5}\\
Alaska Aleutians & 13 & 6 & 84.0 & 15.8 & 77.8 & 16.7 & 78.1 & 25.2\\
\cellcolor{gray!6}{Alaska Aleutians} & \cellcolor{gray!6}{14} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{63.5} & \cellcolor{gray!6}{20.0} & \cellcolor{gray!6}{74.2} & \cellcolor{gray!6}{11.5} & \cellcolor{gray!6}{60.4} & \cellcolor{gray!6}{12.6}\\
Andes & 4 & 14 & 74.5 & 89.5 & 75.3 & 13.8 & 98.4 & 40.7\\
\cellcolor{gray!6}{Andes} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{68} & \cellcolor{gray!6}{69.0} & \cellcolor{gray!6}{59.8} & \cellcolor{gray!6}{78.7} & \cellcolor{gray!6}{16.1} & \cellcolor{gray!6}{135.4} & \cellcolor{gray!6}{30.0}\\
Andes & 6 & 39 & 61.0 & 40.5 & 73.6 & 23.4 & 109.1 & 24.1\\
\cellcolor{gray!6}{Andes} & \cellcolor{gray!6}{7} & \cellcolor{gray!6}{23} & \cellcolor{gray!6}{81.0} & \cellcolor{gray!6}{112.0} & \cellcolor{gray!6}{77.3} & \cellcolor{gray!6}{40.3} & \cellcolor{gray!6}{103.8} & \cellcolor{gray!6}{38.6}\\
Andes & 8 & 30 & 94.0 & 49.8 & 101.4 & 89.6 & 108.6 & 26.1\\
\cellcolor{gray!6}{Andes} & \cellcolor{gray!6}{9} & \cellcolor{gray!6}{45} & \cellcolor{gray!6}{61.0} & \cellcolor{gray!6}{57.0} & \cellcolor{gray!6}{74.6} & \cellcolor{gray!6}{56.3} & \cellcolor{gray!6}{111.6} & \cellcolor{gray!6}{25.8}\\
Andes & 10 & 11 & 45.0 & 19.5 & 68.2 & 24.7 & 64.9 & 23.6\\
\cellcolor{gray!6}{Andes} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{41.9} & \cellcolor{gray!6}{8.3} & \cellcolor{gray!6}{69.8} & \cellcolor{gray!6}{19.2} & \cellcolor{gray!6}{43.1} & \cellcolor{gray!6}{15.1}\\
Andes & 12 & 4 & 36.0 & 8.2 & 67.4 & 19.8 & 57.5 & 14.3\\
\cellcolor{gray!6}{Andes} & \cellcolor{gray!6}{13} & \cellcolor{gray!6}{36} & \cellcolor{gray!6}{71.0} & \cellcolor{gray!6}{7.0} & \cellcolor{gray!6}{74.0} & \cellcolor{gray!6}{21.2} & \cellcolor{gray!6}{96.6} & \cellcolor{gray!6}{39.6}\\
Central America & 1 & 72 & 42.0 & 12.2 & 56.2 & 24.9 & 43.1 & 11.6\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{50.2} & \cellcolor{gray!6}{4.1} & \cellcolor{gray!6}{76.7} & \cellcolor{gray!6}{22.6} & \cellcolor{gray!6}{46.2} & \cellcolor{gray!6}{10.2}\\
Central America & 4 & 1 & 37.7 & 0.0 & 77.7 & 24.2 & 44.3 & 22.2\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{41} & \cellcolor{gray!6}{34.7} & \cellcolor{gray!6}{6.6} & \cellcolor{gray!6}{82.6} & \cellcolor{gray!6}{25.7} & \cellcolor{gray!6}{37.4} & \cellcolor{gray!6}{10.6}\\
Central America & 6 & 94 & 50.9 & 20.1 & 81.7 & 11.6 & 55.5 & 17.2\\
\cellcolor{gray!6}{Central America} & \cellcolor{gray!6}{7} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{76.4} & \cellcolor{gray!6}{11.5} & \cellcolor{gray!6}{81.5} & \cellcolor{gray!6}{11.1} & \cellcolor{gray!6}{65.0} & \cellcolor{gray!6}{9.8}\\
Central America & 8 & 10 & 63.0 & 15.1 & 71.8 & 26.4 & 60.5 & 15.3\\
\cellcolor{gray!6}{Kamchatka Marianas} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{25} & \cellcolor{gray!6}{186.0} & \cellcolor{gray!6}{112.0} & \cellcolor{gray!6}{70.4} & \cellcolor{gray!6}{44.1} & \cellcolor{gray!6}{53.3} & \cellcolor{gray!6}{46.4}\\
Kamchatka Marianas & 4 & 43 & 64.5 & 150.8 & 74.2 & 49.2 & 57.9 & 35.7\\
\cellcolor{gray!6}{Kamchatka Marianas} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{79} & \cellcolor{gray!6}{54.0} & \cellcolor{gray!6}{64.5} & \cellcolor{gray!6}{95.4} & \cellcolor{gray!6}{46.2} & \cellcolor{gray!6}{91.3} & \cellcolor{gray!6}{53.2}\\
Kamchatka Marianas & 6 & 116 & 71.0 & 65.2 & 75.3 & 52.5 & 63.3 & 45.0\\
\cellcolor{gray!6}{Kamchatka Marianas} & \cellcolor{gray!6}{7} & \cellcolor{gray!6}{302} & \cellcolor{gray!6}{74.8} & \cellcolor{gray!6}{49.8} & \cellcolor{gray!6}{78.6} & \cellcolor{gray!6}{43.3} & \cellcolor{gray!6}{72.8} & \cellcolor{gray!6}{37.3}\\
Kamchatka Marianas & 8 & 126 & 81.8 & 55.0 & 73.6 & 38.4 & 73.9 & 56.0\\
\cellcolor{gray!6}{Kamchatka Marianas} & \cellcolor{gray!6}{9} & \cellcolor{gray!6}{172} & \cellcolor{gray!6}{89.0} & \cellcolor{gray!6}{82.8} & \cellcolor{gray!6}{76.0} & \cellcolor{gray!6}{61.0} & \cellcolor{gray!6}{70.9} & \cellcolor{gray!6}{56.9}\\
Kamchatka Marianas & 10 & 59 & 83.7 & 30.8 & 91.7 & 36.7 & 80.5 & 31.5\\
\cellcolor{gray!6}{Kamchatka Marianas} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{27} & \cellcolor{gray!6}{80.0} & \cellcolor{gray!6}{39.8} & \cellcolor{gray!6}{83.7} & \cellcolor{gray!6}{30.6} & \cellcolor{gray!6}{67.9} & \cellcolor{gray!6}{32.8}\\
Kamchatka Marianas & 12 & 48 & 78.2 & 41.2 & 75.8 & 24.8 & 68.8 & 25.4\\
\cellcolor{gray!6}{Kamchatka Marianas} & \cellcolor{gray!6}{13} & \cellcolor{gray!6}{55} & \cellcolor{gray!6}{68.0} & \cellcolor{gray!6}{32.5} & \cellcolor{gray!6}{75.5} & \cellcolor{gray!6}{27.1} & \cellcolor{gray!6}{61.1} & \cellcolor{gray!6}{28.9}\\
Kyushu Ryukyu & 1 & 74 & 69.5 & 41.8 & 75.8 & 40.3 & 86.6 & 30.7\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{25} & \cellcolor{gray!6}{80.0} & \cellcolor{gray!6}{40.0} & \cellcolor{gray!6}{77.6} & \cellcolor{gray!6}{13.1} & \cellcolor{gray!6}{75.4} & \cellcolor{gray!6}{28.6}\\
Kyushu Ryukyu & 3 & 6 & 67.5 & 16.8 & 86.2 & 17.8 & 76.8 & 18.7\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{28} & \cellcolor{gray!6}{77.5} & \cellcolor{gray!6}{26.2} & \cellcolor{gray!6}{84.9} & \cellcolor{gray!6}{24.6} & \cellcolor{gray!6}{77.6} & \cellcolor{gray!6}{45.2}\\
Kyushu Ryukyu & 5 & 103 & 89.0 & 77.0 & 72.4 & 27.2 & 76.1 & 37.1\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{6} & \cellcolor{gray!6}{25} & \cellcolor{gray!6}{126.0} & \cellcolor{gray!6}{94.0} & \cellcolor{gray!6}{80.4} & \cellcolor{gray!6}{19.0} & \cellcolor{gray!6}{96.0} & \cellcolor{gray!6}{57.6}\\
Kyushu Ryukyu & 7 & 42 & 60.0 & 70.2 & 76.3 & 16.7 & 67.0 & 34.7\\
\cellcolor{gray!6}{Kyushu Ryukyu} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{36} & \cellcolor{gray!6}{43.4} & \cellcolor{gray!6}{30.8} & \cellcolor{gray!6}{62.1} & \cellcolor{gray!6}{37.6} & \cellcolor{gray!6}{55.3} & \cellcolor{gray!6}{33.8}\\
Lesser Antilles & 1 & 3 & 54.4 & 0.4 & 54.0 & 7.5 & 52.0 & 8.2\\
\cellcolor{gray!6}{Lesser Antilles} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{10} & \cellcolor{gray!6}{38.1} & \cellcolor{gray!6}{31.9} & \cellcolor{gray!6}{57.7} & \cellcolor{gray!6}{24.0} & \cellcolor{gray!6}{63.4} & \cellcolor{gray!6}{18.0}\\
Lesser Antilles & 5 & 15 & 55.0 & 36.2 & 73.0 & 32.7 & 79.0 & 40.5\\
\cellcolor{gray!6}{Lesser Antilles} & \cellcolor{gray!6}{6} & \cellcolor{gray!6}{24} & \cellcolor{gray!6}{74.4} & \cellcolor{gray!6}{89.3} & \cellcolor{gray!6}{68.6} & \cellcolor{gray!6}{83.1} & \cellcolor{gray!6}{98.0} & \cellcolor{gray!6}{90.7}\\
Lesser Antilles & 7 & 6 & 78.2 & 26.8 & 68.4 & 36.0 & 76.9 & 37.5\\
\cellcolor{gray!6}{Lesser Antilles} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{14} & \cellcolor{gray!6}{54.5} & \cellcolor{gray!6}{32.0} & \cellcolor{gray!6}{64.9} & \cellcolor{gray!6}{21.0} & \cellcolor{gray!6}{60.3} & \cellcolor{gray!6}{27.8}\\
N Philippines & 1 & 2 & 46.3 & 2.3 & 65.3 & 18.0 & 54.1 & 4.4\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{44.0} & \cellcolor{gray!6}{3.3} & \cellcolor{gray!6}{71.6} & \cellcolor{gray!6}{26.2} & \cellcolor{gray!6}{54.7} & \cellcolor{gray!6}{6.5}\\
N Philippines & 3 & 2 & 75.4 & 33.5 & 66.2 & 33.9 & 55.4 & 7.8\\
\cellcolor{gray!6}{N Philippines} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{23.0} & \cellcolor{gray!6}{7.0} & \cellcolor{gray!6}{75.7} & \cellcolor{gray!6}{34.2} & \cellcolor{gray!6}{48.2} & \cellcolor{gray!6}{11.0}\\
N Philippines & 6 & 1 & 51.0 & 0.0 & 81.1 & 14.3 & 49.2 & 4.8\\
\cellcolor{gray!6}{New Britain Solomon} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{37.7} & \cellcolor{gray!6}{0.0} & \cellcolor{gray!6}{83.2} & \cellcolor{gray!6}{24.9} & \cellcolor{gray!6}{48.5} & \cellcolor{gray!6}{3.8}\\
New Britain Solomon & 4 & 1 & 2.9 & 0.0 & 96.6 & 48.6 & 49.4 & 6.5\\
\cellcolor{gray!6}{New Britain Solomon} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{36.8} & \cellcolor{gray!6}{12.1} & \cellcolor{gray!6}{58.8} & \cellcolor{gray!6}{29.3} & \cellcolor{gray!6}{44.7} & \cellcolor{gray!6}{8.7}\\
New Britain Solomon & 6 & 3 & 35.2 & 10.6 & 52.5 & 10.5 & 39.8 & 7.7\\
\cellcolor{gray!6}{New Britain Solomon} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{58.2} & \cellcolor{gray!6}{0.0} & \cellcolor{gray!6}{56.6} & \cellcolor{gray!6}{27.8} & \cellcolor{gray!6}{49.1} & \cellcolor{gray!6}{19.2}\\
S Philippines & 2 & 7 & 129.0 & 35.5 & 88.2 & 45.0 & 115.7 & 41.1\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{97.0} & \cellcolor{gray!6}{105.8} & \cellcolor{gray!6}{73.0} & \cellcolor{gray!6}{24.7} & \cellcolor{gray!6}{57.9} & \cellcolor{gray!6}{23.2}\\
S Philippines & 5 & 5 & 62.8 & 4.6 & 69.6 & 18.0 & 57.3 & 7.0\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{6} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{52.9} & \cellcolor{gray!6}{24.3} & \cellcolor{gray!6}{76.8} & \cellcolor{gray!6}{27.4} & \cellcolor{gray!6}{53.5} & \cellcolor{gray!6}{11.2}\\
S Philippines & 7 & 5 & 46.0 & 5.0 & 76.9 & 14.6 & 47.5 & 8.2\\
\cellcolor{gray!6}{S Philippines} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{45.5} & \cellcolor{gray!6}{7.2} & \cellcolor{gray!6}{81.4} & \cellcolor{gray!6}{18.0} & \cellcolor{gray!6}{47.3} & \cellcolor{gray!6}{6.8}\\
Scotia & 2 & 3 & 143.0 & 5.5 & 120.0 & 51.2 & 83.9 & 26.0\\
\cellcolor{gray!6}{Scotia} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{9} & \cellcolor{gray!6}{134.0} & \cellcolor{gray!6}{37.0} & \cellcolor{gray!6}{90.2} & \cellcolor{gray!6}{38.9} & \cellcolor{gray!6}{89.6} & \cellcolor{gray!6}{28.2}\\
Sumatra Banda Sea & 1 & 339 & 21.0 & 10.8 & 74.4 & 15.2 & 82.4 & 99.7\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{23} & \cellcolor{gray!6}{80.0} & \cellcolor{gray!6}{24.2} & \cellcolor{gray!6}{75.4} & \cellcolor{gray!6}{22.6} & \cellcolor{gray!6}{68.3} & \cellcolor{gray!6}{19.7}\\
Sumatra Banda Sea & 4 & 208 & 113.0 & 47.2 & 85.2 & 32.1 & 89.1 & 40.1\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{192} & \cellcolor{gray!6}{123.0} & \cellcolor{gray!6}{33.2} & \cellcolor{gray!6}{85.4} & \cellcolor{gray!6}{36.9} & \cellcolor{gray!6}{97.9} & \cellcolor{gray!6}{54.7}\\
Sumatra Banda Sea & 6 & 40 & 103.0 & 13.0 & 72.9 & 50.0 & 67.2 & 57.8\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{7} & \cellcolor{gray!6}{86} & \cellcolor{gray!6}{70.5} & \cellcolor{gray!6}{31.5} & \cellcolor{gray!6}{71.7} & \cellcolor{gray!6}{24.7} & \cellcolor{gray!6}{70.1} & \cellcolor{gray!6}{31.7}\\
Sumatra Banda Sea & 8 & 40 & 78.0 & 18.5 & 66.7 & 18.0 & 57.9 & 25.3\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{9} & \cellcolor{gray!6}{30} & \cellcolor{gray!6}{77.5} & \cellcolor{gray!6}{25.2} & \cellcolor{gray!6}{68.8} & \cellcolor{gray!6}{28.8} & \cellcolor{gray!6}{43.7} & \cellcolor{gray!6}{36.6}\\
Sumatra Banda Sea & 10 & 5 & 75.0 & 51.2 & 70.7 & 24.7 & 53.2 & 14.0\\
\cellcolor{gray!6}{Sumatra Banda Sea} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{71.2} & \cellcolor{gray!6}{0.0} & \cellcolor{gray!6}{72.3} & \cellcolor{gray!6}{12.4} & \cellcolor{gray!6}{60.9} & \cellcolor{gray!6}{5.7}\\
Sumatra Banda Sea & 12 & 1 & 175.0 & 0.0 & 80.0 & 19.0 & 81.3 & 30.1\\
\cellcolor{gray!6}{Tonga New Zealand} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{73} & \cellcolor{gray!6}{46.8} & \cellcolor{gray!6}{39.0} & \cellcolor{gray!6}{56.9} & \cellcolor{gray!6}{24.3} & \cellcolor{gray!6}{49.7} & \cellcolor{gray!6}{21.8}\\
Tonga New Zealand & 2 & 44 & 39.5 & 20.8 & 49.7 & 29.0 & 41.0 & 19.5\\
\cellcolor{gray!6}{Tonga New Zealand} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{30} & \cellcolor{gray!6}{64.0} & \cellcolor{gray!6}{36.0} & \cellcolor{gray!6}{73.6} & \cellcolor{gray!6}{38.2} & \cellcolor{gray!6}{91.1} & \cellcolor{gray!6}{80.5}\\
Tonga New Zealand & 4 & 1 & 24.3 & 0.0 & 76.0 & 28.2 & 47.1 & 58.7\\
\cellcolor{gray!6}{Tonga New Zealand} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{1} & \cellcolor{gray!6}{15.1} & \cellcolor{gray!6}{0.0} & \cellcolor{gray!6}{80.7} & \cellcolor{gray!6}{37.4} & \cellcolor{gray!6}{45.7} & \cellcolor{gray!6}{41.8}\\
Tonga New Zealand & 6 & 29 & 31.2 & 15.0 & 79.7 & 35.6 & 108.6 & 88.9\\
\cellcolor{gray!6}{Tonga New Zealand} & \cellcolor{gray!6}{7} & \cellcolor{gray!6}{35} & \cellcolor{gray!6}{28.5} & \cellcolor{gray!6}{7.1} & \cellcolor{gray!6}{71.9} & \cellcolor{gray!6}{24.0} & \cellcolor{gray!6}{53.1} & \cellcolor{gray!6}{30.2}\\
Tonga New Zealand & 8 & 7 & 49.0 & 49.2 & 81.0 & 43.8 & 54.8 & 26.2\\
\cellcolor{gray!6}{Tonga New Zealand} & \cellcolor{gray!6}{9} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{31.1} & \cellcolor{gray!6}{23.2} & \cellcolor{gray!6}{73.8} & \cellcolor{gray!6}{34.8} & \cellcolor{gray!6}{47.5} & \cellcolor{gray!6}{36.2}\\
Tonga New Zealand & 10 & 4 & 59.7 & 47.0 & 74.3 & 29.3 & 72.6 & 68.1\\
\cellcolor{gray!6}{Tonga New Zealand} & \cellcolor{gray!6}{11} & \cellcolor{gray!6}{5} & \cellcolor{gray!6}{31.8} & \cellcolor{gray!6}{19.7} & \cellcolor{gray!6}{79.3} & \cellcolor{gray!6}{33.4} & \cellcolor{gray!6}{57.3} & \cellcolor{gray!6}{34.9}\\
Vanuatu & 1 & 9 & 96.0 & 72.0 & 81.6 & 17.5 & 84.4 & 37.5\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{91.4} & \cellcolor{gray!6}{32.7} & \cellcolor{gray!6}{103.9} & \cellcolor{gray!6}{56.5} & \cellcolor{gray!6}{78.4} & \cellcolor{gray!6}{59.7}\\
Vanuatu & 3 & 6 & 54.5 & 116.8 & 101.7 & 60.0 & 96.9 & 84.9\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{4} & \cellcolor{gray!6}{3} & \cellcolor{gray!6}{125.0} & \cellcolor{gray!6}{9.5} & \cellcolor{gray!6}{110.8} & \cellcolor{gray!6}{67.7} & \cellcolor{gray!6}{119.4} & \cellcolor{gray!6}{86.9}\\
Vanuatu & 5 & 4 & 174.5 & 18.8 & 107.5 & 75.6 & 133.6 & 41.7\\
\cellcolor{gray!6}{Vanuatu} & \cellcolor{gray!6}{6} & \cellcolor{gray!6}{2} & \cellcolor{gray!6}{123.0} & \cellcolor{gray!6}{18.0} & \cellcolor{gray!6}{118.1} & \cellcolor{gray!6}{48.1} & \cellcolor{gray!6}{109.9} & \cellcolor{gray!6}{29.9}\\
Vanuatu & 7 & 2 & 57.0 & 2.9 & 109.8 & 18.0 & 71.9 & 25.1\\*
\end{longtable}
\end{ThreePartTable}
\endgroup{}
